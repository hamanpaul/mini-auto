...
async def startup_event():
    global camera_processor_instance # 宣告使用全域變數 camera_processor_instance。
    ...
    # 影像處理器將在 /camera/start API 端點被呼叫時才開始擷取影像，因此這裡不需要立即啟動。
    # camera_processor_instance.start() # 我們將透過 API 端點啟動它。
