...
*/
 ...
 #define CIU_NEW_SP_TIMING        0x00000004
 ...
 #define CIU_DS_MODE_DIS          0x00000000
 ...
 #define CIU_MP_SEL_DS            0x08000000 // downsample
 #define CIU_MP_SEL_SC            0x10000000 // scalar

 #define CIU_SP_SEL_SENSOR        0x00000000
 #define CIU_SP_SEL_DS            0x20000000 // downsample
 #define CIU_SP_SEL_SC            0x40000000 // scalar

 #define CIU_SA_SEL_SENSOR        0x00000000
 #define CIU_SA_SEL_DS            0x80000000 // downsample
 ...
 /*CIU_1_SA_InputSize*/       
 #define CIU_SA_INPUT_SIZE_X_SHFT 0
 #define CIU_SA_INPUT_SIZE_Y_SHFT 16
