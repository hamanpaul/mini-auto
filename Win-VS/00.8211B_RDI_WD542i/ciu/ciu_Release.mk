...
CARM_SRCS	= 		  .\src\MotionDetect_HW.c .\src\ciu.c 
CARM_COMP	= c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c $$SRC $(CARM) -o $$OBJ
CARM_OBJS	= 		  Release\MotionDetect_HW.o Release\ciu.o 
...
MAKENAME	= ciu_Release.mk
PRINT		= pr
PROGRAM		= none
BUILD_LIB	= Debug\..\..\lib\ciu.lib
POST_BUILD	=
...
INC__CIU_H=inc\\ciu.h 
# DEPEND: end include files

Release\MotionDetect_HW.o: .\src\MotionDetect_HW.c
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c \
	 .\src\MotionDetect_HW.c $(CARM) -o Release\MotionDetect_HW.o
Release\ciu.o: .\src\ciu.c ..\inc\\board.h $(___INC__I2CAPI_H) \
	 $(___INC__FSAPI_H) $(___INC__DCFAPI_H) ..\inc\\gpioapi.h \
	 ..\inc\\sysapi.h  ..\inc\\iisapi.h ..\inc\\isuapi.h \
	 $(___INC__TIMERAPI_H) inc\\ciureg.h $(INC__CIU_H) inc\\mdreg.h \
	 ..\inc\\task.h ..\inc\\uiapi.h ..\inc\\uikey.h
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c .\src\ciu.c \
	 $(CARM) -o Release\ciu.o
