...
CARM_SRCS	= 		  .\src\fstest.c .\src\commands.c .\src\shelltask.c 
CARM_COMP	= c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c $$SRC $(CARM) -o $$OBJ
CARM_OBJS	= 		  DebugRel\fstest.o DebugRel\commands.o \
		  DebugRel\shelltask.o 
...
MAKENAME	= shell_release_DebugRel.mk
PRINT		= pr
PROGRAM		= none
BUILD_LIB	= Release\..\..\lib\release\shell_release.lib
POST_BUILD	=
...
DebugRel\fstest.o: .\src\fstest.c $(___INC__GENERAL_H) inc\\commands.h \
	 inc\\shelltask.h  ..\inc\\fsapi.h ..\fs\inc\fs_fat.h
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c .\src\fstest.c \
	 $(CARM) -o DebugRel\fstest.o
DebugRel\commands.o: .\src\commands.c $(___INC__GENERAL_H) inc\\commands.h \
	 inc\\shelltask.h  ..\inc\\fsapi.h ..\fs\inc\fs_fat.h
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c .\src\commands.c \
	 $(CARM) -o DebugRel\commands.o
DebugRel\shelltask.o: .\src\shelltask.c inc\\commands.h inc\\shelltask.h \
	 $(___INC__FSAPI_H) ..\inc\\ramdiskapi.h ..\inc\\sdcapi.h \
	 $(___INC__SMCAPI_H)
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c .\src\shelltask.c \
	 $(CARM) -o DebugRel\shelltask.o
