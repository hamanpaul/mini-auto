...
MAKENAME	= dummy_Release.mk
PRINT		= pr
PROGRAM		= none
BUILD_LIB	= Debug\dummy.lib
POST_BUILD	=
...
Release\dummy.o: .\src\dummy.c
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c .\src\dummy.c \
	 $(CARM) -o Release\dummy.o
