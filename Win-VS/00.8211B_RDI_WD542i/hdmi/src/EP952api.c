...
void  EP_HDMI_Set_Audio_Fmt_952(HDMI_AudFmt_t  Audfmt, HDMI_AudFreq  Audfreq)
{
	///////////////////////////////////////////////////////////////
...
void EP_HDMI_952_Init(void)
{
    EP_HDMI_Set_Video_Timing_952(4);
    EP_HDMI_Set_Audio_Fmt_952(AUD_I2S, AUD_SF_48000Hz);
