...
CARM_OBJS	= 		  Release\adc.o Release\adc_project.o 
...
MAKENAME	= adc_release_Release.mk
PRINT		= pr
PROGRAM		= none
...
Release\adc.o: .\src\adc.c ..\inc\\board.h inc\\adcreg.h ..\inc\\sysapi.h \
	...
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c .\src\adc.c \
	 $(CARM) -o Release\adc.o
Release\adc_project.o: .\src\adc_project.c $(___INC__GENERAL_H) \
	 ..\inc\\board.h inc\\adcreg.h ..\inc\\sysapi.h
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c \
	 .\src\adc_project.c $(CARM) -o Release\adc_project.o
