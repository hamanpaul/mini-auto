...
#elif((HW_BOARD_OPTION == MR8120_TX_RDI_CA672) || (HW_BOARD_OPTION == MR8120_TX_RDI_CA652))
...
void SetPO3100K_720P_30FPS(void)
{
    ...
    i2cWrite_PO3100K(0x06,0x06);    // 30fps: 0x0671, 25fps: 0x07BB
...
void SetPO3100K_720P_28FPS(void)
{
    int i;

    DEBUG_SIU("SetPO3100K_720P_28FPS()\n");
    ...
    i2cWrite_PO3100K(0x40,0x3C);
#if 0
    i2cWrite_PO3100K(0x06,0x07);    // 30fps: 0x0671, 25fps: 0x07BB
    i2cWrite_PO3100K(0x07,0xBB);
    i2cWrite_PO3100K(0x08,0x02);
    i2cWrite_PO3100K(0x09,0xED);
    i2cWrite_PO3100K(0x0A,0x02);
    i2cWrite_PO3100K(0x0B,0xED);
    ...
    i2cWrite_PO3100K(0x06,0x06);
    i2cWrite_PO3100K(0x07,0x71);
    i2cWrite_PO3100K(0x08,0x03);    // 30fps: 0x02ED, 28fps: 0x0322, 25fps: 0x0383
    i2cWrite_PO3100K(0x09,0x22);
    i2cWrite_PO3100K(0x0A,0x03);    // 30fps: 0x02ED, 28fps: 0x0322, 25fps: 0x0383
    i2cWrite_PO3100K(0x0B,0x22);
#endif
    i2cWrite_PO3100K(0x0C,0x00);
    i2cWrite_PO3100K(0x0D,0x05);
    i2cWrite_PO3100K(0x0E,0x00);
...
void SetPO3100K_720P_25FPS(void)
{
    int i;

    DEBUG_SIU("SetPO3100K_720P_25FPS()\n");
    ...
    i2cWrite_PO3100K(0x07,0x71);
    i2cWrite_PO3100K(0x08,0x03);    // 30fps: 0x02ED, 28fps: 0x0322, 25fps: 0x0383
    i2cWrite_PO3100K(0x09,0x83);
    i2cWrite_PO3100K(0x0A,0x03);    // 30fps: 0x02ED, 28fps: 0x0322, 25fps: 0x0383
    i2cWrite_PO3100K(0x0B,0x83);
#endif
    i2cWrite_PO3100K(0x0C,0x00);
    i2cWrite_PO3100K(0x0D,0x05);
    i2cWrite_PO3100K(0x0E,0x00);
...
s32 siuSensorInit(u8 siuSensorMode,u8 zoomFactor)
{
   ...
   //---------Run on Mclk=27 MHz--------------//
    ...
    SYS_CLK1 = (SYS_CLK1 & (~0x000000ff)) | 0x0a; //MClk=288/12=26.18MHz
   #elif(SYS_CPU_CLK_FREQ == 108000000)
    SYS_CLK1 = (SYS_CLK1 & (~0x000000ff)) | 0x07; //MClk=216/8=27MHz
   ...
   gRfiuUnitCntl[0].RFpara.TX_SensorType=TX_SENSORTYPE_HD;
    ...
    {	
        ...
        case SIUMODE_MPEGAVI: 
            ...
            #elif 0
                FrameRate   = 28;
                SetPO3100K_720P_28FPS();
            #else
                FrameRate   = 25;
                SetPO3100K_720P_25FPS();
            #endif
            }
...
#if((HW_BOARD_OPTION == MR8120_TX_RDI_CA672) || (HW_BOARD_OPTION == MR8120_TX_RDI_CA652))
...
void siuSetSensorDayNight(u8 Level)
{
	...
	{   //夜間模式
        ...
        i2cWrite_PO3100K(0x2C,0x80);
        i2cWrite_PO3100K(0x77,0x01);
        i2cWrite_PO3100K(0x03,0x04);
        i2cWrite_PO3100K(0x07,0x80);
        i2cWrite_PO3100K(0x03,0x00);
        i2cWrite_PO3100K(0x8E,0x98);
        i2cWrite_PO3100K(0x8F,0x05);
        i2cWrite_PO3100K(0x03,0x02);
        i2cWrite_PO3100K(0x8B,0x00);
#else   // 20141023
        i2cWrite_PO3100K(0x03, 0x02);
