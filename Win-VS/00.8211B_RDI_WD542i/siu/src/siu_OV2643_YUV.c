...
#include "general.h"
#if (Sensor_OPTION == Sensor_OV2643_YUV601)
        #include "board.h"
...
void SetOV2643_720P_15FPS(void)
{
    int i;
    ...
    DEBUG_SIU("SetOV2643_720P_15FPS()\n");

    i2cWrite_SENSOR(0x12, 0x80);
    for(i=0;i<10000;i++);
    i2cWrite_SENSOR(0xc3, 0x1f);
    i2cWrite_SENSOR(0xc4, 0xff);
    i2cWrite_SENSOR(0x3d, 0x48);
    i2cWrite_SENSOR(0xdd, 0x95);
    i2cWrite_SENSOR(0x0e, 0xb4);
    i2cWrite_SENSOR(0x10, 0x0a);
    i2cWrite_SENSOR(0x11, 0x00);
    i2cWrite_SENSOR(0x0f, 0x24);    // 0x24: 15 fps, 0x14: 30 fps
    i2cWrite_SENSOR(0x20, 0x01);
    i2cWrite_SENSOR(0x21, 0x25);
    i2cWrite_SENSOR(0x22, 0x00);
    i2cWrite_SENSOR(0x23, 0x0c);
    i2cWrite_SENSOR(0x24, 0x50);
    i2cWrite_SENSOR(0x26, 0x2d);
    i2cWrite_SENSOR(0x27, 0x04);
    i2cWrite_SENSOR(0x29, 0x06);
    i2cWrite_SENSOR(0x2a, 0x40);
    i2cWrite_SENSOR(0x2b, 0x02);
    i2cWrite_SENSOR(0x2c, 0xee);
    i2cWrite_SENSOR(0x1d, 0x04);
    i2cWrite_SENSOR(0x25, 0x04);
    i2cWrite_SENSOR(0x27, 0x04);
    i2cWrite_SENSOR(0x28, 0x40);
    i2cWrite_SENSOR(0x12, 0x48);
    i2cWrite_SENSOR(0x39, 0x10);
    i2cWrite_SENSOR(0xcd, 0x12);
    i2cWrite_SENSOR(0x13, 0xff);
    i2cWrite_SENSOR(0x14, 0xa7);
    i2cWrite_SENSOR(0x15, 0x42);
    i2cWrite_SENSOR(0x3c, 0xa4);
    i2cWrite_SENSOR(0x18, 0x60);
    i2cWrite_SENSOR(0x19, 0x50);
    i2cWrite_SENSOR(0x1a, 0xe2);
    i2cWrite_SENSOR(0x37, 0xe8);
    i2cWrite_SENSOR(0x16, 0x90);
    i2cWrite_SENSOR(0x43, 0x00);    // 0x80: color bar test pattern enable, 0x00 : disable
    //i2cWrite_SENSOR(0x43, 0x80);    // 0x80: color bar test pattern enable, 0x00 : disable
    i2cWrite_SENSOR(0x40, 0xfb);
    i2cWrite_SENSOR(0xa9, 0x44);
    i2cWrite_SENSOR(0x2f, 0xec);
    i2cWrite_SENSOR(0x35, 0x10);
    i2cWrite_SENSOR(0x36, 0x10);
    i2cWrite_SENSOR(0x0c, 0x00);
    i2cWrite_SENSOR(0x0d, 0x60);    // 0x00: YUYV, 0x60: VYUY
    i2cWrite_SENSOR(0xd0, 0x93);
    i2cWrite_SENSOR(0xdc, 0x2b);
    i2cWrite_SENSOR(0xd9, 0x81);
    i2cWrite_SENSOR(0xd3, 0x04);
    i2cWrite_SENSOR(0xcc, 0x04);
    i2cWrite_SENSOR(0xc7, 0x08);
    i2cWrite_SENSOR(0x3d, 0x08);
    i2cWrite_SENSOR(0x0c, 0x00);
    i2cWrite_SENSOR(0x18, 0x2c);
    i2cWrite_SENSOR(0x19, 0x24);
    i2cWrite_SENSOR(0x1a, 0x71);
    i2cWrite_SENSOR(0x9b, 0x69);
    i2cWrite_SENSOR(0x9c, 0x7d);
    i2cWrite_SENSOR(0x9d, 0x7d);
    i2cWrite_SENSOR(0x9e, 0x69);
    i2cWrite_SENSOR(0x35, 0x04);
    i2cWrite_SENSOR(0x36, 0x04);
    i2cWrite_SENSOR(0x65, 0x12);
    i2cWrite_SENSOR(0x66, 0x20);
    i2cWrite_SENSOR(0x67, 0x39);
    i2cWrite_SENSOR(0x68, 0x4e);
    i2cWrite_SENSOR(0x69, 0x62);
    i2cWrite_SENSOR(0x6a, 0x74);
    i2cWrite_SENSOR(0x6b, 0x85);
    i2cWrite_SENSOR(0x6c, 0x92);
    i2cWrite_SENSOR(0x6d, 0x9e);
    i2cWrite_SENSOR(0x6e, 0xb2);
    i2cWrite_SENSOR(0x6f, 0xc0);
    i2cWrite_SENSOR(0x70, 0xcc);
    i2cWrite_SENSOR(0x71, 0xe0);
    i2cWrite_SENSOR(0x72, 0xee);
    i2cWrite_SENSOR(0x73, 0xf6);
    i2cWrite_SENSOR(0x74, 0x11);
    i2cWrite_SENSOR(0xab, 0x20);
    i2cWrite_SENSOR(0xac, 0x5b);
    i2cWrite_SENSOR(0xad, 0x05);
    i2cWrite_SENSOR(0xae, 0x1b);
    i2cWrite_SENSOR(0xaf, 0x76);
    i2cWrite_SENSOR(0xb0, 0x90);
    i2cWrite_SENSOR(0xb1, 0x90);
    i2cWrite_SENSOR(0xb2, 0x8c);
    i2cWrite_SENSOR(0xb3, 0x04);
    i2cWrite_SENSOR(0xb4, 0x98);
    i2cWrite_SENSOR(0x4c, 0x03);
    i2cWrite_SENSOR(0x4d, 0x30);
    i2cWrite_SENSOR(0x4e, 0x02);
    i2cWrite_SENSOR(0x4f, 0x5c);
    i2cWrite_SENSOR(0x50, 0x56);
    i2cWrite_SENSOR(0x51, 0x00);
    i2cWrite_SENSOR(0x52, 0x66);
    i2cWrite_SENSOR(0x53, 0x03);
    i2cWrite_SENSOR(0x54, 0x30);
    i2cWrite_SENSOR(0x55, 0x02);
    i2cWrite_SENSOR(0x56, 0x5c);
    i2cWrite_SENSOR(0x57, 0x40);
    i2cWrite_SENSOR(0x58, 0x00);
    i2cWrite_SENSOR(0x59, 0x66);
    i2cWrite_SENSOR(0x5a, 0x03);
    i2cWrite_SENSOR(0x5b, 0x20);
    i2cWrite_SENSOR(0x5c, 0x02);
    i2cWrite_SENSOR(0x5d, 0x5c);
    i2cWrite_SENSOR(0x5e, 0x3a);
    i2cWrite_SENSOR(0x5f, 0x00);
    i2cWrite_SENSOR(0x60, 0x66);
    i2cWrite_SENSOR(0x41, 0x1f);
    i2cWrite_SENSOR(0xb5, 0x01);
    i2cWrite_SENSOR(0xb6, 0x02);
    i2cWrite_SENSOR(0xb9, 0x40);
    i2cWrite_SENSOR(0xba, 0x28);
    i2cWrite_SENSOR(0xbf, 0x0c);
    i2cWrite_SENSOR(0xc0, 0x3e);
    i2cWrite_SENSOR(0xa3, 0x0a);
    i2cWrite_SENSOR(0xa4, 0x0f);
    i2cWrite_SENSOR(0xa5, 0x09);
    i2cWrite_SENSOR(0xa6, 0x16);
    i2cWrite_SENSOR(0x9f, 0x0a);
    i2cWrite_SENSOR(0xa0, 0x0f);
    i2cWrite_SENSOR(0xa7, 0x0a);
    i2cWrite_SENSOR(0xa8, 0x0f);
    i2cWrite_SENSOR(0xa1, 0x10);
    i2cWrite_SENSOR(0xa2, 0x04);
    i2cWrite_SENSOR(0xa9, 0x04);
    i2cWrite_SENSOR(0xaa, 0xa6);
    i2cWrite_SENSOR(0x75, 0x6a);
    i2cWrite_SENSOR(0x76, 0x11);
    i2cWrite_SENSOR(0x77, 0x92);
    i2cWrite_SENSOR(0x78, 0x21);
    i2cWrite_SENSOR(0x79, 0xe1);
    i2cWrite_SENSOR(0x7a, 0x02);
    i2cWrite_SENSOR(0x7c, 0x05);
    i2cWrite_SENSOR(0x7d, 0x08);
    i2cWrite_SENSOR(0x7e, 0x08);
    i2cWrite_SENSOR(0x7f, 0x7c);
    i2cWrite_SENSOR(0x80, 0x58);
    i2cWrite_SENSOR(0x81, 0x2a);
    i2cWrite_SENSOR(0x82, 0xc5);
    i2cWrite_SENSOR(0x83, 0x46);
    i2cWrite_SENSOR(0x84, 0x3a);
    i2cWrite_SENSOR(0x85, 0x54);
    i2cWrite_SENSOR(0x86, 0x44);
    i2cWrite_SENSOR(0x87, 0xf8);
    i2cWrite_SENSOR(0x88, 0x08);
    i2cWrite_SENSOR(0x89, 0x70);
    i2cWrite_SENSOR(0x8a, 0xf0);
    i2cWrite_SENSOR(0x8b, 0xf0);
    i2cWrite_SENSOR(0x90, 0xe3);
    i2cWrite_SENSOR(0x93, 0x10);
    i2cWrite_SENSOR(0x94, 0x20);
    i2cWrite_SENSOR(0x95, 0x10);
    i2cWrite_SENSOR(0x96, 0x18);
    i2cWrite_SENSOR(0xc2, 0x08);    // 0x08: VSYNC low active(frame valid is high), 0x00: VSYNC high active(frame valid is low)

}

void SetOV2643_VGA_30FPS(void)
{
    int i;
    ...
    i2cWrite_SENSOR(0xc4, 0xff);
    i2cWrite_SENSOR(0x3d, 0x48);
    i2cWrite_SENSOR(0xdd, 0x95);    //a5
    i2cWrite_SENSOR(0x0e, 0xb8);
    i2cWrite_SENSOR(0x10, 0x0a);
    i2cWrite_SENSOR(0x11, 0x00);
    i2cWrite_SENSOR(0x0f, 0x14);
    i2cWrite_SENSOR(0x20, 0x01);
    i2cWrite_SENSOR(0x21, 0xe8);    //98
    i2cWrite_SENSOR(0x22, 0x00);
    i2cWrite_SENSOR(0x23, 0x42);    //06
    i2cWrite_SENSOR(0x24, 0x28);    //32
    i2cWrite_SENSOR(0x26, 0x1e);    //25
    i2cWrite_SENSOR(0x27, 0x04);    //84
    i2cWrite_SENSOR(0x29, 0x04);
    i2cWrite_SENSOR(0x2a, 0xce);
    i2cWrite_SENSOR(0x2b, 0x02);
    i2cWrite_SENSOR(0x2c, 0x8a);
    i2cWrite_SENSOR(0x1d, 0x04);
    i2cWrite_SENSOR(0x25, 0x04);
    i2cWrite_SENSOR(0x28, 0x40);
    i2cWrite_SENSOR(0x12, 0x09);
    i2cWrite_SENSOR(0x39, 0xd0);
    i2cWrite_SENSOR(0xcd, 0x13);
    i2cWrite_SENSOR(0x13, 0xff);
    i2cWrite_SENSOR(0x14, 0xa9);    //a7
    i2cWrite_SENSOR(0x15, 0x42);
    i2cWrite_SENSOR(0x3c, 0xa4);
    i2cWrite_SENSOR(0x18, 0x60);
    i2cWrite_SENSOR(0x19, 0x50);
   ...
   gRfiuUnitCntl[0].RFpara.TX_SensorType=TX_SENSORTYPE_HD;
    ...
    {	
       ...
       case SIUMODE_MPEGAVI: 
            ...
            for(i = 0; i < 0x100; i++)
            {
                i2cRead_SENSOR(i, &data);
                DEBUG_SIU("OV2643(0x%02x)=0x%02x\n", i, data);
            }
            */
