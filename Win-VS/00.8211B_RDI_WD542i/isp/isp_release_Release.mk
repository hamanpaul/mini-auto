...
MAKENAME	= isp_release_Release.mk
PRINT		= pr
PROGRAM		= none
BUILD_LIB	= Release\..\..\lib\release\isp_release.lib
POST_BUILD	=
...
Release\isp.o: .\src\isp.c ..\inc\\board.h inc\\isp.h ..\inc\\ispapi.h \
	 ..\inc\\rtcapi.h $(___INC__FSAPI_H) $(___INC__DCFAPI_H) \
	 $(___INC__SMCAPI_H) ..\inc\\sysapi.h ..\inc\\spiapi.h \
	 ..\inc\\gpioapi.h $(___INC__UIAPI_H)
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c .\src\isp.c \
	 $(CARM) -o Release\isp.o
