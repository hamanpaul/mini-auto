...
TARGET		= ARM
INC_PATHS	= -I..\inc\mars_controller\ -I.\inc\ -I..\inc\ -I..\inc\os\
...
CARM	= -I..\inc\mars_controller\ -I.\inc\ -I..\inc\ -I..\inc\os\ -g --dwarf2 -O1
CARM_SRCS	= 		  .\src\mars_dmareqfunc.c .\src\mars_dma.c 
CARM_COMP	= c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c $$SRC $(CARM) -o $$OBJ
CARM_OBJS	= 		  DebugRel\mars_dmareqfunc.o DebugRel\mars_dma.o 
...
MAKENAME	= mars_dma_release_DebugRel.mk
PRINT		= pr
PROGRAM		= none
BUILD_LIB	= Release\..\..\lib\release\mars_dma_release.lib
POST_BUILD	=
...
DebugRel\mars_dmareqfunc.o: .\src\mars_dmareqfunc.c
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c \
	 .\src\mars_dmareqfunc.c $(CARM) -o DebugRel\mars_dmareqfunc.o
DebugRel\mars_dma.o: .\src\mars_dma.c
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c .\src\mars_dma.c \
	 $(CARM) -o DebugRel\mars_dma.o
