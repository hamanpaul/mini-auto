...
s32 usbInit(void)
{
    ...
    #if ( (HW_BOARD_OPTION < MMR6720_EBELL) ||(HW_BOARD_OPTION==ITS_CARDVR)||(HW_BOARD_OPTION==DEMO_DVR))
        /* do not enable high resistor for booting with USB plug-in */
        gpioCheckLevel_USB();
    #endif
