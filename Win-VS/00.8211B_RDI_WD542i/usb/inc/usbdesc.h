...
#else
	#if ((HW_BOARD_OPTION == SUNWAY_SDV)||(HW_BOARD_OPTION == ULTMOST_SDV)||(HW_BOARD_OPTION == SHUOYING_SDV)||(HW_BOARD_OPTION==WENSHING_SDV))
#define USB_STR2_bString			'M', 0x00, 'R', 0x00, '9', 0x00, '6', 0x00, '2', 0x00, '0', 0x00
	#elif (HW_BOARD_OPTION == D010_CARDVR)
#define USB_STR2_bString			'P', 0x00, 'G', 0x00, '1', 0x00, '0', 0x00, '0', 0x00, '0', 0x00
	#else
