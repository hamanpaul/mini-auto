...
extern INT32U OSIntFIQNestIRQFlag;
/* cytsai: 0421 */
//extern u32 dbgArray[];
//extern u32 dbgIndex;
//extern u32 osCurStk[64][18];
        ...
        if (OSIntNesting == 0) {                           /* Reschedule only if all ISRs complete ... */
            if (OSLockNesting == 0) {                      /* ... and not locked.                      */
                ...
                if (OSPrioHighRdy != OSPrioCur) {          /* No Ctx Sw if current task is highest rdy */
                    ...
                    OSIntIRQCtxSw();                          /* Perform interrupt level ctx switch       */
                }
            }
        }
        OS_EXIT_CRITICAL();
...
#endif
                        /* cytsai: 0421 */
                        //dbgArray[dbgIndex++] = 0x00000003;
                        
                        OSCtxSwCtr++;                          /* Keep track of the number of ctx switches */
                        
                        OSIntFIQCtxSw();                          /* Perform interrupt level ctx switch       */
                    }
                }
            }
        }
...
INT8U  OS_TCBInit (INT8U prio, OS_STK *ptos, OS_STK *pbos, INT16U id, INT32U stk_size, void *pext, INT16U opt)
{
    ...
    if (ptcb != (OS_TCB *)0) {
        ...
        /* cytsai: 0421 */     
#if 0 
        osCurStk[prio][0]  = (u32)ptos;              /* sp */
        osCurStk[prio][1]  = (u32)(0x13|0x0);        /* spsr */
        osCurStk[prio][2]  = (u32)(0x13|0x0);        /* cpsr */
        osCurStk[prio][3]  = (u32)0;                 /* r0 */
        osCurStk[prio][4]  = (u32)0;                 /* r1 */
        osCurStk[prio][5]  = (u32)0;                 /* r2 */
        osCurStk[prio][6]  = (u32)0;                 /* r3 */
        osCurStk[prio][7]  = (u32)0;                 /* r4 */
        osCurStk[prio][8]  = (u32)0;                 /* r5 */
        osCurStk[prio][9]  = (u32)0;                 /* r6 */
        osCurStk[prio][10] = (u32)0;                 /* r7 */
        osCurStk[prio][11] = (u32)0;                 /* r8 */
        osCurStk[prio][12] = (u32)0;                 /* r9 */
        osCurStk[prio][13] = (u32)0;                 /* r10 */
        osCurStk[prio][14] = (u32)0;                 /* r11 */
        osCurStk[prio][15] = (u32)0;                 /* r12 */
        osCurStk[prio][16] = (u32)0;                 /* lr */
        osCurStk[prio][17] = (u32)0;                 /* pc */
#endif
