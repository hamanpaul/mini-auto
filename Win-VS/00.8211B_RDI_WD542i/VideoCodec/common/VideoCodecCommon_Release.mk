...
MAKENAME	= VideoCodecCommon_Release.mk
PRINT		= pr
PROGRAM		= none
BUILD_LIB	= Debug\..\..\..\lib\VideoCodecCommon.lib
POST_BUILD	=
...
INC_VIDEOCODEC_COMMON_H=inc\videocodec_common.h ..\..\inc\videocodecapi.h 
...
Release\VideoCodec_common.o: .\src\VideoCodec_common.c \
	 $(______INC_GENERAL_H) ..\..\inc\task.h $(INC_VIDEOCODEC_COMMON_H) \
	  ..\..\inc\asfapi.h ..\..\inc\fsapi.h
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c \
	 .\src\VideoCodec_common.c $(CARM) -o Release\VideoCodec_common.o
