...
CARM_OBJS	= 		  Release\CalAWBGain.o Release\ipu.o 
...
MAKENAME	= ipu_release_Release.mk
PRINT		= pr
PROGRAM		= none
...
Release\CalAWBGain.o: .\src\CalAWBGain.c $(___INC__GENERAL_H)
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c .\src\CalAWBGain.c \
	 $(CARM) -o Release\CalAWBGain.o
Release\ipu.o: .\src\ipu.c $(___INC__GENERAL_H) ..\inc\\board.h inc\\ipu.h \
	 inc\\ipureg.h $(___INC__SIUAPI_H)
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c .\src\ipu.c \
	 $(CARM) -o Release\ipu.o
