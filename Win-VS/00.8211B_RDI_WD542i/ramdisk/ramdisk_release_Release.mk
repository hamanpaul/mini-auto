...
MAKENAME	= ramdisk_release_Release.mk
PRINT		= pr
PROGRAM		= none
BUILD_LIB	= Release\..\..\lib\release\ramdisk_release.lib
POST_BUILD	=
...
Release\ramdisk.o: .\src\ramdisk.c $(___INC__GENERAL_H)  ..\inc\\usbapi.h \
	 ..\inc\\fsapi.h ..\fs\inc\fs_fat.h
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c .\src\ramdisk.c \
	 $(CARM) -o Release\ramdisk.o
