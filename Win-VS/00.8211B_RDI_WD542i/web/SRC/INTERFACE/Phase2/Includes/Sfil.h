 ...
 *
 * * * * Release 4.20  * * *
 *		12/18/02	bva		bump SfsFileNumber size
 * * * * Release 4.12  * * *
 * * * * Release 4.11  * * *
 *		07/01/02	pjr		add SfsOpenFileForWrite and SfsDelete prototypes
 * * * * Release 4.10  * * *
 * * * * Release 4.00  * * *
 * * * * Release 3.0 * * * *
 * * * * Release 2.2 * * * *
...
typedef unsigned short	SfsFileNumber;
...
extern RpErrorCode SfsOpenFileForWrite(SfsFileNumber theFileNumber,
										char *theFullNamePtr);
...
extern RpErrorCode SfsDeleteFile(SfsFileNumber theFileNumber,
										char *theFullNamePtr);

extern RpErrorCode SfsDeleteStatus(SfsFileNumber theFileNumber,
										SfsStatus *theCompletionStatusPtr);
