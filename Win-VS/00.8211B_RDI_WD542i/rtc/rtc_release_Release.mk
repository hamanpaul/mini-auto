...
MAKENAME	= rtc_release_Release.mk
PRINT		= pr
PROGRAM		= none
BUILD_LIB	= Release\..\..\lib\release\rtc_release.lib
POST_BUILD	=
...
# Missing files: 6
#   Selected list: ..\ui\inc\ui.h ..\ui\inc\osd_draw_api.h ..\sys\inc\sys.h 
...
Release\rtc.o: .\src\rtc.c $(___INC__GENERAL_H) ..\inc\\board.h \
	 ..\inc\\rtcapi.h inc\\rtcreg.h ..\inc\\task.h ..\inc\\sysapi.h
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c .\src\rtc.c \
	 $(CARM) -o Release\rtc.o
