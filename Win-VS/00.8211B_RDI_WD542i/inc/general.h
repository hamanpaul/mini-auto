...
typedef signed long long s64;   /* Signed   64 bit quantity                     */
...
#define SYS_TV_OUT_HD720P           0x02
#define SYS_TV_OUT_FHD1080I         0x03
#define SYS_TV_OUT_FHD1080P         0x04


#define TVOUT_OSDx1_VDOx1   0
#define TVOUT_OSDx2_VDOx1   1
...
#if(MAIN_DEBUG_ERR || ALL_DEBUG)
#define DEBUG_MAIN_ERR(fmt...)  printf(fmt)
#else
#define DEBUG_MAIN_ERR(fmt...)  //do { } while (0)
#endif
