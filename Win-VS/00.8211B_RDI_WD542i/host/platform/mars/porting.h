...
#define ICOMM_TASK_PRIORITY = ICOMM_TASK_01_PRIORITY

#define RX_ISR_PRIORITY    0 //No use for uCOS2
#define TMR_TASK_PRIORITY  ICOMM_TASK_01_PRIORITY
#define MLME_TASK_PRIORITY ICOMM_TASK_02_PRIORITY
#define CMD_ENG_PRIORITY   ICOMM_TASK_03_PRIORITY
#define WIFI_RX_PRIORITY  ICOMM_TASK_04_PRIORITY
#define WIFI_TX_PRIORITY   ICOMM_TASK_05_PRIORITY
#define TCPIP_PRIORITY     ICOMM_TASK_06_PRIORITY
#define DHCPD_PRIORITY     ICOMM_TASK_07_PRIORITY
#define NETAPP_PRIORITY    ICOMM_TASK_08_PRIORITY
#define NETAPP_PRIORITY_1  ICOMM_TASK_09_PRIORITY
#define NETAPP_PRIORITY_2  ICOMM_TASK_10_PRIORITY
#define NETMGR_PRIORITY    ICOMM_TASK_11_PRIORITY
#define VDO_ENC_PRIO       ICOMM_TASK_12_PRIORITY
#define MJPG_STREAMER_PRIO ICOMM_TASK_13_PRIORITY
#define TASK_END_PRIO      ICOMM_TASK_14_PRIORITY
...
#define TCPIP_STACK_SIZE     128	//->2048
#define DHCPD_STACK_SIZE     64     //->1024
#define NETAPP1_STACK_SIZE    128	//->2048
#define NETAPP2_STACK_SIZE    128	//->2048
#define NETAPP3_STACK_SIZE    128	//->2048
#define NETMGR_STACK_SIZE    80//64
#define CLI_TASK_STACK_SIZE  64		//->1024
