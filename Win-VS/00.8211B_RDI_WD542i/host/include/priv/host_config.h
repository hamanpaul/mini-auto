...
#define CONFIG_LOG_LEVEL				(LOG_LEVEL_SEVERE)
...
#define TX_TASK_RETRY_CNT           50             // Tx task retry count when tx resource of wifi-chip is not enough
...
#define RC_DEFAULT_RATE_MSK 0xFEF
//#define RC_DEFAULT_RATE_MSK 0xF	//b mode ONLY
