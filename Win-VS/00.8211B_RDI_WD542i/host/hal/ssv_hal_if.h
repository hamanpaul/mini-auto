...
struct ssv_hal_ops
{
    ...
    int (* get_diagnosis)(u32 *pSysIrq, u32 *pWdg, u32 *pChipId0, u32 *pChipId2);
    ...
    int (* get_tx_resources)(u16 *pFreePages, u16 *pFreeIDs);
	...
	extern struct ssv_hal_ops	g_hal_ssv6030;
#endif
