...
CARM_OBJS	= 		  Release\Spiapi.o Release\spi_ESMT.o \
		  Release\spi_WBD_EON.o 
...
MAKENAME	= spi_release_Release.mk
PRINT		= pr
PROGRAM		= none
...
Release\Spiapi.o: .\src\Spiapi.c $(___INC__GENERAL_H) ..\inc\\board.h \
	...
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c .\src\Spiapi.c \
	 $(CARM) -o Release\Spiapi.o
Release\spi_ESMT.o: .\src\spi_ESMT.c $(___INC__GENERAL_H) ..\inc\\board.h \
	 inc\\spi.h inc\\spireg.h ..\inc\\dmaapi.h  ..\inc\\rtcapi.h \
	 $(___INC__DCFAPI_H) ..\inc\\gpioapi.h ..\inc\\spiapi.h \
	 ..\inc\\fsapi.h ..\fs\inc\fs_fat.h
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c .\src\spi_ESMT.c \
	 $(CARM) -o Release\spi_ESMT.o
Release\spi_WBD_EON.o: .\src\spi_WBD_EON.c $(___INC__GENERAL_H) \
	...
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c \
	 .\src\spi_WBD_EON.c $(CARM) -o Release\spi_WBD_EON.o
