...
s32 movCaptureVideoFile(s32 ZoomFactor) /*BJ 0530 S*/
{
...
#if ( (LCM_OPTION == LCM_HX8224) || (LCM_OPTION == LCM_HX8224_SRGB) || (LCM_OPTION == LCM_HX5073_RGB) || (LCM_OPTION == LCM_HX5073_YUV) || (LCM_OPTION == LCM_TPG105) || (LCM_OPTION ==LCM_A015AN04)  || (LCM_OPTION == LCM_TD020THEG1) || (LCM_OPTION == LCM_GPG48238QS4))
    SyncIduIsu();
#endif
...
#if ((HW_BOARD_OPTION==ROULE_DOORPHONE)||(HW_BOARD_OPTION == ROULE_SD8F)||(HW_BOARD_OPTION == ROULE_SD7N)||(HW_BOARD_OPTION == LEIYON_DOORPHONE))
        else if(uiGetMenuMode() == STANDBY_MODE)
        {
    ...
    {       
        ...
        #if(HW_BOARD_OPTION==NEWKEN_PVR_EVB)
        if((OS_tickcounter - timetick) > 10) {
            ledon      ^= 1;
            #if((HW_BOARD_OPTION==AIPTEK_BOARD_V5o)||(HW_BOARD_OPTION==SALIX_SDV)||(HW_BOARD_OPTION==HX_DH500))
