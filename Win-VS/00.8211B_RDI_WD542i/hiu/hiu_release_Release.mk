...
MAKENAME	= hiu_release_Release.mk
PRINT		= pr
PROGRAM		= none
BUILD_LIB	= Release\..\..\lib\release\hiu_release.lib
POST_BUILD	=
...
Release\hiu.o: .\src\hiu.c $(___INC__GENERAL_H) ..\inc\\board.h inc\\hiu.h \
	 inc\\hiureg.h ..\inc\\hiapi.h $(___INC__UIAPI_H) ..\inc\\gpioapi.h \
	 ..\inc\\rtcapi.h  $(___INC__DCFAPI_H) $(___INC__ISUAPI_H) \
	 ..\inc\\iduapi.h ..\inc\\fsapi.h ..\fs\inc\fs_fat.h
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c .\src\hiu.c \
	 $(CARM) -o Release\hiu.o
