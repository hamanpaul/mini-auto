...
MAKENAME	= jpeg_release_Release.mk
PRINT		= pr
PROGRAM		= none
BUILD_LIB	= Release\..\..\lib\release\jpeg_release.lib
POST_BUILD	=
...
Release\jpeg.o: .\src\jpeg.c $(___INC__GENERAL_H) ..\inc\\board.h \
	 inc\\jpeg.h inc\\jpegreg.h ..\inc\\jpegapi.h  ..\inc\\rtcapi.h \
	 $(___INC__DCFAPI_H) ..\inc\\sysapi.h ..\inc\\fsapi.h \
	 ..\fs\inc\fs_fat.h
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c .\src\jpeg.c \
	 $(CARM) -o Release\jpeg.o
