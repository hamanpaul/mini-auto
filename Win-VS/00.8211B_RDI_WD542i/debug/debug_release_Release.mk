...
MAKENAME	= debug_release_Release.mk
PRINT		= pr
PROGRAM		= none
BUILD_LIB	= Release\..\..\lib\release\debug_release.lib
POST_BUILD	=
...
Release\debug.o: .\src\debug.c $(___INC__GENERAL_H) ..\inc\\task.h
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c .\src\debug.c \
	 $(CARM) -o Release\debug.o
