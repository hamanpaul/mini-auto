...
#error "Please define a way to initialize a memory block."
	...
	if (time_in_secs(total_time) > 0)
		...
		*/
    result  = time_in_secs(total_time);
    result1 = (ee_s32)result;
    result2 = (ee_s32)((result - (secs_ret)result1) * 10000);
    ee_printf("Total time (secs): %d.%04d\n", result1, result2);
	if (result > 0) {
        result  = default_num_contexts*results[0].iterations/time_in_secs(total_time);
        result1 = (ee_s32)result;
        result2 = (ee_s32)((result - (secs_ret)result1) * 10000);
		ee_printf("Iterations/Sec   : %d.%04d\n", result1, result2);
	}
#else 
