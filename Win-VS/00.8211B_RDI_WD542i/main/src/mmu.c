...
static struct map_desc standard_io_desc[]  = {
	...
	#endif
	{ VA_SdramBase+SZ_4M   ,SdramBase+SZ_4M   ,SDRAM_SIZE-SZ_4M ,DOMAIN_CLIENT, 0,0,0,0,0},
...
#if( (CHIP_OPTION == CHIP_A1016A) || (CHIP_OPTION == CHIP_A1013B) || (CHIP_OPTION == CHIP_A1016B) || (CHIP_OPTION == CHIP_A1018A) || \
...
static struct map_desc standard_io_desc[]  = {
	...
	{ VA_SdramBase+SZ_4M    ,SdramBase+SZ_4M       ,SDRAM_SIZE-SZ_4M ,0x0,0x0,DOMAIN_CLIENT, 0,0,0},       
...
void  create_mapping(struct map_desc *md)
{
    ...
    {
    DEBUG_MAIN_ERR("Error: MMU AP flag error\n"); 
    }
