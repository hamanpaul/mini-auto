...
#define IDU_CTL_HISH_SPEED_EN           0x08000000 //A1018B function
// DISP_CONF 0x0008
...
//====== TV Setting====//
  ...
  #define TV_OSDFULLSIZE_DISA 0x00000000
  #define TV_OSDFULLSIZE_ENA  0x00000010
  ...
  //0x08
  #define TV_YC_SWAP          0x00000004
  #define TV_UV_SWAP          0x00000008
  
  #define TV_DV_SEL_YUV       0x00000000
  #define TV_DV_SEL_601       0x00004000
  #define TV_DV_SEL_656       0x00008000
