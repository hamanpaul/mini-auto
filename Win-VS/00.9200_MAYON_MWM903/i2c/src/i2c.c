...
#elif (TOUCH_PANEL_DRIVER_GT9271== TOUCH_PANEL)
    u8 i2cInit_GT9271(void);
    bool GT9271_getPosition(int *x, int *y);
#endif
...
#define I2C_SENSOR_WR_SLAV_ADDR    0x00000076
#define I2C_SENSOR_RD_SLAV_ADDR    0x00000077
...
#elif(Sensor_OPTION == Sensor_PO2210K_YUV601)
#define I2C_SENSOR_WR_SLAV_ADDR    0x000000EE
#define I2C_SENSOR_RD_SLAV_ADDR    0x000000EF

#elif(Sensor_OPTION == Sensor_ZN220_YUV601)
#define I2C_SENSOR_WR_SLAV_ADDR    0x00000080
#define I2C_SENSOR_RD_SLAV_ADDR    0x00000081

#elif(Sensor_OPTION == Sensor_XC7021_SC2133)
#define I2C_XC7021_WR_SLAV_ADDR    0x00000036 //ISP
#define I2C_XC7021_RD_SLAV_ADDR    0x00000037

#define I2C_SC2133_WR_SLAV_ADDR    0x00000060 //sensor
#define I2C_SC2133_RD_SLAV_ADDR    0x00000061

#elif(Sensor_OPTION == Sensor_XC7021_GC2023)
#define I2C_XC7021_WR_SLAV_ADDR    0x00000036 //ISP
#define I2C_XC7021_RD_SLAV_ADDR    0x00000037

#define I2C_GC2023_WR_SLAV_ADDR    0x0000006E //sensor
#define I2C_GC2023_RD_SLAV_ADDR    0x0000006F
...
#if(EXT_RTC_SEL == RTC_PCF8563)
#define I2C_RTC_PCF8563_WR_SLAV_ADDR    0x000000A2
#define I2C_RTC_PCF8563_RD_SLAV_ADDR    0x000000A3
#endif

#if(EXT_RTC_SEL == RTC_PT7C43390)
#define I2C_RTC_PT7C43390_WR_SLAV_ADDR    0x00000064
#define I2C_RTC_PT7C43390_RD_SLAV_ADDR    0x00000065

#define I2C_STATUS_PT7C43390_RD_SLAV_ADDR 0x00000061
#define I2C_STATUS_PT7C43390_WR_SLAV_ADDR 0x00000060
#define I2C_CLOCK_PT7C43390_WR_SLAV_ADDR  0x0000006C
#define I2C_CLOCK_PT7C43390_RD_SLAV_ADDR  0x0000006D
#endif

#if(EXT_RTC_SEL == RTC_SD2068)
#define I2C_RTC_SD2068_WR_SLAV_ADDR    0x00000064
#define I2C_RTC_SD2068_RD_SLAV_ADDR    0x00000065
#endif

#if(EXT_RTC_SEL == RTC_HM8563)
#define I2C_RTC_HM8563_WR_SLAV_ADDR    0x000000A2
#define I2C_RTC_HM8563_RD_SLAV_ADDR    0x000000A3
#endif

#if(Video_Processer == Video_Processer_VX9988)
#define I2C_VX9988_RD_SLAV_ADDR   0x89
#define I2C_VX9988_WR_SLAV_ADDR   0x88
#endif

#if(TOUCH_PANEL == TOUCH_PANEL_DRIVER_GT9271)
#define I2C_TOUCH_GT9271_WR_SLAV_ADDR    0x000000BA
#define I2C_TOUCH_GT9271_RD_SLAV_ADDR    0x000000BB
#endif

#if(DOOR_BELL_SUPPORT)
#define I2C_433RFMod_R_SLAV_ADDR  0x00000061
#define I2C_433RFMod_W_SLAV_ADDR  0x00000060
#endif
...
#if(Video_Processer == Video_Processer_VX9988)
#define INIT_TABLE_LEN 237
#define SWITCH_TABLE_LEN 31
const u8 i2cVX9988_init_Table[INIT_TABLE_LEN][2] = {
{0x01, 0x00}, {0x02, 0x00}, {0x03, 0xF5}, {0x04, 0x18}, {0x05, 0x80},
{0x06, 0x20}, {0x07, 0x0A}, {0x08, 0x41}, {0x09, 0x12}, {0x0A, 0x20},
{0x0B, 0x0B}, {0x0C, 0x08}, {0x0D, 0x20}, {0x0E, 0x10}, {0x0F, 0x00},
{0x10, 0x0A}, {0x11, 0x10}, {0x12, 0x00}, {0x13, 0x00}, {0x14, 0x00},
{0x15, 0x88}, {0x16, 0x00}, {0x17, 0x00}, {0x18, 0x00}, {0x19, 0x01},
{0x1A, 0x25}, {0x1B, 0x24}, {0x1C, 0x00}, {0x1D, 0x00}, {0x1E, 0x40},
{0x1F, 0x64}, {0x20, 0x00}, {0x21, 0x58}, {0x22, 0x4E}, {0x23, 0x2C},
{0x24, 0x30}, {0x25, 0x18}, {0x26, 0x20}, {0x27, 0x03}, {0x28, 0x08},
{0x29, 0x60}, {0x2A, 0x86}, {0x2B, 0x1C}, {0x2C, 0x00}, {0x2D, 0x07},
{0x2E, 0x23}, {0x2F, 0x5F}, {0x30, 0x1B}, {0x31, 0x96}, {0x32, 0x80},
{0x33, 0x80}, {0x34, 0xA8}, {0x35, 0x18}, {0x36, 0x46}, {0x37, 0x64},
{0x38, 0x00}, {0x39, 0x80}, {0x3A, 0x00}, {0x3B, 0x80}, {0x3C, 0x80},
{0x3D, 0x80}, {0x3E, 0x80}, {0x3F, 0x80}, {0x40, 0x64}, {0x41, 0x60},
{0x42, 0x5F}, {0x43, 0x37}, {0x44, 0x14}, {0x45, 0x05}, {0x46, 0xC8},
{0x47, 0xFF}, {0x48, 0x80}, {0x49, 0x00}, {0x4B, 0x20}, {0x4C, 0x00},
{0x4D, 0x00}, {0x4E, 0x00}, {0x4F, 0x7F}, {0x50, 0x20}, {0x51, 0x20},
{0x52, 0x00}, {0x53, 0x04}, {0x54, 0x00}, {0x55, 0xA0}, {0x56, 0x40},
{0x57, 0x04}, {0x58, 0x10}, {0x59, 0x08}, {0x5A, 0x10}, {0x5B, 0x00},
{0x5C, 0x68}, {0x5D, 0x84}, {0x5E, 0x08}, {0x5F, 0x21}, {0x60, 0x20},
{0x61, 0xB0}, {0x62, 0x33}, {0x63, 0x01}, {0x64, 0xFF}, {0x65, 0x01},
{0x66, 0xFF}, {0x67, 0x89}, {0x68, 0xAB}, {0x69, 0x28}, {0x6A, 0x6E},
{0x6B, 0x6E}, {0x6C, 0x6E}, {0x6D, 0x00}, {0x6E, 0x00}, {0x6F, 0x00},
{0x70, 0x00}, {0x71, 0x00}, {0x72, 0x00}, {0x73, 0x00}, {0x74, 0x00},
{0x75, 0xFF}, {0x76, 0xFF}, {0x77, 0xFF}, {0x78, 0xFF}, {0x79, 0xFF},
{0x7A, 0xFF}, {0x7B, 0xFF}, {0x7C, 0xFF}, {0x7D, 0xF0}, {0x7E, 0x80},
{0x7F, 0x08}, {0x80, 0x00}, {0x81, 0x00}, {0x82, 0x01}, {0x83, 0x06},
{0x84, 0xF0}, {0x85, 0x1A}, {0x86, 0x03}, {0x87, 0x1D}, {0x88, 0xA0},
{0x89, 0x18}, {0x8A, 0x00}, {0x8B, 0x7E}, {0x8C, 0x03}, {0x8D, 0x88},
{0x8E, 0x70}, {0x8F, 0x00}, {0x90, 0x70}, {0x91, 0x01}, {0x92, 0xC2},
{0x93, 0x53}, {0x94, 0x89}, {0x95, 0x40}, {0x96, 0x0B}, {0x97, 0x5B},
{0x98, 0x02}, {0x99, 0xD0}, {0x9A, 0x21}, {0x9B, 0x0C}, {0x9D, 0x1E},
{0x9E, 0x02}, {0x9F, 0x8A}, {0xA0, 0x50}, {0xA1, 0x0C}, {0xA2, 0x40},
{0xA3, 0x54}, {0xA4, 0xA3}, {0xA5, 0x19}, {0xA6, 0x6C}, {0xA7, 0x12},
{0xA8, 0x40}, {0xA9, 0x00}, {0xAA, 0x2E}, {0xAB, 0x00}, {0xAC, 0x4C},
{0xAD, 0x0B}, {0xAE, 0x8A}, {0xAF, 0x0C}, {0xB0, 0x00}, {0xB1, 0x00},
{0xB2, 0x00}, {0xB3, 0x00}, {0xB4, 0x00}, {0xB5, 0x00}, {0xB6, 0x00},
{0xB7, 0x00}, {0xB8, 0x00}, {0xB9, 0x00}, {0xBA, 0x00}, {0xBB, 0x00},
{0xBC, 0x00}, {0xBD, 0x20}, {0xBE, 0x00}, {0xC0, 0x00}, {0xC1, 0x00},
{0xC2, 0x00}, {0xD0, 0xFC}, {0xD1, 0xFF}, {0xD2, 0x08}, {0xD3, 0xFC},
{0xD4, 0x01}, {0xD5, 0x10}, {0xD6, 0x00}, {0xD7, 0x10}, {0xD8, 0x00},
{0xDB, 0x00}, {0xDC, 0x00}, {0xDD, 0x00}, {0xDE, 0x87}, {0xDF, 0x98},
{0xE0, 0x80}, {0xE1, 0x22}, {0xE2, 0x33}, {0xE3, 0x1C}, {0xE4, 0x00},
{0xE5, 0xAF}, {0xE6, 0xA0}, {0xE7, 0xF0}, {0xE8, 0x00}, {0xE9, 0x00},
{0xEA, 0x00}, {0xEB, 0x00}, {0xEC, 0x00}, {0xED, 0x27}, {0xEE, 0x80},
{0xEF, 0x1C}, {0xF0, 0x35}, {0xF1, 0x43}, {0xF2, 0x1F}, {0xF3, 0x1F},
{0xF4, 0x22}, {0xF5, 0x73}, {0xF6, 0x53}, {0xF7, 0x55}, {0xF8, 0x01},
{0xF9, 0x01}, {0xFA, 0x00}, {0xFB, 0x00}, {0xFC, 0x00}, {0xFD, 0x00},
{0xFE, 0x00}, {0xFF, 0x00}
};

const u8 i2cVX9988_720P_Table[SWITCH_TABLE_LEN][2]=
{
{0x0B,0x0B}, {0x84,0xF0}, {0x85,0x1A}, {0x88,0xA0}, {0x93,0x53},
{0x94,0x89}, {0x95,0x40}, {0x96,0x0B}, {0x97,0x5B}, {0x98,0x02},
{0x99,0xD0}, {0x9D,0x1E}, {0xA1,0x0C}, {0xA4,0xA3}, {0xA5,0x19},
{0xA6,0x6C}, {0xA7,0x12}, {0xA9,0x00}, {0xAC,0x4C}, {0xAD,0x0B},
{0xDE,0x65}, {0xDF,0x72}, {0xE0,0x00}, {0xE2,0xEE}, {0xE3,0xD0},
{0xE6,0xC8}, {0xED,0x25}, {0xEE,0x00}, {0xEF,0xD0}, {0xF0,0x35},
{0xF7,0x55}
};

const u8 i2cVX9988_1080I_Table[SWITCH_TABLE_LEN][2]=
{
{0x0B,0x0C}, {0x84,0xF2}, {0x85,0x15}, {0x88,0x9E}, {0x93,0x82},
{0x94,0x16}, {0x95,0x80}, {0x96,0x42}, {0x97,0x7A}, {0x98,0x01},
{0x99,0xF0}, {0x9D,0x6F}, {0xA1,0x0E}, {0xA4,0x28}, {0xA5,0x71},
{0xA6,0xCC}, {0xA7,0x56}, {0xA9,0x0C}, {0xAC,0x48}, {0xAD,0x42},
{0xDE,0x87}, {0xDF,0x98}, {0xE0,0x80}, {0xE2,0x32}, {0xE3,0x1C},
{0xE6,0xF0}, {0xED,0x27}, {0xEE,0x80}, {0xEF,0x1C}, {0xF0,0x31},
{0xF7,0x14}
};
...
const u8 i2cGT9271_Config[186] =
{
 0x43, 0x58, 0x02, 0x00, 0x04, 0x01, 0x35, 0x20, 0x11, 0x0F, 
 0x14, 0x0F, 0x50, 0x32, 0x03, 0x0F, 0x00, 0x00, 0x00, 0x00, 
 0x00, 0x00, 0x00, 0x18, 0x1A, 0x1E, 0x14, 0x90, 0x30, 0xAA, 
 0x1E, 0x20, 0x0C, 0x08, 0x00, 0x00, 0x00, 0xA2, 0x03, 0x1D, 
 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
 0x00, 0x0F, 0x2D, 0x94, 0xC5, 0x02, 0x07, 0x00, 0x00, 0x04, 
 0xD5, 0x10, 0x00, 0xB0, 0x14, 0x00, 0x8E, 0x1A, 0x00, 0x7A, 
 0x20, 0x00, 0x68, 0x28, 0x00, 0x68, 0x00, 0x00, 0x00, 0x00, 
 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
...
s32 i2cWrite_SENSOR(u16, u16);
s32 i2cRead_SENSOR(u16, u16*);
...
void gpio_TVInSwithc2SensorIn(void);
  ...
  s32 i2cWrite_WM8940(u8 addr, u16 data);
  s32 i2cRead_WM8940(u8 addr, u16* pData);
  void Init_IIS_WM8940_play(void);
  void Init_IIS_WM8940_rec(void);
  void IIS_WM8940_reset(void);
  /*
...
#if HDCVIENC_SUPPORT
  void i2cInit_DH9801(void);
#endif

#if AHD_NVP6021_SUPPORT
  void i2cInit_NVP6020(char vmode);
#endif

#if(Video_Processer == Video_Processer_VX9988)
    u8 i2cInit_VX9988(void);
    u8 i2cCmd_VX9988_SwitchResolution(u8 u8Type);

#endif

#if(EXT_RTC_SEL == RTC_HM8563)
    void HM8563_RTC_Init(void);
#endif
...
s32 i2cWrite_HM5065(u16 addr, u8 data)
{
    u8 err;
    u8 data2;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cWrite_HM5065 i2cSemReq is %d.\n", err);
        return 0;
    }
    I2cData = ((((u32)addr) << 8) | data);
    I2cCtrl = I2C_ENA | I2C_3B | I2C_CLK_DIV_1920 | (I2C_SENSOR_WR_SLAV_ADDR << I2C_SLAV_ADDR_SHFT) |I2C_INT_ENA ;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cWrite_HM5065 i2cSemFin is %d.\n", err);
        OSSemPost(i2cSemReq);
        return 0;
    }
...
s32 i2cRead_HM5065(u16 addr, u8* pData)
{
    u8 err;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cRead_HM5065 i2cSemReq is %d.\n", err);
        return 0;
    }
#if 1
    // write 2 bytes register address
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cRead_HM5065 write 2 bytes register address i2cSemFin is %d.\n", err);
        OSSemPost(i2cSemReq);
        return 0;
    }
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cRead_HM5065 read 1 byte data i2cSemFin is %d.\n", err);
        OSSemPost(i2cSemReq);
        return 0;
    }

    *pData = (u8)(I2cData & 0xff);
    //DEBUG_I2C("read HM5065 i2c addr = 0x%04x, i2c data = 0x%02x\n", addr, *pData);
    OSSemPost(i2cSemReq);
    return 1;
#else
    if (!gpio_IIC_Read(IIC_DEV_HM5065, I2C_HM5065_WR_SLAV_ADDR, addr, pData))
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_HM5065() gpio IIC Read Addr [%#x] Error!!!\n", addr);
        return 0;
    }
    else
    {
...
s32 i2cWrite_NT99340(u16 addr, u8 data)
{
    u8 err;
    u8 data2;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cWrite_NT99340 i2cSemReq is %d.\n", err);
        return 0;
    }
    I2cData = ((((u32)addr) << 8) | data);
    I2cCtrl = I2C_ENA | I2C_3B | I2C_CLK_DIV_1920 | (I2C_SENSOR_WR_SLAV_ADDR << I2C_SLAV_ADDR_SHFT) |I2C_INT_ENA ;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cWrite_NT99340 i2cSemFin is %d.\n", err);
        OSSemPost(i2cSemReq);
        return 0;
    }
...
s32 i2cRead_NT99340(u16 addr, u8* pData)
{
    u8 err;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cRead_NT99340 i2cSemReq is %d.\n", err);
        return 0;
    }
#if 1
    // write 2 bytes register address
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cRead_NT99340 write 2 bytes register address i2cSemFin is %d.\n", err);
        OSSemPost(i2cSemReq);
        return 0;
    }
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cRead_NT99340 read 1 byte data i2cSemFin is %d.\n", err);
        OSSemPost(i2cSemReq);
        return 0;
    }

    *pData = (u8)(I2cData & 0xff);
    //DEBUG_I2C("read NT99340 i2c addr = 0x%04x, i2c data = 0x%02x\n", addr, *pData);
    OSSemPost(i2cSemReq);
    return 1;
#else
    if (!gpio_IIC_Read(IIC_DEV_NT99340, I2C_NT99340_WR_SLAV_ADDR, addr, pData))
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_NT99340() gpio IIC Read Addr [%#x] Error!!!\n", addr);
        return 0;
    }
    else
    {
...
s32 i2cRead_NT99340_Manual(u16 ucRegAddr, u8* pucData)
{
    u8 err;
    u32 i;
    u8 subReg=0;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cRead_NT99340_Manual(0x%02x, 0x%02x), i2cSemReq is %d.\n",  ucRegAddr, *pucData, err);
        return 0;
    }
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_NT99340_Manual() IIC Start 1 Error!!!\n");
        return 0;
    }
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_NT99340_Manual() IIC Write Slave Addr 0x%02x Error!!!\n", I2C_SENSOR_WR_SLAV_ADDR);
        return 0;
    }
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_NT99340_Manual() IIC Write Sub Addr 0x%04x high byte Error!!!\n", ucRegAddr);
        return 0;
    }
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_NT99340_Manual() IIC Start 2 Error!!!\n");
        return 0;
    }
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_NT99340_Manual() IIC Read Data Error!!!\n");
        return 0;
    }
    ...
    *pucData  = (u8)I2cData;
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_NT99340_Manual() IIC Stop Error!!!\n");
        return 0;
    }
    else
    {
...
#if (Sensor_OPTION ==Sensor_NT99230_YUV601)

s32 i2cWrite_NT99230(u16 addr, u8 data)
{
    u8 err;
    u8 data2;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cWrite_ NT99230 i2cSemReq is %d.\n", err);
        return 0;
    }
    I2cData = ((((u32)addr) << 8) | data);
    I2cCtrl = I2C_ENA | I2C_3B | I2C_CLK_DIV_1920 | (I2C_SENSOR_WR_SLAV_ADDR << I2C_SLAV_ADDR_SHFT) |I2C_INT_ENA ;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cWrite_ NT99230 i2cSemFin is %d.\n", err);
        OSSemPost(i2cSemReq);
        return 0;
    }
...
s32 i2cRead_NT99230(u16 addr, u8* pData)
{
    u8 err;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cRead_NT99230 i2cSemReq is %d.\n", err);
        return 0;
    }
#if 1
    // write 2 bytes register address
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cRead_NT99230 write 2 bytes register address i2cSemFin is %d.\n", err);
        OSSemPost(i2cSemReq);
        return 0;
    }
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cRead_NT99230 read 1 byte data i2cSemFin is %d.\n", err);
        OSSemPost(i2cSemReq);
        return 0;
    }

    *pData = (u8)(I2cData & 0xff);
    //DEBUG_I2C("read  NT99230 i2c addr = 0x%04x, i2c data = 0x%02x\n", addr, *pData);
    OSSemPost(i2cSemReq);
    return 1;
#else
    if (!gpio_IIC_Read(IIC_DEV_ NT99230, I2C_ NT99230_WR_SLAV_ADDR, addr, pData))
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_ NT99230() gpio IIC Read Addr [%#x] Error!!!\n", addr);
        return 0;
    }
    else
    {
...
s32 i2cRead_NT99230_Manual(u16 ucRegAddr, u16* pucData)
{
    u8 err;
    u32 i;
    u8 subReg=0;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cRead_NT99230_Manual(0x%02x, 0x%02x), i2cSemReq is %d.\n",  ucRegAddr, *pucData, err);
        return 0;
    }
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_NT99230_Manual() IIC Start 1 Error!!!\n");
        return 0;
    }
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_ NT99230_Manual() IIC Write Slave Addr 0x%02x Error!!!\n", I2C_SENSOR_WR_SLAV_ADDR);
        return 0;
    }
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_ NT99230_Manual() IIC Write Sub Addr 0x%04x high byte Error!!!\n", ucRegAddr);
        return 0;
    }
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_ NT99230_Manual() IIC Start 2 Error!!!\n");
        return 0;
    }
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_ NT99230_Manual() IIC Read Data Error!!!\n");
        return 0;
    }
    ...
    *pucData  = (u8)I2cData;
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_ NT99230_Manual() IIC Stop Error!!!\n");
        return 0;
    }
    else
    {
...
s32 i2cRead_PO3100K(u8 addr, u16* pData)
{
    u8 err;
...
s32 i2cWrite_PO2210K(u8 addr, u8 data)
{
    u8 err;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cWrite_PO2210K(0x%02x, 0x%02x), i2cSemReq is %d.\n", addr, data, err);
        return 0;
    }
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cWrite_PO2210K(0x%02x, 0x%02x), i2cSemFin is %d.\n", addr, data, err);
        OSSemPost(i2cSemReq);
        return 0;
    }
...
s32 i2cRead_PO2210K(u8 addr, u16* pData)
{
    u8 err;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cRead_PO2210K(0x%02x, 0x%02x), i2cSemReq is %d.\n", addr, *pData, err);
        return 0;
    }
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cRead_PO2210K(0x%02x, 0x%02x), i2cSemFin is %d.\n", addr, *pData, err);
        OSSemPost(i2cSemReq);
        return 0;
    }
...
s32 i2cWrite_ZN220(u8 addr, u8 data)
{
    u8 err;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cWrite_ZN220(0x%02x, 0x%02x), i2cSemReq is %d.\n", addr, data, err);
        return 0;
    }
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cWrite_ZN220(0x%02x, 0x%02x), i2cSemFin is %d.\n", addr, data, err);
        OSSemPost(i2cSemReq);
        return 0;
    }
...
s32 i2cRead_ZN220(u8 addr, u16* pData)
{
    u8 err;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cRead_ZN220(0x%02x, 0x%02x), i2cSemReq is %d.\n", addr, *pData, err);
        return 0;
    }
    ...
    //I2cCtrl = I2C_ENA | I2C_1B | I2C_CLK_DIV_480 | (I2C_SENSOR_RD_SLAV_ADDR << I2C_SLAV_ADDR_SHFT) | I2C_INT_ENA | I2C_SENS_CLK_DIV_1;
    //I2cCtrl |= I2C_TRIG;

    OSSemPend(i2cSemFin, I2C_TIMEOUT, &err);
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cRead_ZN220(0x%02x, 0x%02x), i2cSemFin is %d.\n", addr, *pData, err);
        OSSemPost(i2cSemReq);
        return 0;
    }
...
s32 i2cWrite_XC7021(u16 addr, u8 data)
{
    u8 err;
    u8 data2;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cWrite_XC7021 i2cSemReq is %d.\n", err);
        return 0;
    }
    I2cData = ((((u32)addr) << 8) | data);
    I2cCtrl = I2C_ENA | I2C_3B | I2C_CLK_DIV_480 | (I2C_XC7021_WR_SLAV_ADDR << I2C_SLAV_ADDR_SHFT) |I2C_INT_ENA ;
    I2cCtrl = I2C_TRIG | I2cCtrl;

    OSSemPend(i2cSemFin, I2C_TIMEOUT, &err);
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cWrite_XC7021 i2cSemFin is %d.\n", err);
        OSSemPost(i2cSemReq);
        return 0;
    }
...
s32 i2cRead_XC7021(u16 addr, u16* pData)
{
    u8 err;
    u32 i;
    u8 subReg=0;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cRead_XC7021(0x%02x, 0x%02x), i2cSemReq is %d.\n",  addr, *pData, err);
        return 0;
    }

    I2cCtrl     = I2C_MANUAL_EN  |I2C_2B| I2C_R_ACK | I2C_ENA | I2C_CLK_DIV_480  | (I2C_XC7021_WR_SLAV_ADDR<< I2C_SLAV_ADDR_SHFT) | ( subReg << I2C_SUB_ADDR_SHFT);
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_XC7021() IIC Start 1 Error!!!\n");
        return 0;
    }
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_XC7021() IIC Write Slave Addr 0x%02x Error!!!\n", I2C_XC7021_WR_SLAV_ADDR);
        return 0;
    }
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_XC7021() IIC Write Sub Addr 0x%04x high byte Error!!!\n", addr);
        return 0;
    }
    ...
    /* Start */
    I2cCtrl     = I2C_MANUAL_EN | I2C_R_ACK | I2C_ENA | I2C_1B | I2C_CLK_DIV_480  | (I2C_XC7021_RD_SLAV_ADDR<< I2C_SLAV_ADDR_SHFT);
    I2cManu     = I2C_ManuSBIT;
    for(i = 0; (i < 1000) && ((I2cCtrl & I2C_BUSY) || (I2cManu & I2C_ManuSBIT)); i++);
    if((I2cCtrl & I2C_BUSY) || (I2cManu & I2C_ManuSBIT))
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_XC7021() IIC Start 2 Error!!!\n");
        return 0;
    }
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_XC7021() IIC Read Data Error!!!\n");
        return 0;
    }
    ...
    *pData  = (u8)I2cData;
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_XC7021() IIC Stop Error!!!\n");
        return 0;
    }
    else
    {
...
s32 i2cWrite_SC2133(u16 addr, u8 data)
{
    u8 err;
    u8 data2;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cWrite_SC2133 i2cSemReq is %d.\n", err);
        return 0;
    }
    I2cData = ((((u32)addr) << 8) | data);
    I2cCtrl = I2C_ENA | I2C_3B | I2C_CLK_DIV_1920 | (I2C_SC2133_WR_SLAV_ADDR << I2C_SLAV_ADDR_SHFT) |I2C_INT_ENA ;
    I2cCtrl = I2C_TRIG | I2cCtrl;

    OSSemPend(i2cSemFin, I2C_TIMEOUT, &err);
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cWrite_SC2133 i2cSemFin is %d.\n", err);
        OSSemPost(i2cSemReq);
        return 0;
    }
...
s32 i2cRead_SC2133(u16 addr, u16* pData)
{
    u8 err;
    u32 i;
    u8 subReg=0;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cRead_SC2133(0x%02x, 0x%02x), i2cSemReq is %d.\n",  addr, *pData, err);
        return 0;
    }

    I2cCtrl     = I2C_MANUAL_EN  |I2C_2B| I2C_R_ACK | I2C_ENA | I2C_CLK_DIV_1920  | (I2C_SC2133_WR_SLAV_ADDR<< I2C_SLAV_ADDR_SHFT) | ( subReg << I2C_SUB_ADDR_SHFT);
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_SC2133() IIC Start 1 Error!!!\n");
        return 0;
    }
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_SC2133() IIC Write Slave Addr 0x%02x Error!!!\n", I2C_SC2133_WR_SLAV_ADDR);
        return 0;
    }
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_SC2133() IIC Write Sub Addr 0x%04x high byte Error!!!\n", addr);
        return 0;
    }
    ...
    /* Start */
    I2cCtrl     = I2C_MANUAL_EN | I2C_R_ACK | I2C_ENA | I2C_1B | I2C_CLK_DIV_480  | (I2C_SC2133_RD_SLAV_ADDR<< I2C_SLAV_ADDR_SHFT);
    I2cManu     = I2C_ManuSBIT;
    for(i = 0; (i < 1000) && ((I2cCtrl & I2C_BUSY) || (I2cManu & I2C_ManuSBIT)); i++);
    if((I2cCtrl & I2C_BUSY) || (I2cManu & I2C_ManuSBIT))
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_SC2133() IIC Start 2 Error!!!\n");
        return 0;
    }
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_SC2133() IIC Read Data Error!!!\n");
        return 0;
    }
    ...
    *pData  = (u8)I2cData;
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_SC2133() IIC Stop Error!!!\n");
        return 0;
    }
    else
    {
...
s32 i2cWrite_SC2133_command(u16 addr, u8 data)
{
    i2cWrite_XC7021(0xfffd,0x80);
    i2cWrite_XC7021(0xfffe,0x50);
    i2cWrite_XC7021(0x004D,0x01);
    i2cWrite_SC2133(addr,data);
    i2cWrite_XC7021(0xfffd,0x80);
    i2cWrite_XC7021(0xfffe,0x50);
    i2cWrite_XC7021(0x004D,0x00);
    
}
s32 i2cRead_SC2133_command(u16 addr, u16* pData)
{
    i2cWrite_XC7021(0xfffd,0x80);
    i2cWrite_XC7021(0xfffe,0x50);
    i2cWrite_XC7021(0x004D,0x01);
    i2cRead_SC2133(addr,pData);
    i2cWrite_XC7021(0xfffd,0x80);
    i2cWrite_XC7021(0xfffe,0x50);
    i2cWrite_XC7021(0x004D,0x00);
}
...
s32 i2cWrite_GC2023(u16 addr, u8 data)
{
    u8 err;
    u8 data2;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cWrite_GC2023 i2cSemReq is %d.\n", err);
        return 0;
    }
    I2cData = ((((u32)addr) << 8) | data);
    I2cCtrl = I2C_ENA | I2C_2B | I2C_CLK_DIV_480 | (I2C_GC2023_WR_SLAV_ADDR << I2C_SLAV_ADDR_SHFT) |I2C_INT_ENA ;
    I2cCtrl = I2C_TRIG | I2cCtrl;

    OSSemPend(i2cSemFin, I2C_TIMEOUT, &err);
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cWrite_GC2023 i2cSemFin is %d.\n", err);
        OSSemPost(i2cSemReq);
        return 0;
    }
...
s32 i2cRead_GC2023(u16 addr, u16* pData)
{
    u8 err;
    u32 i;
    u8 subReg=0;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cRead_GC2023(0x%02x, 0x%02x), i2cSemReq is %d.\n",  addr, *pData, err);
        return 0;
    }

    I2cCtrl     = I2C_MANUAL_EN  |I2C_1B| I2C_R_ACK | I2C_ENA | I2C_CLK_DIV_480  | (I2C_GC2023_WR_SLAV_ADDR<< I2C_SLAV_ADDR_SHFT) | ( subReg << I2C_SUB_ADDR_SHFT);
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_GC2023() IIC Start 1 Error!!!\n");
        return 0;
    }
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_GC2023() IIC Write Slave Addr 0x%02x Error!!!\n", I2C_GC2023_WR_SLAV_ADDR);
        return 0;
    }
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_GC2023() IIC Write Sub Addr 0x%04x high byte Error!!!\n", addr);
        return 0;
    }
*/
    /* Reg Addr (bit 7:0) */
    ...
    /* Start */ //I2C_R_ACK |
    I2cCtrl     = I2C_MANUAL_EN |  I2C_ENA | I2C_1B | I2C_CLK_DIV_480  | (I2C_GC2023_RD_SLAV_ADDR<< I2C_SLAV_ADDR_SHFT);
    I2cManu     = I2C_ManuSBIT;
    for(i = 0; (i < 1000) && ((I2cCtrl & I2C_BUSY) || (I2cManu & I2C_ManuSBIT)); i++);
    if((I2cCtrl & I2C_BUSY) || (I2cManu & I2C_ManuSBIT))
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_GC2023() IIC Start 2 Error!!!\n");
        return 0;
    }
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_GC2023() IIC Read Data Error!!!\n");
        return 0;
    }
    ...
    *pData  = (u8)I2cData;
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_GC2023() IIC Stop Error!!!\n");
        return 0;
    }
    else
    {
...
s32 i2cWrite_GC2023_command(u16 addr, u8 data)
{
    i2cWrite_XC7021(0xfffd,0x80);
    i2cWrite_XC7021(0xfffe,0x50);
    i2cWrite_XC7021(0x004D,0x01);
    i2cWrite_GC2023(addr,data);
    i2cWrite_XC7021(0xfffd,0x80);
    i2cWrite_XC7021(0xfffe,0x50);
    i2cWrite_XC7021(0x004D,0x00);
    
}
s32 i2cRead_GC2023_command(u16 addr, u16* pData)
{
    i2cWrite_XC7021(0xfffd,0x80);
    i2cWrite_XC7021(0xfffe,0x50);
    i2cWrite_XC7021(0x004D,0x01);
    i2cRead_GC2023(addr,pData);
    i2cWrite_XC7021(0xfffd,0x80);
    i2cWrite_XC7021(0xfffe,0x50);
    i2cWrite_XC7021(0x004D,0x00);
}
...
*/
s32 i2cWrite_SENSOR(u16 addr, u16 data)
{

#if ( (Sensor_OPTION == Sensor_OV7725_VGA) || (Sensor_OPTION ==Sensor_OV7725_YUV601) || (Sensor_OPTION == Sensor_OV7740_YUV601) || (Sensor_OPTION ==Sensor_CCIR601_MIX_OV7740YUV) ||\
      (Sensor_OPTION == Sensor_OV7740_RAW) || (Sensor_OPTION == Sensor_PC1089_YUV601) || (Sensor_OPTION == Sensor_OV2643_YUV601) || (Sensor_OPTION ==Sensor_MI_5M) )
    u8 err;
    OSSemPend(i2cSemReq, I2C_TIMEOUT, &err);
    if (err != OS_NO_ERR)
    {
...
//  I2cData = ((u32)data) << 16;
    ...
    return 1;
#elif (Sensor_OPTION == Sensor_PO3100K_YUV601)
    i2cWrite_PO3100K(addr, data);
#elif (Sensor_OPTION == Sensor_PO2210K_YUV601)
    i2cWrite_PO2210K(addr, data);
#elif (Sensor_OPTION == Sensor_ZN220_YUV601)
    i2cWrite_ZN220(addr, data);
#elif (Sensor_OPTION ==Sensor_NT99230_YUV601)
    i2cWrite_NT99230(addr, data);
#elif (Sensor_OPTION ==Sensor_XC7021_SC2133)
    i2cWrite_SC2133_command(addr, data);
#elif (Sensor_OPTION ==Sensor_XC7021_GC2023)
    i2cWrite_GC2023_command(addr, data);
#endif
    return 1;
}
...
*/
s32 i2cRead_SENSOR(u16 addr, u16* pData)
{
    u8 err;

#if ( (Sensor_OPTION == Sensor_OV7725_VGA) || (Sensor_OPTION ==Sensor_OV7725_YUV601) || (Sensor_OPTION == Sensor_OV7740_YUV601) ||\
      (Sensor_OPTION ==Sensor_CCIR601_MIX_OV7740YUV) || (Sensor_OPTION == Sensor_OV7740_RAW) || (Sensor_OPTION == Sensor_PC1089_YUV601) ||\
      (Sensor_OPTION == Sensor_OV2643_YUV601) || (Sensor_OPTION ==Sensor_MI_5M) )
    //---First step---//
    OSSemPend(i2cSemReq, I2C_TIMEOUT, &err);
    if (err != OS_NO_ERR)
    {
...
#elif (Sensor_OPTION == Sensor_PO3100K_YUV601)
    i2cRead_PO3100K(addr, pData);
#elif (Sensor_OPTION == Sensor_PO2210K_YUV601)
    i2cRead_PO2210K(addr, pData);
#elif (Sensor_OPTION == Sensor_ZN220_YUV601)
    i2cRead_ZN220(addr, pData);
#elif (Sensor_OPTION ==Sensor_NT99230_YUV601)
    i2cRead_NT99230_Manual(addr, pData);
#elif (Sensor_OPTION ==Sensor_XC7021_SC2133)
    i2cRead_SC2133_command(addr, pData);
#elif (Sensor_OPTION ==Sensor_XC7021_GC2023)
    i2cRead_GC2023_command(addr, pData);
#else
    OSSemPend(i2cSemReq, I2C_TIMEOUT, &err);
    if (err != OS_NO_ERR)
    {
...
s32 i2cInit(void)
{
    ...
    DEBUG_I2C("VX9988_init VX9988_SwitchResolution\n");
    #endif
    return 1;
}


#if( ( (SW_APPLICATION_OPTION == MR8600_RFAVSED_RX1RX2) || (SW_APPLICATION_OPTION == MR8600_RFAVSED_RX1) ) && (CHIP_A1016A))
...
s32 i2cDeviceInit(void)
{
    ...
    i=0;
#if(  (FPGA_BOARD_A1018_SERIES) || \
      (SW_APPLICATION_OPTION == MR8120_RFCAM_TX1) || (SW_APPLICATION_OPTION == MR9120_RFCAM_TX5) || (SW_APPLICATION_OPTION == MR9120_RFCAM_TX5_SUBSTREAM) || (SW_APPLICATION_OPTION == MR9120_RFCAM_TX5_MUTISTREAM) || \
      ...
      (SW_APPLICATION_OPTION == MR9120_RFCAM_TX1_SUBSTREAM)|| (SW_APPLICATION_OPTION == MR9120_RFCAM_TX1_MUTISTREAM) || (SW_APPLICATION_OPTION == MR8211_IPCAM) || \
      (SW_APPLICATION_OPTION == FPGA_VERIFY_TEST_CIU) || (SW_APPLICATION_OPTION == FPGA_VERIFY_TEST_SIU) || (SW_APPLICATION_OPTION == FPGA_VERIFY_TEST_IDU) || (SW_APPLICATION_OPTION == FPGA_VERIFY_TEST_USB_HOST) )
        ...
        (SW_APPLICATION_OPTION == MR9100_AHDINREC_TX5) || (SW_APPLICATION_OPTION == MR8110_RFCAM_TX1) ||\
        (SW_APPLICATION_OPTION == MR9120_RFCAM_TX1_SUBSTREAM) || (SW_APPLICATION_OPTION == MR9120_RFCAM_TX1_MUTISTREAM) ) && (CIU1_OPTION == Sensor_HM1375_YUV601) )
...
#endif
#if (AUDIO_DEVICE== AUDIO_IIS_WM8940)
Init_IIS_WM8940_MicRec_AuxPlay();
...
s32 i2cDeviceInit2(void)
{
#if AHD_NVP6021_SUPPORT
  #if (SW_APPLICATION_OPTION == MR9100_RF_AHDIN_AVSED_RX1)
    if (TvOutMode==SYS_TV_OUT_HD720P30)
        ...
        i2cInit_NVP6020(0);
  #else
      #if( (TVOUT_RESOLUTION_PREVIEW_CAPTURE ==TV_HD720P30) || (TVOUT_RESOLUTION_PREVIEW_CAPTURE ==TV_HD720P60_37M) )
       i2cInit_NVP6020(4);
...
#define I2C_WM8940_WR_SLAV_ADDR  0x00000034
#define I2C_WM8940_RD_SLAV_ADDR  0x00000035
...
s32 i2cWrite_WM8940(u8 addr, u16 data)
{
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cWrite_WM8940 i2cSemReq is %d.\n", err);
        return 0;
    }

    I2cData = ((u32)data);
    I2cCtrl = I2C_ENA | I2C_RD_REG_ADDR | I2C_2B | I2C_CLK_DIV_1920 | (I2C_WM8940_WR_SLAV_ADDR << I2C_SLAV_ADDR_SHFT) |I2C_INT_ENA ;
    I2cCtrl = I2cCtrl | (((u32)addr) << I2C_SUB_ADDR_SHFT);
    I2cCtrl = I2C_TRIG | I2cCtrl;
    ...
    //DEBUG_I2C("write WM8940 i2c addr=%d,  i2c data=%x\n",addr ,data);
    return 1;
}
...
s32 i2cRead_WM8940(u8 addr, u16* pData)
{
    ...
    I2cCtrl = I2C_ENA | I2C_RD_REG_ADDR | I2C_2B | I2C_CLK_DIV_1920 | (I2C_WM8940_RD_SLAV_ADDR << I2C_SLAV_ADDR_SHFT) | I2C_INT_ENA ;
    ...
    *pData = I2cData;
    DEBUG_I2C("read WM8940 i2c addr=%d,  i2c data=%x\n",addr ,*pData);
    OSSemPost(i2cSemReq);
    return 1;
}
...
void IIS_WM8940_reset(void)
{   //For Power down
    //i2cWrite_WM8940(0,0x0);
    return;
}
void Init_IIS_WM8940_loopback(void)  //ADC data output is fed directly into DAC data input.
{
    i2cWrite_WM8940(0x00, 0x0000);
    i2cWrite_WM8940(0x01, 0x009D);
    i2cWrite_WM8940(0x02, 0x0015);
    i2cWrite_WM8940(0x03, 0x0065);
    i2cWrite_WM8940(0x04, 0x0016);
    i2cWrite_WM8940(0x05, 0x0001);


    i2cWrite_WM8940(0x06, 0x0000);
    i2cWrite_WM8940(0x2C, 0x0003);
    i2cWrite_WM8940(0x2D, 0x003A);
    i2cWrite_WM8940(0x2F, 0x0100);
    i2cWrite_WM8940(0x32, 0x0001);
...
void Init_IIS_WM8940_play(void) //AUX-in, use WM8940 speaker volume control
{
    return;
}
void Init_IIS_WM8940_MicRec_MonoPlay(void) //Mic record, and Aux-in playback
{
	u8 i;
    i2cWrite_WM8940(0x00, 0x0000);
    i2cWrite_WM8940(0x01, 0x00DD);
	for(i=0;i<200;i++)
    i2cWrite_WM8940(0x02, 0x0015);
    i2cWrite_WM8940(0x03, 0x00E4);
	for(i=0;i<200;i++)
    i2cWrite_WM8940(0x04, 0x0012);
    i2cWrite_WM8940(0x05, 0x0000);
    i2cWrite_WM8940(0x06, 0x0000);
    i2cWrite_WM8940(0x07, 0x0006);          // 16k sampling rate
    i2cWrite_WM8940(0x2C, 0x0103);          //
    i2cWrite_WM8940(0x2D, ADC_PGA_GAIN);    //Input PGA volume
    i2cWrite_WM8940(0x2F, 0x0100);
    i2cWrite_WM8940(0x38, 0x0002);

    #if(AUDIO_ALC_ENABLE==1)
    //ALC
    i2cWrite_WM8940(0x20, 0x013A);
    i2cWrite_WM8940(0x23, 0x0008);
    #endif
}

void Init_IIS_WM8940_MicRec_AuxPlay(void) //Mic record, and Aux-in playback
{
    i2cWrite_WM8940(0x00, 0x0000);
    i2cWrite_WM8940(0x01, 0x00DD);
    i2cWrite_WM8940(0x02, 0x0015);
    i2cWrite_WM8940(0x03, 0x0064);
    i2cWrite_WM8940(0x04, 0x0012);
    i2cWrite_WM8940(0x05, 0x0000);
    i2cWrite_WM8940(0x06, 0x0000);
    i2cWrite_WM8940(0x07, 0x0006);          // 16k sampling rate
    ...
    i2cWrite_WM8940(0x2D, ADC_PGA_GAIN);    //Input PGA volume
    i2cWrite_WM8940(0x2F, 0x0100);
    i2cWrite_WM8940(0x32, 0x0020);
    i2cWrite_WM8940(0x36, DAC_PGA_GAIN);
...
void WM8940_MicVol_FadeIn(void)
{
    u16 data;

    for(data=(u16)(ADC_PGA_GAIN-10); data<=ADC_PGA_GAIN; data++)
        i2cWrite_WM8940(0x2D, data);
}

void WM8940_MicVol_FadeOut(void)
{
    u16 data;

    for(data=ADC_PGA_GAIN; data>=(u16)(ADC_PGA_GAIN-10); data--)
        i2cWrite_WM8940(0x2D, data);
}
void WM8940_SpeakVol_FadeIn(void)
{
    u16 data;

    for(data=0x0000; data<=MAX_DAC_PGA_GAIN; data++)
        i2cWrite_WM8940(0x36, data);
    printf("WM8940_SpeakVol_FadeIn %x\n",MAX_DAC_PGA_GAIN);
}

void WM8940_SpeakVol_FadeOut(void)
{
    u16 data;

    for(data=MAX_DAC_PGA_GAIN; data>0x0000; data--)
        i2cWrite_WM8940(0x36, data);

        i2cWrite_WM8940(0x36, 0x0040);
    printf("WM8940_SpeakVol_FadeOut %x\n",MAX_DAC_PGA_GAIN);
}


void WM8940_AdjustMicVolume(u16 Volume) //0x00~0x3f : -12db~35.25db, each 0.75db, default boost enable 20db
{
    if(Volume > 0x3F)
        Volume = 0x3F;

    i2cWrite_WM8940(0x2D, Volume);  //Input PGA volume
}

void WM8940_AdjustSpeakerVolume(u8 Volume) // 1~9: -12db~6db, each 2db
{
    #if ((HW_BOARD_OPTION == MR9200_RX_TRANWO_D8795R2) || (HW_BOARD_OPTION  == MR9200_RX_TRANWO_D8797R) ||\
         (HW_BOARD_OPTION  == MR9200_RX_ROULE) ||\
         (HW_BOARD_OPTION == MR9200_RX_TRANWO_D8710R) || (HW_BOARD_OPTION  == MR9200_RX_MAYON_MWM903) ||\
    ...
    u16 volVal[10] = {0x0040, 0x001F, 0x0023, 0x0027, 0x002B , 0x002F, 0x0033, 0x0037, 0x003B, 0x003F};
    #else //RDI
    #if (((HW_BOARD_OPTION == MR9200_RX_RDI_UDR777) && (PROJ_OPT==3)) || ((HW_BOARD_OPTION == MR9200_RX_RDI_UDR777) && (PROJ_OPT==8)) ||\
         ((HW_BOARD_OPTION == MR9200_RX_RDI_UDR777) && (PROJ_OPT==9)))
    u16 volVal[10] = {0x000a, 0x0014, 0x0017, 0x001c, 0x0020 , 0x0029, 0x002C, 0x002f, 0x0032, 0x0038};
    #else
    u16 volVal[10] = {0x000b, 0x0015, 0x0018, 0x001D, 0x0021 , 0x002A, 0x002D, 0x0030, 0x0033, 0x0039};
    #endif
    #endif

    printf("SpeakerVolume [%d] = [0x%04x]\n", Volume, volVal[Volume]);
    i2cWrite_WM8940(0x36, volVal[Volume]);
    MAX_DAC_PGA_GAIN = volVal[Volume];

}

void WM8940_SpeakerMute(void)
{
    i2cWrite_WM8940(0x36, 0x0040);
}
void WM8940_PLL_AuxPlay_ALL(void)
{
    //clock 27M, 44.1k, Bclk 1.4M, 16 bit to HDMI
    i2cWrite_WM8940(0x02, 0x11);
    i2cWrite_WM8940(0x06, 0x0d); // disable PLL
    i2cWrite_WM8940(0x2f, 0x07); 
    i2cWrite_WM8940(0x32, 0x20);

    i2cWrite_WM8940(0x01, 0xef); // PLL on/ set VIMC
    i2cWrite_WM8940(0x24, 0x66); //N
    i2cWrite_WM8940(0x25, 0x2c); //K
    i2cWrite_WM8940(0x26, 0x56); //K
    i2cWrite_WM8940(0x27, 0x93); //K
    i2cWrite_WM8940(0x06, 0x14d); // PLL enable
    ...
    //i2cWrite_WM8940(0x2F, 0x0100);
    i2cWrite_WM8940(0x32, 0x0020);
    i2cWrite_WM8940(0x36, MAX_DAC_PGA_GAIN); 
    
}
void WM8940_PLL_LineIn(void)
{
    //clock 27M, 44.1k, Bclk 1.4M, 16 bit to HDMI
    i2cWrite_WM8940(0x02, 0x11);
    i2cWrite_WM8940(0x06, 0x0d); // disable PLL
    ...
    i2cWrite_WM8940(0x01, 0xaf); // PLL on/ set VIMC
    i2cWrite_WM8940(0x24, 0x66); //N
    i2cWrite_WM8940(0x25, 0x2c); //K
    i2cWrite_WM8940(0x26, 0x56); //K
    i2cWrite_WM8940(0x27, 0x93); //K
...
void WM8940_MicRec_AuxPlay_Switch2panel(void) //Mic record, and Aux-in playback
{
    i2cWrite_WM8940(0x00, 0x0000);
    i2cWrite_WM8940(0x01, 0x00DD);
    i2cWrite_WM8940(0x02, 0x0015);
...
void ALC5621_AdjustVolume(u8 Volume)
{
    ...
    i2cWrite_ALC5621(12,0xFF1F); //  0ch, Stereo DAC Volume
#else
...
void ALC5621_AdjustMICVolume(u8 Volume)
{
    ...
    {
    #if (HW_BOARD_OPTION == MR9120_TX_OPCOM)
        i2cWrite_ALC5621(0x1C,0x4740); // HPR Volume output input select
        i2cWrite_ALC5621(0x0e,0); //  0eh, MIC Volume
    #else
...
void ALC5621_ChannelSwitch(u8 ch)
{
    ...
    {
    #if (HW_BOARD_OPTION == MR9120_TX_OPCOM)
        i2cWrite_ALC5621(0x10,0x70E0);   // 10h, Enable MIC1 Single End Input
    #else
...
#if (HW_BOARD_OPTION == MR9120_TX_OPCOM)
    i2cWrite_ALC5621(28,0x4740);   //  1ch, Output Mixer Control
    i2cWrite_ALC5621(2,0x1010);     //  02h, Speaker Output Volume
#else
...
void Init_IIS_ALC5621_rec(void)
{
    ...
    */
    ...
    // i2cWrite_ALC5621(16,0x60f0);  // 10h, Enable MIC1 Single End Input
     ...
     #endif
    #if (HW_BOARD_OPTION == MR9120_TX_OPCOM)
     i2cWrite_ALC5621(10,0xFF1F);    // 0ah, Line-In
    // i2cWrite_ALC5621(34,0x0a00);    // 22h, MIC1,2 Boost 30dB    --- very important
     i2cWrite_ALC5621(34,0x0800);  // 22h, MIC1,2 Boost 20dB    --- very important //albert on 20090713
    // i2cWrite_ALC5621(34,0x0000);  // 22h, MIC1,2 Boost Bypass  --- very important
    #else
     i2cWrite_ALC5621(10,0x6808);    // 0ah, Line-In
    // i2cWrite_ALC5621(34,0x0a00);    // 22h, MIC1,2 Boost 30dB    --- very important
    ...
    // i2cWrite_ALC5621(20,0x3b3b);  // 14h, ADC Record Mixer Control
    // i2cWrite_ALC5621(20,0x7b7b);  // 14h, ADC Record Mixer Control
    i2cWrite_ALC5621(14,0x0002);  // 0eh, Mic volume  07/10//albert on 20090713
    ...
    i2cWrite_ALC5621(18,0xF58B);    // 12h, ADC Record Gain 19.5dB Gain  [1111][11000][11][11000]//albert on 20090713
    // i2cWrite_ALC5621(18,0xf7ef);  // 12h, ADC Record Gain 6dB Gain     [1111][01111][11][01111]
    // i2cWrite_ALC5621(18,0xf5eb);  // 12h, ADC Record Gain 0dB Gain     [1111][01011][11][01011]
    #else
    i2cWrite_ALC5621(14,0x0202);  // 0eh, Mic volume  07/10//albert on 20090713
...
s32 i2cWrite_DM5900(u8 addr, u8 data,u32 DeviceAddr)
{
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cWrite_DM5900 i2cSemReq is %d.\n", err);
        return 0;
    }
    I2cData = ((u32)data);
...
#if (TV_DECODER == TI5150) //use TI5150 tv decoder
#if GPIO_I2C_ENA
...
void i2cInit_BIT1201G(void)
{
    ...
    {
        i2cWrite_BIT1201G(0x0a, 0x80, I2C_BIT1201G_WR_SLAV_ADDR); //NTSC Y gain
...
u8 FM1288_mode0_Rx[] =
 {                           //16k vda 1mic
    ...
    0xFC, 0xF3, 0x3B, 0x22, 0xE9, 0x00, 0x11,
...
s32 i2cInit_FM1288_Tx(void)
{
    ...
    gpioSetLevel(1, 5, 0); //reset  FM1288    
    OSTimeDly(1);    
    gpioSetLevel(1, 5, 1); //reset  FM1288
    OSTimeDly(1);        
...
s32 i2cWrite_DH9801(u16 addr, u8 data)
{
    u8 err;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cWrite_DH9801 i2cSemReq is %d.\n", err);
        return 0;
    }

    I2cData = ((u32)data);
    I2cCtrl = I2C_ENA | I2C_RD_REG_ADDR | I2C_1B | I2C_CLK_DIV_1920 | (I2C_DH9801_WR_SLAV_ADDR<< I2C_SLAV_ADDR_SHFT) |I2C_INT_ENA ;
    I2cCtrl = I2cCtrl | (((u32)addr) << I2C_SUB_ADDR_SHFT);
    I2cCtrl = I2C_TRIG | I2cCtrl;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cWrite_DH9801 i2cSemFin is %d.\n", err);
        OSSemPost(i2cSemReq);
        return 0;
    }
    OSSemPost(i2cSemReq);
...
s32 i2cRead_DH9801_Manual(u16 addr, u8* data)
{
    u8 err;
    u32 i;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cRead_DH9801_Manual(0x%02x, 0x%02x), i2cSemReq is %d.\n",  addr, *data, err);
        return 0;
    }

    I2cCtrl     = I2C_MANUAL_EN  |I2C_1B| I2C_ENA | I2C_CLK_DIV_1920  | (I2C_DH9801_WR_SLAV_ADDR<< I2C_SLAV_ADDR_SHFT);
    /* Start */
    I2cManu     = I2C_ManuSBIT;
    for(i = 0; (i < 1000) && ((I2cCtrl & I2C_BUSY) || (I2cManu & I2C_ManuSBIT)); i++);
    if((I2cCtrl & I2C_BUSY) || (I2cManu & I2C_ManuSBIT))
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_DH9801_Manual() IIC Start 1 Error!!!\n");
        return 0;
    }
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_DH9801_Manual() IIC Write Slave Addr 0x%02x Error!!!\n", I2C_DH9801_WR_SLAV_ADDR);
        return 0;
    }
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_DH9801_Manual() IIC Write Sub Addr 0x%04x high byte Error!!!\n", addr);
        return 0;
    }
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_DH9801_Manual() IIC Stop 1 Error!!!\n");
        return 0;
    }


    I2cCtrl     = I2C_MANUAL_EN |I2C_ENA | I2C_1B | I2C_CLK_DIV_1920  | (I2C_DH9801_RD_SLAV_ADDR<< I2C_SLAV_ADDR_SHFT);
    /* Start */
    I2cManu     = I2C_ManuSBIT;
    for(i = 0; (i < 1000) && ((I2cCtrl & I2C_BUSY) || (I2cManu & I2C_ManuSBIT)); i++);
    if((I2cCtrl & I2C_BUSY) || (I2cManu & I2C_ManuSBIT))
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_DH9801_Manual() IIC Start 2 Error!!!\n");
        return 0;
    }
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_DH9801_Manual() IIC Read Data Error!!!\n");
        return 0;
    }
    ...
    *data  = (u8)I2cData;
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead_DH9801_Manual() IIC Stop 2 Error!!!\n");
        return 0;
    }
    else
    {
...
void i2cInit_DH9801(void)
{
    ...
    gpioSetLevel(GPIO_GROUP_CVI_RST, GPIO_BIT_CVI_RST,1);
    for(i=0;i<10;i++);
    gpioSetLevel(GPIO_GROUP_CVI_RST, GPIO_BIT_CVI_RST,0);
    for(i=0;i<30;i++);
    gpioSetLevel(GPIO_GROUP_CVI_RST, GPIO_BIT_CVI_RST,1);
    for(i=0;i<10;i++);

    addr =0x0d;
    i2cRead_DH9801_Manual(addr, &data);
    DEBUG_UI("regist:%x, data:%x(0x80)  \n",addr,data);
    addr =0x0e;
    i2cRead_DH9801_Manual(addr, &data);
    DEBUG_UI("regist:%x, data:%x(0xa1) \n",addr,data);
    addr =0x0f;
    i2cRead_DH9801_Manual(addr, &data);
    DEBUG_UI("regist:%x, data:%x(0x01)  \n",addr,data);

    i2cWrite_DH9801(0x00, 0x80); // reset
    for(i=0;i<100;i++);
    #if (TVOUT_RESOLUTION_PREVIEW_CAPTURE == TV_HD720P30)
    i2cWrite_DH9801(0x41, 0x40);
    i2cWrite_DH9801(0x00, 0x01);  //0x00:25fps, 0x01:30fps,0x02: 50 fps, 0x03: 60 fps
    #elif (TVOUT_RESOLUTION_PREVIEW_CAPTURE == TV_HD720P60)
    i2cWrite_DH9801(0x41, 0x40);
    i2cWrite_DH9801(0x00, 0x03);  //0x00:25fps, 0x01:30fps,0x02: 50 fps, 0x03: 60 fps
    #elif (TVOUT_RESOLUTION_PREVIEW_CAPTURE == TV_FHD1080P30)
    i2cWrite_DH9801(0x41, 0x41);
    i2cWrite_DH9801(0x00, 0x05);
    #else
    i2cWrite_DH9801(0x00, 0x01);  //0x00:25fps, 0x01:30fps,0x02: 50 fps, 0x03: 60 fps
    #endif
    i2cWrite_DH9801(0x04, 0x11);
    i2cWrite_DH9801(0x40, 0x80);
    //i2cWrite_DH9801(0x40, 0xa0); //color bar test
    i2cWrite_DH9801(0x4a, 0x10);

    i2cWrite_DH9801(0xf4, 0x01);
    i2cWrite_DH9801(0x24, 0xc1);
    i2cWrite_DH9801(0x08, 0x82);

    i2cWrite_DH9801(0x10, 0x80);  //IIS
    i2cWrite_DH9801(0xfa, 0x01);

    addr =0x00;  i2cRead_DH9801_Manual(addr, &data);  DEBUG_UI("regist:%x, data:%x(0x03)  \n",addr,data);
    addr =0x04;  i2cRead_DH9801_Manual(addr, &data);  DEBUG_UI("regist:%x, data:%x(0x11)  \n",addr,data);
    addr =0x40;  i2cRead_DH9801_Manual(addr, &data);  DEBUG_UI("regist:%x, data:%x(0x80)  \n",addr,data);
    addr =0xf4;  i2cRead_DH9801_Manual(addr, &data);  DEBUG_UI("regist:%x, data:%x(0x01)  \n",addr,data);
    addr =0x24;  i2cRead_DH9801_Manual(addr, &data);  DEBUG_UI("regist:%x, data:%x(0xc1)  \n",addr,data);
    addr =0x08;  i2cRead_DH9801_Manual(addr, &data);  DEBUG_UI("regist:%x, data:%x(0x82)  \n",addr,data);
}
#endif
...
s32 i2cWrite_NVP6020(u16 addr, u8 data)
{
    u8 err;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cWrite_NVP6020 i2cSemReq is %d.\n", err);
        return 0;
    }

    I2cData = ((u32)data);
    I2cCtrl = I2C_ENA | I2C_RD_REG_ADDR | I2C_1B | I2C_CLK_DIV_1920 | (I2C_NVP6020_WR_SLAV_ADDR << I2C_SLAV_ADDR_SHFT) | I2C_INT_ENA ;
    I2cCtrl = I2cCtrl | (((u32)addr) << I2C_SUB_ADDR_SHFT);
    I2cCtrl = I2C_TRIG | I2cCtrl;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cWrite_NVP6020 i2cSemFin is %d.\n", err);
        OSSemPost(i2cSemReq);
        return 0;
    }
    OSSemPost(i2cSemReq);
...
s32 i2cRead_NVP6020(u8 addr, u8* pData)
{
    u8 err;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cRead_NVP6020 i2cSemReq is %d.\n", err);
        return 0;
    }

    I2cCtrl = I2C_ENA | I2C_RD_REG_ADDR | I2C_1B | I2C_CLK_DIV_1920 | (I2C_NVP6020_RD_SLAV_ADDR << I2C_SLAV_ADDR_SHFT) | I2C_INT_ENA | I2C_SENS_CLK_DIV_1;
    I2cCtrl = I2cCtrl | (((u32)addr) << I2C_SUB_ADDR_SHFT);
    I2cCtrl |= I2C_TRIG;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cRead_NVP6020 i2cSemFin is %d.\n", err);
        OSSemPost(i2cSemReq);
        return 0;
    }
    *pData = (u8)(I2cData & 0xff);
    ...
    void i2cInit_NVP6020(char vmode)
    {
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////
        /*
                                          NVP6021_720P_30P_(141127_ver.0.1)
        */
        ////////////////////////////////////////////////////////////////////////////////////////////////

        unsigned char NVP6021_720P_B0_30P_Buf[256] = {
              // 0x00,0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x09,0x0A,0x0B,0x0C,0x0D,0x0E,0x0F
        /*0x00*/ 0x00,0xea,0x00,0x00,0x00,0x00,0x40,0x18,0x00,0x00,0x00,0x00,0x00,0xea,0x86,0x03,
        /*0x10*/ 0x02,0x00,0x40,0x00,0x00,0x00,0x00,0x03,0x00,0x00,0x00,0x00,0x08,0x00,0x00,0x00,
        ...
        unsigned char NVP6021_720P_B1_30P_Buf[256] = {
              // 0x00,0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x09,0x0A,0x0B,0x0C,0x0D,0x0E,0x0F
        /*0x00*/ 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x03,0x00,
        /*0x10*/ 0x00,0x00,0x13,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
        /*0x20*/ 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
        /*0x30*/ 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
        /*0x40*/ 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
        /*0x50*/ 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
        ...
        unsigned char NVP6021_720P_B2_30P_Buf[256] = {
              // 0x00,0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x09,0x0A,0x0B,0x0C,0x0D,0x0E,0x0F
        /*0x00*/ 0xfe,0xea,0x00,0x00,0x50,0x00,0x10,0x00,0x00,0x00,0x00,0x00,0x04,0x3f,0x00,0x00,
        /*0x10*/ 0xeb,0x10,0xf0,0x10,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x80,0x80,0x80,0x00,
        /*0x20*/ 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
        /*0x30*/ 0x00,0x00,0x00,0x00,0x00,0x00,0x01,0x80,0x00,0x00,0x13,0x00,0x00,0x00,0x00,0x00,
        /*0x40*/ 0x01,0xff,0x80,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
        /*0x50*/ 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
        /*0x60*/ 0x80,0x80,0x00,0xe0,0x19,0x04,0xeb,0x60,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
        /*0x70*/ 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
        /*0x80*/ 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
        /*0x90*/ 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
        /*0xa0*/ 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
        ...
        gpioSetLevel(GPIO_GROUP_AHD_RST, GPIO_BIT_AHD_RST,1);
        for(i=0;i<10;i++);
        gpioSetLevel(GPIO_GROUP_AHD_RST, GPIO_BIT_AHD_RST,0);
        for(i=0;i<30;i++);
        gpioSetLevel(GPIO_GROUP_AHD_RST, GPIO_BIT_AHD_RST,1);
        for(i=0;i<10;i++);

        i2cWrite_NVP6020(0xff, 0x00); //bank0
        for(i=0;i<256;i++)
        {
            i2cWrite_NVP6020(i,NVP6021_720P_B0_30P_Buf[i]);
        }

        i2cWrite_NVP6020(0xff, 0x01); //bank1
        for(i=0;i<256;i++)
        {
            i2cWrite_NVP6020(i,NVP6021_720P_B1_30P_Buf[i]);
        }
        i2cWrite_NVP6020(0xff, 0x02); //bank2
        for(i=0;i<256;i++)
        {
            i2cWrite_NVP6020(i,NVP6021_720P_B2_30P_Buf[i]);
        }
    ...
    {
        i2cWrite_NVP6020(0xFF,0x02);
        i2cWrite_NVP6020(0x63,0xFF);    // TX out-put Threshold
        i2cWrite_NVP6020(0xFF,0x03);

        i2cWrite_NVP6020(0x20,0x2F);    // A-CP TX BOUD
        i2cWrite_NVP6020(0x23,0x08);    // Line position1
        i2cWrite_NVP6020(0x24,0x00);    // Line position2
        i2cWrite_NVP6020(0x25,0x07);    // Lines count
        i2cWrite_NVP6020(0x2B,0x10);    // A-CP mode choose
        i2cWrite_NVP6020(0x2D,0x0D);    // Start point1
        i2cWrite_NVP6020(0x2E,0x01);    // Start point2
        i2cWrite_NVP6020(0xA9,0x00);    // i2c master mode off

        i2cWrite_NVP6020(0x30,0x55);    // HEADER
        i2cWrite_NVP6020(0x31,0x24);    // NVP6021 set
        i2cWrite_NVP6020(0x32,0x00);
        i2cWrite_NVP6020(0x33,0x00);
        i2cWrite_NVP6020(0x34,0x00);
        i2cWrite_NVP6020(0x35,0x00);
        i2cWrite_NVP6020(0x36,0x00);
        i2cWrite_NVP6020(0x37,0x00);
        i2cWrite_NVP6020(0x29,0x08);    // Status out
    }

    void Init_RX_coax(void)
    {
        i2cWrite_NVP6020(0xFF, BANK0);
        i2cWrite_NVP6020(0x17, 0x00);   //RX Threshold on
        i2cWrite_NVP6020(0xFF, 0x03);

        i2cWrite_NVP6020(0x09, 0x00);
        //ser_write(0x80, 0x55);//RX ID
        i2cWrite_NVP6020(0x80, 0x00);//RX ID
        i2cWrite_NVP6020(0x82, 0x10);
        i2cWrite_NVP6020(0x83, 0x01);
        i2cWrite_NVP6020(0x86, 0x80);
        i2cWrite_NVP6020(0x87, 0x01);
        i2cWrite_NVP6020(0x88, 0x40);

        i2cWrite_NVP6020(0x30, 0x55); //TX ID
    }
    void i2cInit_NVP6020(char vmode)
    {
         int i;
         ...
         switch(vmode)
         {
              case 0 : DEBUG_I2C("AHD 1080p30\r\n"); break;
              case 1 : DEBUG_I2C("AHD 1080p25\r\n"); break;
              case 2 : DEBUG_I2C("AHD 720p60\r\n"); break;
              case 3 : DEBUG_I2C("AHD 720p50\r\n"); break;
              case 4 : DEBUG_I2C("AHD 720p30b16\r\n"); break;
              case 5 : DEBUG_I2C("AHD 720p25b16\r\n"); break;
              case 6 : DEBUG_I2C("AHD 720p30b8\r\n"); break;
              case 7 : DEBUG_I2C("AHD 720p25b8\r\n"); break;
         }
         ...
         i2cWrite_NVP6020(0xFF, BANK0);
         i2cWrite_NVP6020(0x00, 0x01);

         switch(vmode)
         {
          case 0 :
           i2cWrite_NVP6020(0x01, 0xF0);
           i2cWrite_NVP6020(0x04, 0x00);
           break;
          case 1 :
           i2cWrite_NVP6020(0x01, 0xF1);
           i2cWrite_NVP6020(0x04, 0x00);
           break;
          case 2 :
           i2cWrite_NVP6020(0x01, 0xE2);
           i2cWrite_NVP6020(0x04, 0x00);
           break;
          case 3 :
           i2cWrite_NVP6020(0x01, 0xE3);
           i2cWrite_NVP6020(0x04, 0x00);
           break;
          case 4 :
           i2cWrite_NVP6020(0x01, 0xEA);
           i2cWrite_NVP6020(0x04, 0x00);
           break;
          case 5 :
           i2cWrite_NVP6020(0x01, 0xEB);
           i2cWrite_NVP6020(0x04, 0x00);
           break;
          case 6 :
           i2cWrite_NVP6020(0x01, 0x6A);
           i2cWrite_NVP6020(0x04, 0x00);
           break;
          case 7 :
           i2cWrite_NVP6020(0x01, 0x6B);
           i2cWrite_NVP6020(0x04, 0x00);
           break;

         }

         i2cWrite_NVP6020(0xFF, BANK1);
         i2cWrite_NVP6020(0x0E, 0x00);  //revers bit Y/C


         i2cWrite_NVP6020(0xFF, BANK2);
         i2cWrite_NVP6020(0x00, 0xFE);


         i2cWrite_NVP6020(0x02, 0x00);

         i2cWrite_NVP6020(0x04, 0x80);
         i2cWrite_NVP6020(0x05, 0x00);
         i2cWrite_NVP6020(0x06, 0x10);

         i2cWrite_NVP6020(0x0C, 0x04);
         i2cWrite_NVP6020(0x0D, 0x3F);
         i2cWrite_NVP6020(0x0E, 0x00);

         i2cWrite_NVP6020(0x10, 0xEB);
         i2cWrite_NVP6020(0x11, 0x10);
         i2cWrite_NVP6020(0x12, 0xF0);
         i2cWrite_NVP6020(0x13, 0x10);
         i2cWrite_NVP6020(0x14, 0x01);
         i2cWrite_NVP6020(0x15, 0x00);
         i2cWrite_NVP6020(0x16, 0x00);


         i2cWrite_NVP6020(0x17, 0x00);
         i2cWrite_NVP6020(0x18, 0x00);
         i2cWrite_NVP6020(0x19, 0x00);

         i2cWrite_NVP6020(0x1C, 0x80);
         i2cWrite_NVP6020(0x1D, 0x80);
         i2cWrite_NVP6020(0x1E, 0x80);


         i2cWrite_NVP6020(0x20, 0x00);
         i2cWrite_NVP6020(0x21, 0x00);
         i2cWrite_NVP6020(0x22, 0x00);
         i2cWrite_NVP6020(0x23, 0x00);
         i2cWrite_NVP6020(0x24, 0x00);
         i2cWrite_NVP6020(0x25, 0x00);
         i2cWrite_NVP6020(0x26, 0x00);
         i2cWrite_NVP6020(0x27, 0x00);
         i2cWrite_NVP6020(0x28, 0x00);
         i2cWrite_NVP6020(0x29, 0x00);
         i2cWrite_NVP6020(0x2A, 0x00);
         i2cWrite_NVP6020(0x2B, 0x00);
         i2cWrite_NVP6020(0x2C, 0x00);
         i2cWrite_NVP6020(0x2D, 0x00);
         i2cWrite_NVP6020(0x2E, 0x00);
         i2cWrite_NVP6020(0x2F, 0x00);
         i2cWrite_NVP6020(0x30, 0x00);
         i2cWrite_NVP6020(0x31, 0x00);
         i2cWrite_NVP6020(0x32, 0x00);
         i2cWrite_NVP6020(0x33, 0x00);
         i2cWrite_NVP6020(0x34, 0x00);

         i2cWrite_NVP6020(0x36, 0x01);
         i2cWrite_NVP6020(0x37, 0x80);

         i2cWrite_NVP6020(0x39, 0x00);


         i2cWrite_NVP6020(0x3C, 0x00);
         i2cWrite_NVP6020(0x3D, 0x00);
         i2cWrite_NVP6020(0x3E, 0x00);



         i2cWrite_NVP6020(0x40, 0x01);
         i2cWrite_NVP6020(0x41, 0xFF);
         i2cWrite_NVP6020(0x42, 0x80);

         i2cWrite_NVP6020(0x48, 0x00);
         i2cWrite_NVP6020(0x49, 0x00);
         i2cWrite_NVP6020(0x4A, 0x00);
         i2cWrite_NVP6020(0x4B, 0x00);
         i2cWrite_NVP6020(0x4C, 0x00);
         i2cWrite_NVP6020(0x4D, 0x00);
         i2cWrite_NVP6020(0x4E, 0x00);
         i2cWrite_NVP6020(0x4F, 0x00);
         i2cWrite_NVP6020(0x50, 0x00);
         i2cWrite_NVP6020(0x51, 0x00);
         i2cWrite_NVP6020(0x52, 0x00);
         i2cWrite_NVP6020(0x53, 0x00);
         i2cWrite_NVP6020(0x54, 0x00);
         i2cWrite_NVP6020(0x55, 0x00);
         i2cWrite_NVP6020(0x56, 0x00);
         i2cWrite_NVP6020(0x57, 0x00);
         i2cWrite_NVP6020(0x59, 0x00);
         i2cWrite_NVP6020(0x5A, 0x00);
         i2cWrite_NVP6020(0x5C, 0x00);
         i2cWrite_NVP6020(0x5D, 0x00);
         i2cWrite_NVP6020(0x5E, 0x00);
         i2cWrite_NVP6020(0x5F, 0x00);


         i2cWrite_NVP6020(0x60, 0x80);
         i2cWrite_NVP6020(0x61, 0x80);
         i2cWrite_NVP6020(0x63, 0xE0);
         i2cWrite_NVP6020(0x64, 0x19);
         i2cWrite_NVP6020(0x65, 0x04);
         i2cWrite_NVP6020(0x66, 0xEB);
         i2cWrite_NVP6020(0x67, 0x60);
         i2cWrite_NVP6020(0x68, 0x00);
         i2cWrite_NVP6020(0x69, 0x00);
         i2cWrite_NVP6020(0x6A, 0x00);
         i2cWrite_NVP6020(0x6B, 0x00);

         switch(vmode)
         {
          case 0 :
           i2cWrite_NVP6020(0x3A, 0x11);
           i2cWrite_NVP6020(0x01, 0xF0);
           break;
          case 1 :
           i2cWrite_NVP6020(0x3A, 0x11);
         ...
         {
          case 0 :    //1080p 30
           i2cWrite_NVP6020(0x3D, 0x80);   //pn enable

           i2cWrite_NVP6020(0x5C, 0x52);   //pn value
           i2cWrite_NVP6020(0x5D, 0xCA);   //pn value
           i2cWrite_NVP6020(0x5E, 0xF0);   //pn value
           i2cWrite_NVP6020(0x5F, 0x2C);   //pn value

           i2cWrite_NVP6020(0x1D, 0xB0);   //cb scale
           i2cWrite_NVP6020(0x1E, 0xB0);   //cr scale

           i2cWrite_NVP6020(0x37, 0xB0);   //burst scale
           break;
          case 1 :    //1080P 25
           i2cWrite_NVP6020(0x3D, 0x80);   //pn enable

           i2cWrite_NVP6020(0x5C, 0x52);   //pn value
           i2cWrite_NVP6020(0x5D, 0xC3);   //pn value
           i2cWrite_NVP6020(0x5E, 0x7D);   //pn value
           i2cWrite_NVP6020(0x5F, 0xC8);   //pn value
...
s32 i2cRead_BS83B12(u8 id, u8* pData)
{
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cRead_Byte(0x%02x, 0x%02x), i2cSemFin is %d n", id, *pData, err);
        OSSemPost(i2cSemReq);
        return 0;
    }
...
#if((USE_BUILD_IN_RTC == RTC_USE_EXT_RTC) && (EXT_RTC_SEL == RTC_ISL1208))
...
#endif      // #if(USE_BUILD_IN_RTC == RTC_USE_EXT_RTC && EXT_RTC_SEL == RTC_ISL1208)
...
#if(EXT_RTC_SEL == RTC_PCF8563)
//*********************** PCF8563 RTC function begin ******************************

s32 i2cWrite_RTC_PCF8563(u8 ucRegAddr, u8 ucData)
{
    u8 err;
    OSSemPend(i2cSemReq, I2C_TIMEOUT, &err);
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cWrite_PCF8563_RTC i2cSemReq is %d.\n", err);
        return 0;
    }

    I2cData = ((u32)ucData);

    I2cCtrl = I2C_ENA |I2C_RD_REG_ADDR | I2C_1B| I2C_R_ACK|I2C_CLK_DIV_480 | (I2C_RTC_PCF8563_WR_SLAV_ADDR << I2C_SLAV_ADDR_SHFT)|I2C_INT_ENA;
    I2cCtrl = I2cCtrl | (((u32)ucRegAddr) << I2C_SUB_ADDR_SHFT);
    I2cCtrl = I2C_TRIG | I2cCtrl;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cWrite_PCF8563_RTC i2cSemFin is %d.\n", err);
        OSSemPost(i2cSemReq);
        return 0;
    }
...
s32 i2cRead_RTC_PCF8563(u8 ucRegAddr, u8 * pData)
{
    u8 err;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cRead_PCF8563 i2cSemReq is %d.\n", err);
        return 0;
    }

    I2cCtrl = I2C_ENA |I2C_RD_REG_ADDR| I2C_1B | I2C_CLK_DIV_480 | (I2C_RTC_PCF8563_RD_SLAV_ADDR << I2C_SLAV_ADDR_SHFT)|I2C_INT_ENA;
    I2cCtrl = I2cCtrl | (((u32)ucRegAddr) << I2C_SUB_ADDR_SHFT);
    I2cCtrl |= I2C_TRIG;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cRead_PCF8563 i2cSemFin is %d.\n", err);
        OSSemPost(i2cSemReq);
        return 0;
    }
    *pData = (u8)(I2cData&0xff);
...
BOOLEAN Get_PCF8563_RTC(RTC_DATE_TIME *rtc_time)
{
    BOOLEAN bRet=TRUE;
    u8 data[7];
    u8 i;
    ...
    for( i = 0 ; i < 7 ; i++)
    {
        if(i2cRead_RTC_PCF8563((addr_sec + i), &data[i]) == 0)
        {
            bRet=FALSE;
            DEBUG_I2C("Get_PCF8563_RTC I2C Read 0x%02x Error\r\n", i);
        }
    }
    if(bRet){
        rtc_time->sec   = GetBCDtoDecimal(data[0] & 0x7F);
        rtc_time->min   = GetBCDtoDecimal(data[1] & 0x7F);
        rtc_time->hour  = GetBCDtoDecimal(data[2] & 0x3F);
        rtc_time->week  = data[4] & 0x07;
        rtc_time->day   = GetBCDtoDecimal(data[3] & 0x3F);
        rtc_time->month = GetBCDtoDecimal(data[5] & 0x1F);
...
BOOLEAN Set_PCF8563_RTC(RTC_DATE_TIME* date)
{
    BOOLEAN bRet=TRUE;
    u8 data[7];
    u8 i;
    ...
    data[0] = ConvertDecimaltoBCD(date->sec);
    data[1] = ConvertDecimaltoBCD(date->min);
    data[2] = (ConvertDecimaltoBCD(date->hour));
    data[4] = date->week;
    data[3] = ConvertDecimaltoBCD(date->day);
    ...
    for(i=0;i<7;i++)
    {
        if(i2cWrite_RTC_PCF8563((addr_sec + i), data[i]) == 0)
        {
            bRet=FALSE;
            DEBUG_I2C("Set_PCF8563_RTC I2C Write 0x%02x Error\r\n", i);
        }
    }
    return bRet;
}
...
void PCF8563_RTC_Init(void)
{
    ...
    i2cWrite_RTC_PCF8563(0x00, 0x00); //set run time
    i2cWrite_RTC_PCF8563(0x01, 0x11); //enable interrupt
    
    Get_PCF8563_RTC(&RtcTime);
    DEBUG_I2C("RTC_PCF8563 Date:%04d/%02d/%02d %02d:%02d:%02d\n", (RtcTime.year + 2000), RtcTime.month, RtcTime.day, RtcTime.hour, RtcTime.min, RtcTime.sec);

    /*check time range*/
    if(rtcIsTimeValid(&RtcTime) == FALSE)
    {
        ...
        RtcTime.month   = 1;
        RtcTime.year    = 10;
        if(Set_PCF8563_RTC(&RtcTime))
        {
            Get_PCF8563_RTC(&RtcTime);
            DEBUG_I2C("RTC_PCF8563 Date:%04d/%02d/%02d %02d:%02d:%02d\n", (RtcTime.year + 2000), RtcTime.month, RtcTime.day, RtcTime.hour, RtcTime.min, RtcTime.sec);
        }
        else
            DEBUG_I2C("Set_PCF8563_RTC set time Error\n");
    }
    //RTC_Get_GMT_Time(&time);
    RTCTime_Gmt_To_Local(&RtcTime, &g_LocalTime);
    DEBUG_RTC("g_LocalTime: 20%02d/%02d/%02d %02d:%02d:%02d\n", g_LocalTime.year, g_LocalTime.month, g_LocalTime.day, g_LocalTime.hour, g_LocalTime.min, g_LocalTime.sec);
}
//*********************** PCF8563 RTC function end ******************************
#endif

#if(EXT_RTC_SEL == RTC_PT7C43390)

#define PT7C43390_STATUS_REG_2	0x01
#define PT7C43390_TEST_BIT		0x01
#define PT7C43390_POC_BIT		0x01
#define PT7C43390_BLD_BIT		0x02
#define PT7C43390_24HR_BIT		0x40
#define PT7C43390_RST_BIT		0x80
#define PT7C43390_RST_RTY_CNT	2

// MSB to LSB, or LSB to MSB
u8 i2cDataInverse(u8 data)
{
    u8 value = 0;
    u8 i = 0;
    for(i=0;i<8;i++)
        value|=((data >> i) & 0x1) << (7 - i);
    return value;
}

s32 i2cRead_PT7C43390(u8 addr, u8* pData)
{
	...
	if (err != OS_NO_ERR)
	{
		DEBUG_I2C("Error: i2cRead_PT7C43390 i2cSemReq is %d.\n", err);
		return 0;
	}

	I2cCtrl = I2C_ENA |I2C_7B |I2C_ACK| I2C_CLK_DIV_480 | (I2C_RTC_PT7C43390_RD_SLAV_ADDR<< I2C_SLAV_ADDR_SHFT) | I2C_INT_ENA;
	//I2cCtrl = I2cCtrl | (((u32)addr) << I2C_SUB_ADDR_SHFT);
	I2cCtrl |= I2C_TRIG;
	...
	if (err != OS_NO_ERR)
	{
		DEBUG_I2C("Error: i2cRead_PT7C43390 i2cSemFin is %d.\n", err);
        OSSemPost(i2cSemReq);
		return 0;
	}
    
	pData[3] = (u8)(I2cData & 0xff); //week
  	pData[2] = (u8)(I2cData >> 8)& 0xff; //day
  	pData[1] = (u8)((I2cData >> 16)& 0xff); //month
   	pData[0] = (u8)((I2cData >> 24)& 0xff); //year
   	pData[6] = (u8)((I2cData2) & 0xff); //sec
  	pData[5] = (u8)((I2cData2 >> 8) & 0xff); //min
  	pData[4] = (u8)((I2cData2 >> 16)& 0xff); //hour

    OSSemPost(i2cSemReq);
	return 1;
}

s32 i2cWrite_PT7C43390(u8 addr, u8 * pdata)
{
	...
	if (err != OS_NO_ERR)
	{
		DEBUG_I2C("Error: i2cWrite_PT7C43390 i2cSemReq is %d.\n", err);
		return 0;
	}

    I2cData = ((u32)pdata[0]<<24) | ((u32)pdata[1]<<16) | ((u32)pdata[2]<<8) | ((u32)pdata[3]);
    I2cData2 =((u32)pdata[4]<<16) | ((u32)pdata[5]<<8) | ((u32)pdata[6]);
    
	I2cCtrl = I2C_ENA | I2C_7B | I2C_CLK_DIV_480 | (I2C_RTC_PT7C43390_WR_SLAV_ADDR << I2C_SLAV_ADDR_SHFT) |I2C_INT_ENA;
	//I2cCtrl = I2cCtrl | (((u32)addr) << I2C_SUB_ADDR_SHFT);
	I2cCtrl = I2C_TRIG | I2cCtrl;
	...
	if (err != OS_NO_ERR)
	{
		DEBUG_I2C("Error: i2cWrite_PT7C43390 i2cSemFin is %d.\n", err);
        OSSemPost(i2cSemReq);
		return 0;
	}
...
s32 i2cRead_PT7C43390_1byte(u8 addr, u8* pData)
{
	u8 err;
	...
	I2cCtrl = I2C_ENA |I2C_1B |I2C_ACK| I2C_CLK_DIV_480 | ( addr << I2C_SLAV_ADDR_SHFT) | I2C_INT_ENA;
	//I2cCtrl = I2cCtrl | (((u32)addr) << I2C_SUB_ADDR_SHFT);
	I2cCtrl |= I2C_TRIG;
    ...
    *pData = (u8)I2cData;
    *pData = i2cDataInverse(*pData);
    OSSemPost(i2cSemReq);
	return 1;
}

s32 i2cWrite_PT7C43390_1byte(u8 addr, u8 data)
{

    u8 err, i;
    u32 temp = 0;
    // two ways, still not work, no ack when write data
    OSSemPend(i2cSemReq, I2C_TIMEOUT, &err);
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cWrite_PT7C43390_1byte(0x%02x, 0x%02x), i2cSemReq is %d.\n",  addr, data, err);
        return 0;
    }

    I2cCtrl     = I2C_MANUAL_EN  |I2C_1B| I2C_ENA | I2C_ACK | I2C_CLK_DIV_480  | (addr<< I2C_SLAV_ADDR_SHFT)|I2C_INT_ENA;
    I2cCtrl = I2cCtrl | (((u32)i2cDataInverse(data)) << I2C_SUB_ADDR_SHFT);
    /* Start */
    I2cManu     = I2C_ManuSBIT;
    for(i = 0; (i < 1000) && ((I2cCtrl & I2C_BUSY) || (I2cManu & I2C_ManuSBIT)); i++);
    if((I2cCtrl & I2C_BUSY) || (I2cManu & I2C_ManuSBIT))
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cWrite_PT7C43390_1byte() IIC Start 1 Error!!!\n");
        return 0;
    }
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cWrite_PT7C43390_1byte() IIC Write Slave Addr 0x%02x Error!!!\n", addr);
        return 0;
    }
    ...
    //temp = (u32)i2cDataInverse(data);
    //I2cData     = temp << 24 + temp;
    ...
    */
	...
	//I2cData = (u32)i2cDataInverse(data);
    printf("inverse data %d\n", i2cDataInverse(data));
    temp = (u32)i2cDataInverse(data);
    I2cData = temp << 24;
    //I2cCtrl = I2C_ENA | I2C_RD_REG_ADDR | I2C_CLK_DIV_960 | (I2C_STATUS_PT7C43390_WR_SLAV_ADDR << I2C_SLAV_ADDR_SHFT) |I2C_INT_ENA | I2C_SENS_CLK_DIV_1;
	I2cCtrl = I2C_ENA | I2C_1B | I2C_ACK | I2C_CLK_DIV_480 | ( addr << I2C_SLAV_ADDR_SHFT) |I2C_INT_ENA;
	//I2cCtrl = I2cCtrl | (((u32)addr) << I2C_SUB_ADDR_SHFT);
	I2cCtrl |= I2C_TRIG;
...
BOOLEAN Get_PT7C43390_RTC(RTC_DATE_TIME *rtc_time)
{
	BOOLEAN bRet=TRUE;
	u8 data[7] = {0};
	u8 i;

	bRet = i2cRead_PT7C43390(i, data);

    for(i=0;i<7;i++)
        data[i] = i2cDataInverse(data[i]);

    if(bRet)
    {
    	rtc_time->sec   = GetBCDtoDecimal(data[6]&0x7F);
    	rtc_time->min   = GetBCDtoDecimal(data[5]&0x7F);
    	rtc_time->hour  = GetBCDtoDecimal(data[4]&0x3F); //12hr 24hr
    	rtc_time->hour  = ((data[4] >> 6)& 0x01)? rtc_time->hour + 12 : rtc_time->hour;
    	rtc_time->week  = GetBCDtoDecimal(data[3]);
    	rtc_time->day   = GetBCDtoDecimal(data[2]&0x3F);
    	rtc_time->month = GetBCDtoDecimal(data[1]&0x1F);
    	rtc_time->year  = GetBCDtoDecimal(data[0]);
    }
	//DEBUG_I2C("Read Date auto:%04d/%02d/%02d %02d:%02d:%02d\n",(rtc_time->year+2000), rtc_time->month, rtc_time->day, rtc_time->hour, rtc_time->min, rtc_time->sec);
    return bRet;
}

BOOLEAN Set_PT7C43390_RTC(RTC_DATE_TIME* date)
{
	BOOLEAN bRet=TRUE;
	u8 data[7] = {0};
	u8 i = 0;

	data[6] = ConvertDecimaltoBCD(date->sec);
	data[5] = ConvertDecimaltoBCD(date->min);
    data[4] = date->hour >= 12 ? (date->hour - 12) : date->hour;
	data[4] = (ConvertDecimaltoBCD(data[4]));
    data[4] = date->hour >= 12 ? (data[4] | 0x40) : data[4];
    data[3] = ConvertDecimaltoBCD(date->week);
	data[2] = ConvertDecimaltoBCD(date->day);
	data[1] = ConvertDecimaltoBCD(date->month);
	data[0] = ConvertDecimaltoBCD(date->year);

    for(i=0;i<7;i++)
        data[i] = i2cDataInverse(data[i]);
   
    bRet = i2cWrite_PT7C43390(i, data); 
    //DEBUG_I2C("Write Date auto:%04d/%02d/%02d %02d:%02d:%02d\n",(date->year+2000), date->month, date->day, date->hour, date->min, date->sec);

    return bRet;
}

void PT7C43390_RTC_Init(void)
{
    u8 cnt=0, u8Status;
	BOOLEAN RTCValid = FALSE;
    RTC_DATE_TIME RtcTime;

    if(i2cRead_PT7C43390_1byte(I2C_STATUS_PT7C43390_RD_SLAV_ADDR, &u8Status) == FALSE)
    {
        DEBUG_I2C("PT7C43390 RTC IC ERROR\n");
        return;
    }

	switch(u8Status & (PT7C43390_POC_BIT | PT7C43390_BLD_BIT))
	{
		case PT7C43390_POC_BIT:
		case PT7C43390_POC_BIT | PT7C43390_BLD_BIT:
			OSTimeDly(10);//delay 500ms
		case PT7C43390_BLD_BIT:
// Only for reset test, Paul
//		default:
			DEBUG_I2C("PT7C43390 reset, Status=0x%X\n",u8Status);
			do{
				i2cWrite_PT7C43390_1byte(I2C_STATUS_PT7C43390_WR_SLAV_ADDR, PT7C43390_RST_BIT );
				i2cRead_PT7C43390_1byte(I2C_STATUS_PT7C43390_RD_SLAV_ADDR, &u8Status);
				if((u8Status & (PT7C43390_POC_BIT | PT7C43390_BLD_BIT)) == 0)
					RTCValid = TRUE;
			}while( (cnt++ < PT7C43390_RST_RTY_CNT ) && !RTCValid);//Call init flow
...
// cnt ==0 : Normal boot, use PT7C43390 time.
// Valid == TRUE : initial success, set default time
// Valid == FALSE : initial fail, show message
	if (( RTCValid ) && (cnt == 0))
	{
		for (cnt=1; cnt<=PT7C43390_RST_RTY_CNT; cnt++)
        {
			RTCValid=Get_PT7C43390_RTC(&RtcTime);
			//Check if this is a valid time. If yes, break the for loop.
			if ( (RTCValid == TRUE) && (rtcIsTimeValid(&RtcTime) == TRUE) ) break;

			//If it is not a valid time, read RTC again.
			DEBUG_I2C("Called Get_PT7C43390_RTC() the %dth time. \r\n",cnt);
		}
        
        //DEBUG_I2C("#1 RTC_PT7C43390 Date:%04d/%02d/%02d %02d:%02d:%02d\n", (RtcTime.year + 2000), RtcTime.month, RtcTime.day, RtcTime.hour, RtcTime.min, RtcTime.sec);
        if(cnt >= PT7C43390_RST_RTY_CNT || (RtcTime.month == 0) || (RtcTime.day == 0))
        {
        	cnt = 0;
            //do{
	            RTCValid=Set_PT7C43390_RTC(&rtcBase);
	            RTCValid=Get_PT7C43390_RTC(&RtcTime);
	        //}while((cnt++ < PT7C43390_RST_RTY_CNT ) && memcmp(&RtcTime, &rtcBase, sizeof(RTC_DATE_TIME)));
        }
	}
	else
	{//cnt > 0 means PT7C43390 was initialled
		if(cnt > PT7C43390_RST_RTY_CNT)
			DEBUG_I2C("PT7C43390 initial fail, status = 0x%X. \r\n", u8Status);
		else
			DEBUG_I2C("PT7C43390 initial success, cnt = %d. \r\n", cnt);
		cnt=0;
    ...
    DEBUG_I2C("#2 RTC_PT7C43390 Date:%04d/%02d/%02d %02d:%02d:%02d\n", (RtcTime.year + 2000), RtcTime.month, RtcTime.day, RtcTime.hour, RtcTime.min, RtcTime.sec);
...
s32 i2cRead_SD2068(u8 ucRegAddr, u8* pucData)
{
    ...
    I2cCtrl = I2C_ENA | I2C_RD_REG_ADDR | I2C_1B | I2C_CLK_DIV_480 | (I2C_RTC_SD2068_RD_SLAV_ADDR << I2C_SLAV_ADDR_SHFT) | I2C_SENS_CLK_DIV_1| I2C_INT_ENA;
    I2cCtrl = I2cCtrl | (((u32)ucRegAddr) << I2C_SUB_ADDR_SHFT);
    I2cCtrl |= I2C_TRIG;
...
s32 i2cWrite_SD2068(u8 ucRegAddr, u8 ucData)
{
	...
	I2cCtrl = I2C_ENA | I2C_RD_REG_ADDR | I2C_1B | I2C_CLK_DIV_480 | (I2C_RTC_SD2068_WR_SLAV_ADDR << I2C_SLAV_ADDR_SHFT)| I2C_INT_ENA;
    I2cCtrl = I2cCtrl | (((u32)ucRegAddr) << I2C_SUB_ADDR_SHFT);
    I2cCtrl = I2C_TRIG | I2cCtrl;
...
#if(EXT_RTC_SEL == RTC_HM8563)
#define HM8563_VOLTAGE_LOW			(1<<7)
#define HM8563_RESET				(1<<3)
#define HM8563_ALARM_DISABLE		(1<<7)
#define HM8563_CLKOUT_DISABLE		(0<<7)
#define HM8563_CENTURY_BIT			(0<<7) //0: 21 century; 1: 20 century
#define HM8563_STATUS_REG			0x00
#define HM8563_STATUS_REG_2			0x01
#define HM8563_SEC_REG				0x02
#define HM8563_MIN_AL_REG			0x09
#define HM8563_HOUR_AL_REG			0x0A
#define HM8563_DAY_AL_REG			0x0B
#define HM8563_WEEK_AL_REG			0x0C
#define HM8563_CLKOUT_REG			0x0D
#define HM8563_TIMER_REG			0x0E
/* 
RESET on STATUS_REG (1<<3)
0x02 sec & VL(1<<7)
0x03 min
0x04 hour
0x05 day
...
0x09 Min Alarm, should disable(1<<7)
0x0A Hour Alarm, should disable(1<<7)
0x0B day Alarm, should disable(1<<7)
0x0C week Alarm, should disable(1<<7)
0x0D CLKOUT, should disable(0<<7)
0x0E Timer, should disable(0<<7)
*/
s32 i2cRead_HM8563_1byte(u8 ucRegAddr, u8* pucData)
{
    u8 err;
    OSSemPend(i2cSemReq, I2C_TIMEOUT, &err);
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cRead_HM8563_1byte(0x%02x), i2cSemReq is %d, data is 0x%X.\n", ucRegAddr,err, i2cSemReq);
        return 0;
    }

	// 1. Send I2C device read address
    I2cCtrl = I2C_ENA | I2C_RD_REG_ADDR | I2C_1B | I2C_CLK_DIV_480 | (I2C_RTC_HM8563_RD_SLAV_ADDR << I2C_SLAV_ADDR_SHFT) | I2C_SENS_CLK_DIV_1| I2C_INT_ENA;
	// 2. Send read address
    I2cCtrl = I2cCtrl | (((u32)ucRegAddr) << I2C_SUB_ADDR_SHFT);
	// 3. Wait receive data
    I2cCtrl |= I2C_TRIG;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cRead_HM8563_1byte(0x%02x), i2cSemFin is %d.\n",  ucRegAddr, err);
        OSSemPost(i2cSemReq);
        return 0;
    }
...
s32 i2cRead_HM8563(u8 ucRegAddr, u8* pucData, u8 blkCnt)
{
    u8 err;
    OSSemPend(i2cSemReq, I2C_TIMEOUT, &err);
    if (err != OS_NO_ERR)
	...
	// 1. Send I2C device read address
	I2cCtrl = I2C_ENA |I2C_7B |I2C_ACK | I2C_RD_REG_ADDR| I2C_CLK_DIV_480 | (I2C_RTC_HM8563_RD_SLAV_ADDR<< I2C_SLAV_ADDR_SHFT) | I2C_INT_ENA;
	// 2. Send read address
	I2cCtrl = I2cCtrl | (((u32)ucRegAddr) << I2C_SUB_ADDR_SHFT);
	// 3. Wait receive data
	I2cCtrl |= I2C_TRIG;
	...
	pucData[3] = (u8)(I2cData & 0xff); //day
  	pucData[2] = (u8)(I2cData >> 8)& 0xff; //hour
  	pucData[1] = (u8)((I2cData >> 16)& 0xff); //min
   	pucData[0] = (u8)((I2cData >> 24)& 0xff); //sec
   	pucData[6] = (u8)((I2cData2) & 0xff); //year
  	pucData[5] = (u8)((I2cData2 >> 8) & 0xff); //month
  	pucData[4] = (u8)((I2cData2 >> 16)& 0xff); //week
    OSSemPost(i2cSemReq);
    return 1;
}

s32 i2cWrite_HM8563_1byte(u8 ucRegAddr, u8 ucData)
{
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cWrite_HM8563_1byte(0x%02x, 0x%02x), i2cSemReq is %d.\n", ucRegAddr, ucData, err);
        return 0;
    }

    I2cData = ((u32)ucData);

	I2cCtrl = I2C_ENA | I2C_RD_REG_ADDR | I2C_1B | I2C_CLK_DIV_480 | (I2C_RTC_HM8563_WR_SLAV_ADDR << I2C_SLAV_ADDR_SHFT)| I2C_INT_ENA;
    I2cCtrl = I2cCtrl | (((u32)ucRegAddr) << I2C_SUB_ADDR_SHFT);
    I2cCtrl = I2C_TRIG | I2cCtrl;
...
s32 i2cWrite_HM8563(u8 ucRegAddr, u8 *pucData, u8 blkCnt)
{
    ...
    I2cData = ((u32)pucData[0]<<24) | ((u32)pucData[1]<<16) | ((u32)pucData[2]<<8) | ((u32)pucData[3]);
    I2cData2 =((u32)pucData[4]<<16) | ((u32)pucData[5]<<8) | ((u32)pucData[6]);
    
	I2cCtrl = I2C_ENA | I2C_7B | I2C_RD_REG_ADDR| I2C_CLK_DIV_480 | (I2C_RTC_HM8563_WR_SLAV_ADDR << I2C_SLAV_ADDR_SHFT) |I2C_INT_ENA;
	I2cCtrl = I2cCtrl | (((u32)ucRegAddr) << I2C_SUB_ADDR_SHFT);
	I2cCtrl = I2C_TRIG | I2cCtrl;
...
BOOLEAN Get_HM8563_RTC(RTC_DATE_TIME *rtc_time)
{
	BOOLEAN bRet=TRUE;
	u8 data[7];

	if( i2cRead_HM8563(HM8563_SEC_REG, data, sizeof(RTC_DATE_TIME)) == 0)
	{
		bRet=FALSE;
		DEBUG_I2C("I2C Read HM8563_SEC_REG 0x%02x Error\r\n", HM8563_SEC_REG);
	}
	if(data[0] & HM8563_VOLTAGE_LOW)
		DEBUG_I2C("[RTC WARING] Battery low\r\n");

    if(bRet)
    {
    	rtc_time->sec   = GetBCDtoDecimal(data[0] & 0xFF);
    	rtc_time->min   = GetBCDtoDecimal(data[1] & 0x7F);
    	rtc_time->hour  = GetBCDtoDecimal(data[2] & 0x3F);
    	rtc_time->day   = GetBCDtoDecimal(data[3] & 0x3F);
        rtc_time->week  = GetBCDtoDecimal(data[4] & 0x07);
    	rtc_time->month = GetBCDtoDecimal(data[5] & 0x9F);
    	rtc_time->year  = GetBCDtoDecimal(data[6] & 0xFF);
    }
//	DEBUG_I2C("Get_HM8563_RTC Date:%04d/%02d/%02d %02d:%02d:%02d\n",(rtc_time->year+2000), rtc_time->month, rtc_time->day, rtc_time->hour, rtc_time->min, rtc_time->sec);
    return bRet;
}

BOOLEAN Set_HM8563_RTC(RTC_DATE_TIME* date)
{
	///u8 data;
	BOOLEAN bRet=TRUE;
	u8 data[7];
	...
	data[2] = ConvertDecimaltoBCD(date->hour);
	data[3] = ConvertDecimaltoBCD(date->day);
	data[4] = ConvertDecimaltoBCD(date->week);
	data[5] = ConvertDecimaltoBCD(date->month);
	data[6] = ConvertDecimaltoBCD(date->year);

	if(i2cWrite_HM8563(HM8563_SEC_REG, data, sizeof(RTC_DATE_TIME)) == 0)
	{
		bRet=FALSE;
		DEBUG_I2C("I2C Write HM8563_SEC_REG 0x%02x Error\r\n", HM8563_SEC_REG);
	}

//    DEBUG_I2C("Set_HM8563_RTC Date:%04X/%02X/%02X %02X:%02X:%02X\n",data[6], data[5], data[3], data[2], data[1], data[0]);
    return bRet;
}

void HM8563_RTC_Init(void)
{
    u8 data, batterybit = 0x01;
    u8 RTCValid;
    u8 cnt=0;
	INT32U tick;
    BOOLEAN bRet=TRUE;
    RTC_DATE_TIME RtcTime;
//    DEBUG_I2C("## HM8563_RTC_Init\n");
	// Wait for HM8563 ready
	do {
		i2cRead_HM8563_1byte(HM8563_SEC_REG, &data);
	}while((data == 0xFF) && cnt++ < 1000);
//	DEBUG_I2C("[RTC INFO]Initial time = %d cnt\n", cnt);
	i2cRead_HM8563_1byte(HM8563_SEC_REG, &data);

	// Reset HM8563 when low battery detect
	if(data & HM8563_VOLTAGE_LOW) {
		DEBUG_I2C("[RTC WARING] Battery low, reset HM8563...sec:0x%X\r\n", data);
		i2cWrite_HM8563_1byte(HM8563_STATUS_REG, HM8563_RESET);
		do {
			i2cRead_HM8563_1byte(HM8563_SEC_REG, &data);
		}while((data == 0xFF) && cnt++ < 1000);
//		DEBUG_I2C("[RTC WARING] reset time = %d cnt\n", cnt);
		i2cWrite_HM8563_1byte(HM8563_STATUS_REG,0 );//Clear HM8563_RESET
		i2cWrite_HM8563_1byte(HM8563_SEC_REG, 0x00 );// Clear HM8563_VOLTAGE_LOW
//		RTCValid = 0;
		bRet=Set_HM8563_RTC(&rtcBase);
	}
	else
	{
		bRet=Get_HM8563_RTC(&RtcTime);
			//Check if this is a valid time. If yes, break the for loop.
		if ( (bRet == FALSE) && (IsTimeValid(&RtcTime) == FALSE) )
		{
			DEBUG_I2C("[RTC ERROR] Time invalid\r\n");
			bRet=Set_HM8563_RTC(&rtcBase);
		}
//		RTCValid =1;
	}
...
//	i2cRead_HM8563_1byte(HM8563_SEC_REG, &data);
//	DEBUG_I2C("[RTC Info]HM8563...sec:0x%X\r\n", data);
#if 0 // Remove for 9160 OPCOM BATCAM, need fast init.
	if ( RTCValid == 1 )
	{
		for (cnt=1; cnt<=10; cnt++)
        {
			...
			//If it is not a valid time, read RTC again.
//			DEBUG_I2C("Called Get_HM8563_RTC() the %dth time. \r\n",cnt);
		}
 //       DEBUG_I2C("#1 RTC_HM8563 Date:%04d/%02d/%02d %02d:%02d:%02d\n", (RtcTime.year + 2000), RtcTime.month, RtcTime.day, RtcTime.hour, RtcTime.min, RtcTime.sec);
        if(cnt >= 10 || (RtcTime.month == 0) || (RtcTime.day == 0))
        {
            bRet=Set_HM8563_RTC(&rtcBase);
        }
	...
	bRet=Get_HM8563_RTC(&RtcTime);
//    DEBUG_I2C("#2 RTC_HM8563 Date:%04d/%02d/%02d %02d:%02d:%02d\n", (RtcTime.year + 2000), RtcTime.month, RtcTime.day, RtcTime.hour, RtcTime.min, RtcTime.sec);
    RTCTime_Gmt_To_Local(&rtcBase, &g_LocalTime);
//    DEBUG_I2C("g_LocalTime:    20%02d/%02d/%02d %02d:%02d:%02d\n", g_LocalTime.year, g_LocalTime.month, g_LocalTime.day, g_LocalTime.hour, g_LocalTime.min, g_LocalTime.sec);
#endif
}
...
#endif
#if (HW_BOARD_OPTION == MR9200_RX_RDI)
enum
{
    PHY_MIN_X = 100,
    PHY_MIN_Y = 180,
...
#elif ((HW_BOARD_OPTION == MR9200_RX_TRANWO_D8795) || (HW_BOARD_OPTION == MR9200_RX_TRANWO_D8795R2) ||\
       (HW_BOARD_OPTION  == MR9200_RX_TRANWO_D8797R) || (HW_BOARD_OPTION == MR9200_RX_TRANWO_D8710R) ||\
       (HW_BOARD_OPTION == MR9200_RX_TRANWO_D8796P) || (HW_BOARD_OPTION == MR9200_RX_TRANWO_D8897H) ||\
       (HW_BOARD_OPTION == MR9200_RX_TRANWO_SH8710R))

    #if(TOUCH_PANEL_DRIVER_INTERNAL == TOUCH_PANEL)
        enum
        {
            PHY_MIN_X = 65,
            PHY_MIN_Y = 208,
    ...
    #elif(TOUCH_PANEL_DRIVER_TSC2003== TOUCH_PANEL)
        enum
        {
            PHY_MIN_X = 72,
            PHY_MIN_Y = 285,
    ...
    #endif
#elif (HW_BOARD_OPTION == MR9200_RX_MAYON_MWM903)
    #if (TOUCH_PANEL == TOUCH_PANEL_DRIVER_GT9271)
    enum
    {
        PHY_MIN_X = 3,
 ...
 * @retval false otherwise.
 */
static bool ADCRX_getPosition(int *x, int *y)
{
    enum {
        REC_SCAN_BIT = 31,
        ADC_BITS = 12,
        ...
        X_DEFAULT = 4095,
        Y_DEFAULT = 203,           // 195~203

        R_TOUCH_DEFAULT = 16769025, // default value of the touch resistance
        Z1_DEFAULT = 1,
        Z2_DEFAULT = 4096,
    ...
    AdcRecConvRate |= (u32)1 << REC_SCAN_BIT;

#define LO_BITS(v, bits)    ((v) & ((1<<(bits)) - 1))
#define HI_BITS(v, bits)    LO_BITS((v)>>(16), bits)
    *x = LO_BITS(ADCRX_TOUCH_XY, ADC_BITS);
    *y = HI_BITS(ADCRX_TOUCH_XY, ADC_BITS);
    z1 = LO_BITS(ADCRX_TOUCH_Z, ADC_BITS);
    z2 = HI_BITS(ADCRX_TOUCH_Z, ADC_BITS);
#undef LO_BITS
#undef HI_BITS
    ...
    // The default position on no any touching is (4095, 203).
    // The touchabled bound is about from (320, 871) to (3683, 3272)
    if (*x > X_DEFAULT-50)
        return false;
    ...
    // z2 could less then z1 when touching two positions at the same time
    if (z2 < z1)
        return false;

    // to avoid dividing by 0 on z2/z1
    if (z1 == 0) {
        ++z1;
        ++z2;
    }

    r_touch = *x * z2/z1 - *x; // assume R_XPlate == ADC_MAX
    printf("x:%d, y:%d, z1:%d, z2:%d, Rt:%d\n", *x, *y, z1, z2, r_touch);

    if (r_touch == R_TOUCH_DEFAULT)
        return false;
    if (r_touch > R_TH || r_touch == R_ZERO)
        return false;
...
#if (TOUCH_PANEL_DRIVER_INTERNAL == TOUCH_PANEL)
    if ((ret = ADCRX_getPosition(x, y)) == true)
#elif (TOUCH_PANEL_DRIVER_CAPACITIVE == TOUCH_PANEL)
    if ((ret = CTP_getPosition(x, y)) == true)
#elif (TOUCH_PANEL_DRIVER_TSC2003== TOUCH_PANEL)
    if ((ret = TSC2003_getPosition(x, y)) == true)
#elif (TOUCH_PANEL_DRIVER_GT9271== TOUCH_PANEL)
    if ((ret = GT9271_getPosition(x, y)) == true)
#endif
    {
        #if (TOUCH_PANEL_DRIVER_CAPACITIVE == TOUCH_PANEL)
        if(*y == 800)
        {
            ...
            else if(*x == 720)
            {
                ...
                #elif(HW_BOARD_OPTION == MR9200_RX_RDI_M1000)
                    uiSentKeyToUi(UI_KEY_VOL_UP);
                #endif
            }

            return false;
        }
        else if(*y > PHY_MAX_Y || *x < PHY_MIN_X)
        {
            return false;
        }
        #elif (TOUCH_PANEL_DRIVER_GT9271== TOUCH_PANEL)
...
#if (Volume_Control == Volume_Control_PT2257)
#define REG_2H_ONES 0xD0
#define REG_2H_TENS 0xE0
#define REG_2H_MUTE_ON 0x79
#define REG_2H_MUTE_OFF 0x78

s32 i2cWrite_PT2257(u8 ucData1, u8 ucData2)
{
    u8 err;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cWrite_Byte(0x%02x, 0x%02x, 0x%02x), i2cSemReq is %d.\n", I2C_PT2257_WR_SLAV_ADDR, ucData1, ucData2, err);
        return 0;
    }

    I2cData = ((u32)ucData2);

    I2cCtrl = I2C_ENA | I2C_RD_REG_ADDR | I2C_1B | I2C_CLK_DIV_1920 | (((u32)I2C_PT2257_WR_SLAV_ADDR) << I2C_SLAV_ADDR_SHFT) |I2C_INT_ENA ;
    I2cCtrl = I2cCtrl | (((u32)ucData1) << I2C_SUB_ADDR_SHFT);
    I2cCtrl = I2C_TRIG | I2cCtrl;
...
s32 VolumeControl_PT2257(u8 unAudioVol)
{
    u8 data_ones,data_tens;

    if(unAudioVol == 31)
    {
        i2cWrite_PT2257(REG_2H_MUTE_ON,REG_2H_MUTE_ON);
    }
    else
    {
        data_tens = REG_2H_TENS + (unAudioVol/10);
        data_ones = REG_2H_ONES + (unAudioVol%10);
        i2cWrite_PT2257(REG_2H_MUTE_OFF,REG_2H_MUTE_OFF);
        i2cWrite_PT2257(data_tens,data_ones);
    }
    return 1;
}
#endif
...
u8 u8CurSize = TV_720p60;

u8 i2cInit_VX9988(void)
{
    u8 i = 0;
    for(i = 0; i< INIT_TABLE_LEN ;i++)
        i2cWrite_Byte(I2C_VX9988_WR_SLAV_ADDR, i2cVX9988_init_Table[i][0], i2cVX9988_init_Table[i][1]);
...
u8 i2cCmd_VX9988_SwitchResolution(u8 u8Type)
{
    ...
    if (u8CurSize != u8Type)
    {
        if(u8Type == TV_720p60)
        {
            for(i = 0; i< SWITCH_TABLE_LEN ;i++)
                i2cWrite_Byte(I2C_VX9988_WR_SLAV_ADDR, i2cVX9988_720P_Table[i][0], i2cVX9988_720P_Table[i][1]);
        }
        else
        {
            for(i = 0; i< SWITCH_TABLE_LEN ;i++)
                i2cWrite_Byte(I2C_VX9988_WR_SLAV_ADDR, i2cVX9988_1080I_Table[i][0], i2cVX9988_1080I_Table[i][1]);
        }
        u8CurSize = u8Type;
    }
    return 1;
...
#if ((TOUCH_PANEL == TOUCH_PANEL_DRIVER_CAPACITIVE) && (HW_BOARD_OPTION != MR9200_RX_TRANWO_D8795R2) &&\
     (HW_BOARD_OPTION != MR9200_RX_TRANWO_D8796P) && (HW_BOARD_OPTION != MR9200_RX_TRANWO_D8897H))
//-----------------------------------------------------------------------------
...
bool CTP_getPosition(int *x, int *y)
{
    ...
    *x = FT5406_readByte(ADDR_Touch1XH);
    event = (EventFlag)(*x >> 6);
    *x = (*x & 0x0F) << 8;
    *x += FT5406_readByte(ADDR_Touch1XL);
    *y = FT5406_readByte(ADDR_Touch1YH) << 8;
    *y += FT5406_readByte(ADDR_Touch1YL);
    if (*x > 770) //maxium raw data
        *x = 770;
    *x = 770 - *x;
...
enum 
{
    ...
    FW_Versin2,
    Touch_Status = 0x814E,
    X_Coordinate_L = 0x8150,
    X_Coordinate_H,
    Y_Coordinate_L,
    Y_Coordinate_H,
    GT9271_Status = 0x81A8
};

//for Touch_Status = 0x814E,
#define mask_buffer_status 0x80
#define mask_have_key      0x10
#define mask_touch_numbers 0x07

void reset_GT9271(void)
{
    int i;

    gpioSetLevel(GPIO_GROUP_TOUCH_PANNEL_RST, GPIO_BIT_TOUCH_PANNEL_RST, 0);

    gpioSetLevel(GPIO_GROUP_TOUCH_PANNEL_INT, GPIO_BIT_TOUCH_PANNEL_INT, GPIO_LEVEL_LO);
    gpioSetDir(GPIO_GROUP_TOUCH_PANNEL_INT, GPIO_BIT_TOUCH_PANNEL_INT, GPIO_DIR_OUT);

    gpioSetLevel(GPIO_GROUP_TOUCH_PANNEL_RST, GPIO_BIT_TOUCH_PANNEL_RST, 1);
    OSTimeDly(1);
...
s32 i2cWrite16addr_Byte(u8 id, u16 addr, u8 data)
{
    u8 err;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cWrite16addr_Byte(0x%02x, 0x%02x, 0x%02x), i2cSemReq is %d.\n", id, addr, data, err);
        return 0;
    }

    I2cData = ((((u32)addr) << 8) | data);

    I2cCtrl = I2C_ENA | I2C_3B | I2C_CLK_DIV_1920 | (((u32)id) << I2C_SLAV_ADDR_SHFT) |I2C_INT_ENA ;
    I2cCtrl = I2C_TRIG | I2cCtrl;

    OSSemPend(i2cSemFin, I2C_TIMEOUT, &err);
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cWrite16addr_Byte(0x%02x, 0x%02x, 0x%02x), i2cSemFin is %d.\n", id, addr, data, err);
        OSSemPost(i2cSemReq);
        return 0;
    }
    OSSemPost(i2cSemReq);
...
s32 i2cRead16addr_Byte(u8 id, u16 addr, u8* pData)
{
    u8 err;
    u32 i;
    u8 subReg=0;
    ...
    if (err != OS_NO_ERR)
    {
        DEBUG_I2C("Error: i2cRead16addr_Byte(0x%02x, 0x%02x), i2cSemReq is %d.\n",  addr, *pData, err);
        return 0;
    }

    I2cCtrl     = I2C_MANUAL_EN  |I2C_2B| I2C_R_ACK | I2C_ENA | I2C_CLK_DIV_1920  | (((u32)id-1)<< I2C_SLAV_ADDR_SHFT) | ( subReg << I2C_SUB_ADDR_SHFT);
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead16addr_Byte() IIC Start 1 Error!!!\n");
        return 0;
    }
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead16addr_Byte() IIC Write Slave Addr 0x%02x Error!!!\n", id);
        return 0;
    }
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead16addr_Byte() IIC Write Sub Addr 0x%04x high byte Error!!!\n", addr);
        return 0;
    }
    ...
    /* Start */
    I2cCtrl     = I2C_MANUAL_EN | I2C_R_ACK | I2C_ENA | I2C_1B | I2C_CLK_DIV_1920  | (((u32)id)<< I2C_SLAV_ADDR_SHFT);
    I2cManu     = I2C_ManuSBIT;
    for(i = 0; (i < 1000) && ((I2cCtrl & I2C_BUSY) || (I2cManu & I2C_ManuSBIT)); i++);
    if((I2cCtrl & I2C_BUSY) || (I2cManu & I2C_ManuSBIT))
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead16addr_Byte() IIC Start 2 Error!!!\n");
        return 0;
    }
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead16addr_Byte() IIC Read Data Error!!!\n");
        return 0;
    }
    ...
    *pData  = (u8)I2cData;
    ...
    {
        OSSemPost(i2cSemReq);
        DEBUG_I2C("Error: i2cRead16addr_Byte() IIC Stop Error!!!\n");
        return 0;
    }
    else
    {
...
bool GT9271_getPosition(int *x, int *y)
{
    ...
    i2cRead16addr_Byte(I2C_TOUCH_GT9271_RD_SLAV_ADDR, Touch_Status, &data);
    if (data & mask_buffer_status)
    {
        i2cWrite16addr_Byte(I2C_TOUCH_GT9271_WR_SLAV_ADDR, Touch_Status, 0);
        //DEBUG_I2C("buffer status %x\n", data); //enter quite often 0x81,0x81,0x80,0x80,0x80 in a touch cycle

        if(data & mask_touch_numbers)
        {
            i2cRead16addr_Byte(I2C_TOUCH_GT9271_RD_SLAV_ADDR, X_Coordinate_L, &L);
            i2cRead16addr_Byte(I2C_TOUCH_GT9271_RD_SLAV_ADDR, X_Coordinate_H, &H);
            *y = L + (H<<8);
            *y = 600 - *y; //y value need inverse
            i2cRead16addr_Byte(I2C_TOUCH_GT9271_RD_SLAV_ADDR, Y_Coordinate_L, &L);
            i2cRead16addr_Byte(I2C_TOUCH_GT9271_RD_SLAV_ADDR, Y_Coordinate_H, &H);
            *x = L + (H<<8);
...
void GT9271_PrintInfo()
{
    u8 word1, word2, word3, word4;
    u8 ver1, ver2, data = 0;
    u8 CheckSum;

    i2cRead16addr_Byte(I2C_TOUCH_GT9271_RD_SLAV_ADDR, Product_ID1, &word1);
    i2cRead16addr_Byte(I2C_TOUCH_GT9271_RD_SLAV_ADDR, Product_ID2, &word2);
    i2cRead16addr_Byte(I2C_TOUCH_GT9271_RD_SLAV_ADDR, Product_ID3, &word3);
    i2cRead16addr_Byte(I2C_TOUCH_GT9271_RD_SLAV_ADDR, Product_ID4, &word4);
    DEBUG_I2C("GT9271 ProductID : %c%c%c%c\n", word1, word2, word3, word4);

    data = 0xAA;
    i2cWrite16addr_Byte(I2C_TOUCH_GT9271_WR_SLAV_ADDR, ESD_Check, data);
    i2cRead16addr_Byte(I2C_TOUCH_GT9271_RD_SLAV_ADDR, ESD_Check, &data);
    DEBUG_I2C("Write AA ESD %x\n", data);

    i2cRead16addr_Byte(I2C_TOUCH_GT9271_RD_SLAV_ADDR, Touch_Number, &data);
    DEBUG_I2C("Touch number %x\n", data);

    i2cRead16addr_Byte(I2C_TOUCH_GT9271_RD_SLAV_ADDR, Refresh_rate, &data);
    DEBUG_I2C("Refresh_rate %x\n", data);
    i2cRead16addr_Byte(I2C_TOUCH_GT9271_RD_SLAV_ADDR, GT9271_Status, &data);
    DEBUG_I2C("GT9271_Status %x, 0 as working\n", data);
...
{
    u8 CheckSum, data, i;
    for(i = 0; i < (Config_Chksum - Config_Version + 1); i++)
        i2cWrite16addr_Byte(I2C_TOUCH_GT9271_WR_SLAV_ADDR, (Config_Version+i), i2cGT9271_Config[i]);


    i2cRead16addr_Byte(I2C_TOUCH_GT9271_RD_SLAV_ADDR, Config_Chksum, &CheckSum);

#if 0 // 1024*600, //600*1024 xy pin inverse for WM903 in i2cGT9271_Config
    i2cRead16addr_Byte(I2C_TOUCH_GT9271_RD_SLAV_ADDR, X_Output_Max_L, &data);
    DEBUG_BLUE("%x ", data);
    CheckSum += data;  
    i2cWrite16addr_Byte(I2C_TOUCH_GT9271_WR_SLAV_ADDR, X_Output_Max_L, 0);
    CheckSum -= 0x0;
    
    i2cRead16addr_Byte(I2C_TOUCH_GT9271_RD_SLAV_ADDR, X_Output_Max_H, &data);
    DEBUG_BLUE("%x ", data);
    CheckSum += data;  
    i2cWrite16addr_Byte(I2C_TOUCH_GT9271_WR_SLAV_ADDR, X_Output_Max_H, 0x4);
    CheckSum -= 0x4;

    i2cRead16addr_Byte(I2C_TOUCH_GT9271_RD_SLAV_ADDR, Y_Output_Max_L, &data);
    DEBUG_BLUE("%x ", data);
    CheckSum += data;  
    i2cWrite16addr_Byte(I2C_TOUCH_GT9271_WR_SLAV_ADDR, Y_Output_Max_L, 0x58);
    CheckSum -= 0x58;
    
    i2cRead16addr_Byte(I2C_TOUCH_GT9271_RD_SLAV_ADDR, Y_Output_Max_H, &data);
    DEBUG_BLUE("%x ", data);
    CheckSum += data;  
    i2cWrite16addr_Byte(I2C_TOUCH_GT9271_WR_SLAV_ADDR, Y_Output_Max_H, 0x2);
    CheckSum -= 0x2;
#endif



    i2cRead16addr_Byte(I2C_TOUCH_GT9271_RD_SLAV_ADDR, Module_Switch, &data);
    CheckSum += data;  
    i2cWrite16addr_Byte(I2C_TOUCH_GT9271_WR_SLAV_ADDR, Module_Switch, 0x1);
    CheckSum -= 0x1;

    i2cRead16addr_Byte(I2C_TOUCH_GT9271_RD_SLAV_ADDR, Shake_Count, &data);
    CheckSum += data;  
    i2cWrite16addr_Byte(I2C_TOUCH_GT9271_WR_SLAV_ADDR, Shake_Count, 0x11);
    CheckSum -= 0x11;

    i2cRead16addr_Byte(I2C_TOUCH_GT9271_RD_SLAV_ADDR, Low_Power_Control, &data);
    CheckSum += data;  
    i2cWrite16addr_Byte(I2C_TOUCH_GT9271_WR_SLAV_ADDR, Low_Power_Control, 0xf);
    CheckSum -= 0xf;
    
    i2cRead16addr_Byte(I2C_TOUCH_GT9271_RD_SLAV_ADDR, Refresh_rate, &data);
    CheckSum += data;  
    i2cWrite16addr_Byte(I2C_TOUCH_GT9271_WR_SLAV_ADDR, Refresh_rate, 0xf);
    CheckSum -= 0xf;

    i2cWrite16addr_Byte(I2C_TOUCH_GT9271_WR_SLAV_ADDR, Config_Chksum, CheckSum);
    i2cWrite16addr_Byte(I2C_TOUCH_GT9271_WR_SLAV_ADDR, Config_Fresh, 0x01);
    i2cWrite16addr_Byte(I2C_TOUCH_GT9271_WR_SLAV_ADDR, Status_Cmd, 0x0);
}
...
u8 i2cInit_GT9271(void)
{
    ...
    i2cWrite16addr_Byte(I2C_TOUCH_GT9271_WR_SLAV_ADDR, Status_Cmd, 0x2); //driver recovery
    OSTimeDly(4);
    ...
    {
        DEBUG_I2C("GT9271 touch ESD check: Write AA ESD %x wrongly\n", data);
    }
