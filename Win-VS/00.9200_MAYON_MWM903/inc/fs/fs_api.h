...
#define FS_DIRNAME_MAX 16        //civic optimized 255->40->16	

#define FS_MEMBLOCK_NUM   ((FS_MAXOPEN+FS_DIR_MAXOPEN))
/* Global error codes */
...
#define FS_CMD_CLEAN_CACHE			1200L
...
#define FS_CMD_FORMAT_FAST			2333L
#define FS_CMD_SET_STATUS			3333L
...
#define FS_CMD_CHECK_UNIT			5000L
#define FS_CMD_FLASH_ERASE_CHIP		9001L

/*CY 0718*/
/* known media */
#define FS_MEDIA_SMC_1MB	1000L
#define FS_MEDIA_SMC_2MB	1010L
#define FS_MEDIA_SMC_4MB	1020L
#define FS_MEDIA_SMC_8MB	1030L
#define FS_MEDIA_SMC_16MB	1040L
#define FS_MEDIA_SMC_32MB	1050L
#define FS_MEDIA_SMC_64MB	1060L
#define FS_MEDIA_SMC_128MB	1070L
#define FS_MEDIA_SMC_256MB	1080L
#define FS_MEDIA_SMC_512MB	1090L

#define FS_MEDIA_RAM_16KB	2004L
#define FS_MEDIA_RAM_32KB	2005L
#define FS_MEDIA_RAM_64KB	2006L
#define FS_MEDIA_RAM_128KB	2007L
#define FS_MEDIA_RAM_256KB	2008L
#define FS_MEDIA_RAM_512KB	2009L

#define FS_MEDIA_FD_144MB	3070L

#define FS_MEDIA_MMC_16MB	4040L
#define FS_MEDIA_MMC_32MB	4050L
#define FS_MEDIA_MMC_64MB	4060L
#define FS_MEDIA_MMC_128MB	4070L
#define FS_MEDIA_MMC_256MB	4080L
#define FS_MEDIA_MMC_512MB	4190L
#define FS_MEDIA_MMC_1GB	4100L

#define FS_MEDIA_SD_16MB	5040L
#define FS_MEDIA_SD_32MB	5050L
#define FS_MEDIA_SD_64MB	5060L
#define FS_MEDIA_SD_128MB	5070L
#define FS_MEDIA_SD_256MB	5080L
#define FS_MEDIA_SD_512MB	5090L

#define FS_MEDIA_SD_1GB		5100L
#define FS_MEDIA_SD_2GB		5110L
#define FS_MEDIA_SD_4GB 	5120L
#define FS_MEDIA_SD_8GB		5130L
#define FS_MEDIA_SD_16GB	5140L
#define FS_MEDIA_SD_32GB	5150L
#define FS_MEDIA_SD_64GB	5160L
#define FS_MEDIA_SD_128GB	5170L
#define FS_MEDIA_SD_256GB	5180L
#define FS_MEDIA_SD_512GB	5190L

#define FS_MEDIA_SD_1TB	5200L
#define FS_MEDIA_SD_2TB	5210L
#define FS_MEDIA_SD_3TB	5220L
#define FS_MEDIA_SD_4TB	5230L
#define FS_MEDIA_SD_5TB	5240L
#define FS_MEDIA_SD_6TB	5250L


#define FS_MEDIA_CF_32MB	6050L
#define FS_MEDIA_CF_64MB	6060L
...
typedef struct
{
	...
	u32 StartTime;
	u32 EndTime;
	u32 StartNumOfInOrder;
	u8 EntryType;
	u8 ChannelMap;
	u8 LightWeightSearch;
...
typedef struct
{
    ...
    char used_flag;
#endif
    u16 FileEntrySect;				//Lucian: recording file-entry location. (sector unit)
    u16 FileEntrySectOffset;

    u16 fsFileCreateTime_HMS;
    u16 fsFileCreateDate_YMD;
    u16 fsFileModifiedTime_HMS;
    u16 fsFileModifiedDate_YMD;
} FS_DIRENT;


typedef struct
{
    u32 fileid_lo;		// unique id for file (lo)	// cytsai: unit where file is located
    u32 fileid_hi;		// unique id for file (hi)	// cytsai: first cluster number of file
    u32 fileid_ex;		// unique id for file (ex)  // cytsai: first cluster number of directory where file is located
    u32 FileEntrySect;                              // Lucian: Optimize for fclose; record the location(sector) of file entry.
    s32 EOFClust;		// used by FAT FSL only
    u32 CurClust;		// used by FAT FSL only
    u32 filepos;		// current position in file	// cytsai: current position of file
    u32 NumOfPosClust;	// The cluster number of last time accessed.
    s32 size;			// size of file
    s32 append_size;
...
typedef struct
{
    FS_DIRENT dirent;	// cunrrent directory entry
    u32 dirid_lo;		// unique id for file (lo)      	// cytsai: unit where directory is located
    u32 dirid_hi;		// unique id for file (hi)      	// cytsai: first cluster number of directory
    u32 dirid_ex;		// unique id for file (ex)      	// cytsai: first cluster number of parent directory
    s32 dirpos;			// current position in file     	// cytsai: FDB position in cluster of directory, dirpos = 0, 32, 64,...
    s32 size;			// size of file                  	// cytsai: in unit sector
    int dev_index;		// index in _FS_devinfo[]
    s16 error;			// error code
    u8 inuse;			// handle in use mark
} FS_DIR;
...
typedef struct
{
    // File information
    char FileName[11];
    u64p FileSize;			// Units in Cluster.
    u64p UsedSize;			// Units in Bytes, DATA IO Length.
    u32 StartClust;			// The first cluster number of file.
    u32 CurClust;			//
    u32 FilePos;			//
    u32 EOFClust;			// The last cluster of this file.

    // Dir information of Parent
    u32 ParentClust;		// The first cluster number of file entry in directory.
    u16 EntryOffsetOfSec;	// Offset number of sectors in cluster.

    // Other information
    u32 ErrorCode;			//
    u8 UnitNumber;			// This number belongs to someone device
    u8 FileStatus;			// 0: not in use, 1: in use.
} FS_OBJ;
...
int FS_ReadDir(FS_DIR *pDir, FS_DIRENT* pEnt);
