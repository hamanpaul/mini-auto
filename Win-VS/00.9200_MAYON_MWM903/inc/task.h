...
extern void pWifi_WrapTx_Task_UnitX(void* pData);

extern void rfiu_WrapRx_Task_UnitX(void*);
extern void pWifi_WrapRx_Task_UnitX(void*);


extern void rfiu_RxMpeg4DecTask_UnitX(void* pData);

#if PWIFI_SUPPORT
extern void pWifi_TX_Task_UnitX(void* pData);
extern void pWifi_RX_Task_UnitX(void* pData);
#endif
...
#if MARSS_SUPPORT
extern void MarssTimerTask(void*);
extern void MARSS_Task(void*);
#endif
#if(HOME_RF_SUPPORT)
extern void homeRFTask(void* pData);
#endif
#if PWM_BEEP_TASK_SUPPORT
extern void pwmBeepTask(void* pData);
#endif
...
extern OS_STK rfiuTaskStack_Unit4[]; 
extern OS_STK rfiuTaskStack_Unit5[]; 
extern OS_STK rfiuTaskStack_Unit6[]; 
extern OS_STK rfiuTaskStack_Unit7[]; 
#endif
...
#if (RFI_TEST_8TX_2RX_PROTOCOL || RFI_TEST_8TX_1RX_PROTOCOL) 
extern OS_STK rfiuWrapTaskStack_Unit4[]; 
extern OS_STK rfiuWrapTaskStack_Unit5[]; 
extern OS_STK rfiuWrapTaskStack_Unit6[]; 
extern OS_STK rfiuWrapTaskStack_Unit7[]; 
#endif
...
#if (RFI_TEST_8TX_2RX_PROTOCOL || RFI_TEST_8TX_1RX_PROTOCOL) 
extern OS_STK rfiuDecTaskStack_Unit4[]; 
extern OS_STK rfiuDecTaskStack_Unit5[]; 
extern OS_STK rfiuDecTaskStack_Unit6[]; 
extern OS_STK rfiuDecTaskStack_Unit7[]; 
#endif
...
extern OS_STK VideoTaskStack0[]; /* Stack of task MultiChannelVideoEncoderTask() */
extern OS_STK VideoTaskStack0[]; /* Stack of task MultiChannelVideoEncoderTask() */
extern OS_STK VideoTaskStack2[]; /* Stack of task MultiChannelVideoEncoderTask() */
extern OS_STK VideoTaskStack3[]; /* Stack of task MultiChannelVideoEncoderTask() */
#endif
...
#if PWM_BEEP_TASK_SUPPORT
extern OS_STK pwmBeepTaskStack[];
#endif
#if MARSS_SUPPORT
extern OS_STK MarssTimerTaskStack[];
extern OS_STK MarssTaskStack[];
#endif
#if(HOME_RF_SUPPORT)
...
#define CIU_TASK_CH5        ciuTask_CH5
...
#if PWIFI_SUPPORT           
#define RFIU_TX_WRAP_TASK_UNITX pWifi_WrapTx_Task_UnitX
#define RFIU_RX_WRAP_TASK_UNITX pWifi_WrapRx_Task_UnitX
#else
...
#if PWIFI_SUPPORT           
#define PWIFI_TX_TASK_UNITX pWifi_TX_Task_UnitX
#define PWIFI_RX_TASK_UNITX pWifi_RX_Task_UnitX
#endif
...
#endif
#define DEBUG_TASK_PRIO (OS_LOWEST_PRIO+1)
...
#define MULTI_CH_VIDEO_ENC_TASK MultiChannelVideoEncoderTask
...
#define IIS_CH0_TASK		iis_ch0_task
#define IIS_CH1_TASK		iis_ch1_task
#define IIS_CH2_TASK		iis_ch2_task
#define IIS_CH3_TASK		iis_ch3_task
...
#if MARSS_SUPPORT
#define MARSS_TIMER_TASK        MarssTimerTask
#define MARSS_TASK        MARSS_Task
#endif
...
#if PWM_BEEP_TASK_SUPPORT
#define PWM_BEEP_TASK          pwmBeepTask
#endif
...
#define CIU_TASK_PARAMETER_CH5		(void *) 0
...
#define RFIU_TASK_PARAMETER_UNIT_4  (void *) 4
#define RFIU_TASK_PARAMETER_UNIT_5  (void *) 5
#define RFIU_TASK_PARAMETER_UNIT_6  (void *) 6
#define RFIU_TASK_PARAMETER_UNIT_7  (void *) 7
...
#define RFIU_WRAP_TASK_PARAMETER_UNIT_4  (void *) 4
#define RFIU_WRAP_TASK_PARAMETER_UNIT_5  (void *) 5
#define RFIU_WRAP_TASK_PARAMETER_UNIT_6  (void *) 6
#define RFIU_WRAP_TASK_PARAMETER_UNIT_7  (void *) 7
...
#define RFIU_DEC_TASK_PARAMETER_UNIT_4  (void *) 4
#define RFIU_DEC_TASK_PARAMETER_UNIT_5  (void *) 5
#define RFIU_DEC_TASK_PARAMETER_UNIT_6  (void *) 6
#define RFIU_DEC_TASK_PARAMETER_UNIT_7  (void *) 7
...
#define IIS_CH0_TASK_PARAMETER		(void *) 0
#define IIS_CH1_TASK_PARAMETER		(void *) 0
#define IIS_CH2_TASK_PARAMETER		(void *) 0
#define IIS_CH3_TASK_PARAMETER		(void *) 0
#endif
...
#if SD_TASK_INSTALL_FLOW_SUPPORT
#define SDC_TASK_PARAMETER			(void *) 0
#endif
#if(USB_HOST==1)
...
#if MARSS_SUPPORT
#define MARSS_TIMER_TASK_PARAMETER     (void *) 0
#define MARSS_TASK_PARAMETER     (void *) 0
#endif
...
#if PWM_BEEP_TASK_SUPPORT
#define PWM_BEEP_TASK_PARAMETER        (void *) 0
#endif
...
/*-------- Task stack size in byte --------*/
    ...
    (SW_APPLICATION_OPTION == MR9120_RFCAM_TX1_SUBSTREAM) || (SW_APPLICATION_OPTION == MR9120_RFCAM_TX1_MUTISTREAM) || (SW_APPLICATION_OPTION == MR9120_DOORCAM_TX5_MUTISTREAM_FWUPD))
     ...
     #define SIU_TASK_STACK_SIZE		         128
     #define CIU_TASK_STACK_SIZE_CH1		     1024
     #define CIU_TASK_STACK_SIZE_CH2		     128
     #define CIU_TASK_STACK_SIZE_CH3		     128
     #define CIU_TASK_STACK_SIZE_CH4		     128
     #define CIU_TASK_STACK_SIZE_CH5		     1024

     #define NIC_TASK_STACK_SIZE		         128

     #define RFIU_TASK_STACK_SIZE_UNIT0          2048
     #define RFIU_TASK_STACK_SIZE_UNIT1          32
     #define RFIU_TASK_STACK_SIZE_UNIT2          32
     #define RFIU_TASK_STACK_SIZE_UNIT3          32
     #define RFIU_TASK_STACK_SIZE_UNIT4          32
     #define RFIU_TASK_STACK_SIZE_UNIT5          32
     #define RFIU_TASK_STACK_SIZE_UNIT6          32
     #define RFIU_TASK_STACK_SIZE_UNIT7          32

     #define RFIU_WRAP_TASK_STACK_SIZE_UNIT0     2048
     #define RFIU_WRAP_TASK_STACK_SIZE_UNIT1     32
     #define RFIU_WRAP_TASK_STACK_SIZE_UNIT2     32
     #define RFIU_WRAP_TASK_STACK_SIZE_UNIT3     32
     #define RFIU_WRAP_TASK_STACK_SIZE_UNIT4     32
     #define RFIU_WRAP_TASK_STACK_SIZE_UNIT5     32
     #define RFIU_WRAP_TASK_STACK_SIZE_UNIT6     32
     #define RFIU_WRAP_TASK_STACK_SIZE_UNIT7     32

     #define RFIU_DEC_TASK_STACK_SIZE_UNIT0      32
     #define RFIU_DEC_TASK_STACK_SIZE_UNIT1      32
     #define RFIU_DEC_TASK_STACK_SIZE_UNIT2      32
     #define RFIU_DEC_TASK_STACK_SIZE_UNIT3      32
     #define RFIU_DEC_TASK_STACK_SIZE_UNIT4      32
     #define RFIU_DEC_TASK_STACK_SIZE_UNIT5      32
     #define RFIU_DEC_TASK_STACK_SIZE_UNIT6      32
     #define RFIU_DEC_TASK_STACK_SIZE_UNIT7      32


     #define UI_TASK_STACK_SIZE		             1024 
     #define SYS_TASK_STACK_SIZE		         2048
     #define SYSBACK_TASK_STACK_SIZE		     1024	//Lucian: sysback task ­t²ü¤é¯qÄY­«.
     #define SYSBACK_RF_TASK_STACK_SIZE          1024
     #if (NIC_SUPPORT == 1)
     #define SYSBACK_NET_TASK_STACK_SIZE         1024//1024
     #endif
     ...
     #define IIS_CH0_TASK_STACK_SIZE             1024
     #define IIS_CH1_TASK_STACK_SIZE             1024
     #define IIS_CH2_TASK_STACK_SIZE             1024
     #define IIS_CH3_TASK_STACK_SIZE             1024
     #endif
     ...
     #define IOTC_TRANSMISSION_TASK_STACK_SIZE	8192 
       ...
       #else
         #define TASK_LOGIN_STACK_SIZE			2048
    ...
    #define IOTC_CMD_TASK_STACK_SIZE			5120//16384
     ...
     #if MARSS_SUPPORT
	 #define MARSS_TIMER_TASK_STACK_SIZE         1024
	 #define MARSS_TASK_STACK_SIZE               1024
     #endif
     #if(HOME_RF_SUPPORT)
...
#if (TCP_ECHO_SERVER_SUPPORT || UDP_ECHO_SERVER_SUPPORT)
     #define ECHO_SERVER_TASK_STACK_SIZE        4096
#endif
     #define RFIU_TASK_STACK_SIZE_UNIT0          2048
     #define RFIU_TASK_STACK_SIZE_UNIT1          2048
     #define RFIU_TASK_STACK_SIZE_UNIT2          2048
     #define RFIU_TASK_STACK_SIZE_UNIT3          2048
     #define RFIU_TASK_STACK_SIZE_UNIT4          2048
     #define RFIU_TASK_STACK_SIZE_UNIT5          2048
     #define RFIU_TASK_STACK_SIZE_UNIT6          2048
     #define RFIU_TASK_STACK_SIZE_UNIT7          2048
     ...
     #define RFIU_WRAP_TASK_STACK_SIZE_UNIT4     2048
     #define RFIU_WRAP_TASK_STACK_SIZE_UNIT5     2048
     #define RFIU_WRAP_TASK_STACK_SIZE_UNIT6     2048
     #define RFIU_WRAP_TASK_STACK_SIZE_UNIT7     2048

     #define RFIU_DEC_TASK_STACK_SIZE_UNIT0      4096
     #define RFIU_DEC_TASK_STACK_SIZE_UNIT1      4096
     #define RFIU_DEC_TASK_STACK_SIZE_UNIT2      4096
     #define RFIU_DEC_TASK_STACK_SIZE_UNIT3      4096
     #define RFIU_DEC_TASK_STACK_SIZE_UNIT4      4096
     #define RFIU_DEC_TASK_STACK_SIZE_UNIT5      4096
     #define RFIU_DEC_TASK_STACK_SIZE_UNIT6      4096
     #define RFIU_DEC_TASK_STACK_SIZE_UNIT7      4096
     ...
     #define USB_PERF_TASK_STACK_SIZE	         1024		/* Chi-Lun 20080624 */
#if SD_TASK_INSTALL_FLOW_SUPPORT
	 #define SDC_DEVICE_TASK_STACK_SIZE			 1024
#endif
     #if(USB_HOST==1)
     #define USB_HOST_TASK_STACK_SIZE	         1024
     #define USB_HOST_MSC_TASK_STACK_SIZE        1024
	...
	#define TASK_SESSION_STACK_SIZE             5120
	#else
	#define TASK_LOGIN_STACK_SIZE               4096
	#define TASK_SESSION_STACK_SIZE             16384
	#endif
	#define TASK_LISTEN_STACK_SIZE              4096
	#define TASK_SPEAKER_STACK_SIZE             4096
	#define TASK_P2P_PLAYFILE_STACK_SIZE        1024
...
#if PWM_BEEP_TASK_SUPPORT
#define PWM_BEEP_TASK_STACK_SIZE              256
#endif
...
#define CIU_TASK_STACK_CH5		&ciuTaskStack_CH5[CIU_TASK_STACK_SIZE_CH5 - 1]


#define NIC_TASK_STACK		    &nicTaskStack[NIC_TASK_STACK_SIZE - 1]
#if (TCP_ECHO_SERVER_SUPPORT || UDP_ECHO_SERVER_SUPPORT)
#define ECHO_SERVER_TASK_STACK		    &echoServerTaskStack[ECHO_SERVER_TASK_STACK_SIZE - 1]
#endif
...
#if (RFI_TEST_8TX_2RX_PROTOCOL || RFI_TEST_8TX_1RX_PROTOCOL) 
#define RFIU_TASK_STACK_UNIT4   &rfiuTaskStack_Unit4[RFIU_TASK_STACK_SIZE_UNIT4]
#define RFIU_TASK_STACK_UNIT5   &rfiuTaskStack_Unit5[RFIU_TASK_STACK_SIZE_UNIT5]
#define RFIU_TASK_STACK_UNIT6   &rfiuTaskStack_Unit6[RFIU_TASK_STACK_SIZE_UNIT6]
#define RFIU_TASK_STACK_UNIT7   &rfiuTaskStack_Unit7[RFIU_TASK_STACK_SIZE_UNIT7]
#endif
...
#if (RFI_TEST_8TX_2RX_PROTOCOL || RFI_TEST_8TX_1RX_PROTOCOL) 
#define RFIU_WRAP_TASK_STACK_UNIT4   &rfiuWrapTaskStack_Unit4[RFIU_WRAP_TASK_STACK_SIZE_UNIT4]
#define RFIU_WRAP_TASK_STACK_UNIT5   &rfiuWrapTaskStack_Unit5[RFIU_WRAP_TASK_STACK_SIZE_UNIT5]
#define RFIU_WRAP_TASK_STACK_UNIT6   &rfiuWrapTaskStack_Unit6[RFIU_WRAP_TASK_STACK_SIZE_UNIT6]
#define RFIU_WRAP_TASK_STACK_UNIT7   &rfiuWrapTaskStack_Unit7[RFIU_WRAP_TASK_STACK_SIZE_UNIT7]
#endif
...
#if (RFI_TEST_8TX_2RX_PROTOCOL || RFI_TEST_8TX_1RX_PROTOCOL) 
#define RFIU_DEC_TASK_STACK_UNIT4   &rfiuDecTaskStack_Unit4[RFIU_DEC_TASK_STACK_SIZE_UNIT4]
#define RFIU_DEC_TASK_STACK_UNIT5   &rfiuDecTaskStack_Unit5[RFIU_DEC_TASK_STACK_SIZE_UNIT5]
#define RFIU_DEC_TASK_STACK_UNIT6   &rfiuDecTaskStack_Unit6[RFIU_DEC_TASK_STACK_SIZE_UNIT6]
#define RFIU_DEC_TASK_STACK_UNIT7   &rfiuDecTaskStack_Unit7[RFIU_DEC_TASK_STACK_SIZE_UNIT7]
...
#define MULTI_CH_VIDEO_TASK_STACK0  &VideoTaskStack0[VIDEO_TASK_STACK_SIZE - 1]
#define MULTI_CH_VIDEO_TASK_STACK1  &VideoTaskStack1[VIDEO_TASK_STACK_SIZE - 1]
#define MULTI_CH_VIDEO_TASK_STACK2  &VideoTaskStack2[VIDEO_TASK_STACK_SIZE - 1]
#define MULTI_CH_VIDEO_TASK_STACK3  &VideoTaskStack3[VIDEO_TASK_STACK_SIZE - 1]
...
#define IIS_CH0_TASK_STACK		&iisCh0TaskStack[IIS_CH0_TASK_STACK_SIZE - 1]
#define IIS_CH1_TASK_STACK		&iisCh1TaskStack[IIS_CH1_TASK_STACK_SIZE - 1]
#define IIS_CH2_TASK_STACK		&iisCh2TaskStack[IIS_CH2_TASK_STACK_SIZE - 1]
#define IIS_CH3_TASK_STACK		&iisCh3TaskStack[IIS_CH3_TASK_STACK_SIZE - 1]
#endif
...
#if SD_TASK_INSTALL_FLOW_SUPPORT
#define SDC_DEVICE_TASK_STACK	&sdcTaskStack[SDC_DEVICE_TASK_STACK_SIZE - 1]
#endif
#if(USB_HOST==1)
...
#if MARSS_SUPPORT
#define MARSS_TIMER_TASK_STACK     &MarssTimerTaskStack[MARSS_TIMER_TASK_STACK_SIZE-1]
#define MARSS_TASK_STACK     &MarssTaskStack[MARSS_TASK_STACK_SIZE-1]
#endif
...
#if PWM_BEEP_TASK_SUPPORT
#define PWM_BEEP_TASK_STACK      &pwmBeepTaskStack[PWM_BEEP_TASK_STACK_SIZE-1]
#endif
#if ICOMMWIFI_SUPPORT
...
/*--------------------------- Task priority-------------------------------- */
    ...
    (SW_APPLICATION_OPTION == MR8120_RFCAM_TX2) || (SW_APPLICATION_OPTION == FPGA_VERIFY_TEST_RFTX1) || (SW_APPLICATION_OPTION == MR9120_RFCAM_TX1_SUBSTREAM) ||\
...
#define VIDEO_TASK_PRIORITY_UNIT0       MPEG4_TASK_PRIORITY_UNIT0
#define VIDEO_TASK_PRIORITY_UNIT1       MPEG4_TASK_PRIORITY_UNIT1
#define VIDEO_TASK_PRIORITY_UNIT2       MPEG4_TASK_PRIORITY_UNIT2
#define VIDEO_TASK_PRIORITY_UNIT3       MPEG4_TASK_PRIORITY_UNIT3
...
enum
{
    ...
    SYSTIMER_TASK_PRIORITY,
    SYSBACK_RF_TASK_PRIORITY,
#if 0 //( ICOMMWIFI_SUPPORT && (PWIFI_SUPPORT == 0) )
	/*Icomm uesd 14 tasks*/
	ICOMM_TASK_01_PRIORITY	,
	ICOMM_TASK_02_PRIORITY	,
	ICOMM_TASK_03_PRIORITY ,
...
#define MPEG4_TASK_PRIORITY_UNIT1	    64
#define MPEG4_TASK_PRIORITY_UNIT2	    64
#define MPEG4_TASK_PRIORITY_UNIT3	    64
...
#define IIS_TASK_PRIORITY               IIS_TASK_PRIORITY_UNIT0
#define MJPG_TASK_PRIORITY		        MPEG4_TASK_PRIORITY_UNIT0
#define MPEG4_TASK_PRIORITY		        MPEG4_TASK_PRIORITY_UNIT0
#define VIDEO_TASK_PRIORITY             MPEG4_TASK_PRIORITY_UNIT0
#define UARTCMD_TASK3_PRIORITY          UARTCMD_TASK1_PRIORITY
#define DISPLAY_LOGO_PRIORITY           RFIU_TASK_PRIORITY_HIGH
...
#define	T_LWIP_THREAD_MAX_NB	        4
    ...
    /*no use, for build code */
#define TCPIP_THREAD_PRIO_t             DEBUG_TASK_PRIO       

#define UARTCMD_TASK2_PRIORITY          DEBUG_TASK_PRIO

#define DEBUG_TASK_PRIORITY             DEBUG_TASK_PRIO
#define USB_MSC_TASK_PRIORITY           USB_DEVICE_TASK_PRIORITY
#define USB_VC_TASK_PRIORITY            USB_DEVICE_TASK_PRIORITY
#define USB_PERF_TASK_PRIORITY          DEBUG_TASK_PRIO
//#define USB_TASK_PRIORITY               DEBUG_TASK_PRIO
#if SD_TASK_INSTALL_FLOW_SUPPORT
#define SDC_TASK_PRIORITY				DEBUG_TASK_PRIO
#endif
#define RTC_TASK_PRIORITY               DEBUG_TASK_PRIO
#define NIC_TASK_PRIORITY               DEBUG_TASK_PRIO
#define T_LWIPENTRY_PRIOR               DEBUG_TASK_PRIO
#define T_LWIP_THREAD_START_PRIO        DEBUG_TASK_PRIO
#define STREAMING_RTP_TASK_PRIORITY     DEBUG_TASK_PRIO
#define WRAP_RTP_TASK_PRIORITY          DEBUG_TASK_PRIO
#define T_ETHERNETIF_INPUT_PRIO         DEBUG_TASK_PRIO

#define MPEG4_TASK_PRIORITY_UNIT0       DEBUG_TASK_PRIO
#define MPEG4_TASK_PRIORITY_UNIT1	    DEBUG_TASK_PRIO
#define MPEG4_TASK_PRIORITY_UNIT2	    DEBUG_TASK_PRIO
#define MPEG4_TASK_PRIORITY_UNIT3	    DEBUG_TASK_PRIO

/*preview*/
#define SIU_TASK_PRIORITY_PVW           DEBUG_TASK_PRIO
#define CIU_TASK_PRIORITY_CH1           DEBUG_TASK_PRIO
#define CIU_TASK_PRIORITY_CH2           DEBUG_TASK_PRIO
#define CIU_TASK_PRIORITY_CH3           DEBUG_TASK_PRIO
#define CIU_TASK_PRIORITY_CH4           DEBUG_TASK_PRIO
#define CIU_TASK_PRIORITY_CH5           DEBUG_TASK_PRIO

#if !ICOMMWIFI_SUPPORT
/*Icomm uesd 14 tasks*/
#define     ICOMM_TASK_01_PRIORITY      DEBUG_TASK_PRIO
#define     ICOMM_TASK_02_PRIORITY      DEBUG_TASK_PRIO
#define     ICOMM_TASK_03_PRIORITY      DEBUG_TASK_PRIO
#define     ICOMM_TASK_04_PRIORITY      DEBUG_TASK_PRIO
#define     ICOMM_TASK_05_PRIORITY      DEBUG_TASK_PRIO
#define     ICOMM_TASK_06_PRIORITY      DEBUG_TASK_PRIO
#define     ICOMM_TASK_07_PRIORITY      DEBUG_TASK_PRIO
#define     ICOMM_TASK_08_PRIORITY      DEBUG_TASK_PRIO
#define     ICOMM_TASK_09_PRIORITY      DEBUG_TASK_PRIO
#define     ICOMM_TASK_10_PRIORITY      DEBUG_TASK_PRIO
#define     ICOMM_TASK_11_PRIORITY      DEBUG_TASK_PRIO
#define     ICOMM_TASK_12_PRIORITY      DEBUG_TASK_PRIO
#define     ICOMM_TASK_13_PRIORITY      DEBUG_TASK_PRIO
#define     ICOMM_TASK_14_PRIORITY      DEBUG_TASK_PRIO

/*SPI wireless dongle*/
#define 	ICOMM_INIT_TASK_PRIORITY	DEBUG_TASK_PRIO
#endif
//-----//
...
#elif((SW_APPLICATION_OPTION == MR9100_RF_DONGLE_AVSED_RX1RX2_8CH))
enum
{
    RFIU_TASK_PRIORITY_HIGH = 4,
#if IIS_TEST   
    ...
    RFIU_TASK_PRIORITY_UNIT2,
    RFIU_TASK_PRIORITY_UNIT3,
    RFIU_TASK_PRIORITY_UNIT4,
    RFIU_TASK_PRIORITY_UNIT5,
    RFIU_TASK_PRIORITY_UNIT6,
    RFIU_TASK_PRIORITY_UNIT7,
    ...
    RFIU_WRAP_TASK_PRIORITY_UNIT2,
    RFIU_WRAP_TASK_PRIORITY_UNIT3,
    RFIU_WRAP_TASK_PRIORITY_UNIT4,
    RFIU_WRAP_TASK_PRIORITY_UNIT5,
    RFIU_WRAP_TASK_PRIORITY_UNIT6,
    RFIU_WRAP_TASK_PRIORITY_UNIT7,
...
#define RTC_TASK_PRIORITY               DEBUG_TASK_PRIO
#if SD_TASK_INSTALL_FLOW_SUPPORT
#define UARTCMD_TASK3_PRIORITY			DEBUG_TASK_PRIO
#endif
#define SIU_TASK_PRIORITY_PVW           DEBUG_TASK_PRIO 
#define CIU_TASK_PRIORITY_CH1           DEBUG_TASK_PRIO 
#define CIU_TASK_PRIORITY_CH2           DEBUG_TASK_PRIO 
...
/*asf*/
#define SYS_SUB_TASK_PRIORITY_UNIT0     DEBUG_TASK_PRIO 
#define SYS_SUB_TASK_PRIORITY_UNIT1     DEBUG_TASK_PRIO 
#define SYS_SUB_TASK_PRIORITY_UNIT2     DEBUG_TASK_PRIO 
#define SYS_SUB_TASK_PRIORITY_UNIT3     DEBUG_TASK_PRIO 

/*RF*/
#define RFIU_DEC_TASK_PRIORITY_UNIT0    DEBUG_TASK_PRIO 
#define RFIU_DEC_TASK_PRIORITY_UNIT1    DEBUG_TASK_PRIO 
#define RFIU_DEC_TASK_PRIORITY_UNIT2    DEBUG_TASK_PRIO 
#define RFIU_DEC_TASK_PRIORITY_UNIT3    DEBUG_TASK_PRIO 
#define RFIU_DEC_TASK_PRIORITY_UNIT4    DEBUG_TASK_PRIO 
#define RFIU_DEC_TASK_PRIORITY_UNIT5    DEBUG_TASK_PRIO 
#define RFIU_DEC_TASK_PRIORITY_UNIT6    DEBUG_TASK_PRIO 
#define RFIU_DEC_TASK_PRIORITY_UNIT7    DEBUG_TASK_PRIO 
...
/*IIS*/
#define IIS_TASK_PRIORITY_UNIT0         DEBUG_TASK_PRIO 
#define IIS_TASK_PRIORITY_UNIT1         DEBUG_TASK_PRIO 
#define IIS_TASK_PRIORITY_UNIT2         DEBUG_TASK_PRIO 
#define IIS_TASK_PRIORITY_UNIT3         DEBUG_TASK_PRIO 
...
enum
{
...
#if( ICOMMWIFI_SUPPORT && (PWIFI_SUPPORT == 1) )
    /*Icomm uesd 14 tasks*/
    ICOMM_TASK_01_PRIORITY  ,
    ICOMM_TASK_02_PRIORITY  ,
    ICOMM_TASK_03_PRIORITY ,
  ...
  #if(TUTK_SUPPORT==1)
    #if LWIP2_SUPPORT
    IOTC_INIT_TASK_PRIORITY,
    IOTC_TRANSMISSION1_TASK_PRIORITY,  
    #else
    IOTC_ROUTINE_TASK_PRIORITY,
    IOTC_TRANSMISSION_TASK_PRIORITY,    
    #endif
...
#if ( ICOMMWIFI_SUPPORT && (PWIFI_SUPPORT == 0) )
    /*Icomm uesd 14 tasks*/
    ICOMM_TASK_01_PRIORITY  ,
    ICOMM_TASK_02_PRIORITY  ,
    ICOMM_TASK_03_PRIORITY ,
...
#elif ( (SW_APPLICATION_OPTION == MR9100_RF_DONGLE_AVSED_RX1RX2) || (SW_APPLICATION_OPTION ==DVP_RF_SELFTEST) || (SW_APPLICATION_OPTION == FPGA_VERIFY_TEST_RFU) ||(SW_APPLICATION_OPTION == MR8200_RFCAM_RX1)||\
        (SW_APPLICATION_OPTION == MR8200_RFCAM_RX1RX2) || (SW_APPLICATION_OPTION == MR9200_HDMI_RX1RX2) || (SW_APPLICATION_OPTION == MR9200_MIXCAM_RX1RX2) ||\
        (SW_APPLICATION_OPTION == MR8120_RFCAM_RX1) || (SW_APPLICATION_OPTION == MR8600_RFCAM_RX1RX2) || (SW_APPLICATION_OPTION == FPGA_VERIFY_TEST_RFRX1) || (SW_APPLICATION_OPTION == MR9300_NETBOX_RX1RX2) ) 
enum
{
    RFIU_TASK_PRIORITY_HIGH = 0,
#if IIS_TEST   
...
#elif ( (SW_APPLICATION_OPTION == MR8600_RFAVSED_RX1RX2) || (SW_APPLICATION_OPTION == MR9100_RF_CVI_AVSED_RX1) || (SW_APPLICATION_OPTION == MR9100_RF_AHD_AVSED_RX1) || (SW_APPLICATION_OPTION == MR9100_RF_AHDIN_AVSED_RX1) || (SW_APPLICATION_OPTION == MR8600_RFAVSED_RX1) || (SW_APPLICATION_OPTION == MR8120_RFAVSED_RX1) || (SW_APPLICATION_OPTION == MR8110_BABYMONITOR)||(SW_APPLICATION_OPTION == MR9100_RF_HDMI_AVSED_RX1) )
enum
{
...
#define DISPLAY_LOGO_PRIORITY           RFIU_TASK_PRIORITY_HIGH
    ...
    /*no use, for build code */
#define DEBUG_TASK_PRIORITY             DEBUG_TASK_PRIO 
#define USB_MSC_TASK_PRIORITY           DEBUG_TASK_PRIO 
#define USB_VC_TASK_PRIORITY              USB_TASK_PRIORITY
#define USB_HOST_TASK_PRIORITY              USB_TASK_PRIORITY
#define USB_PERF_TASK_PRIORITY          DEBUG_TASK_PRIO 
...
#define DEBUG_TASK_PRIORITY             DEBUG_TASK_PRIO 
#define USB_MSC_TASK_PRIORITY           DEBUG_TASK_PRIO 
#define USB_VC_TASK_PRIORITY            DEBUG_TASK_PRIO 
#define USB_PERF_TASK_PRIORITY          DEBUG_TASK_PRIO 
#define USB_TASK_PRIORITY               DEBUG_TASK_PRIO 
#define SDC_TASK_PRIORITY				DEBUG_TASK_PRIO 
#define RTC_TASK_PRIORITY               DEBUG_TASK_PRIO 
#define RFIU_WRAP_TASK_PRIORITY_UNIT2   DEBUG_TASK_PRIO 
#define RFIU_WRAP_TASK_PRIORITY_UNIT3   DEBUG_TASK_PRIO 
#if (NIC_SUPPORT == 0)
#define T_LWIPENTRY_PRIOR               DEBUG_TASK_PRIO 
#define TCPIP_THREAD_PRIO_t             DEBUG_TASK_PRIO 
#define T_ETHERNETIF_INPUT_PRIO         DEBUG_TASK_PRIO 
#define WEB_LISTEN_TASK_PRIORITY        DEBUG_TASK_PRIO 
#define WEB_TASK_PRIORITY               DEBUG_TASK_PRIO 
#define WEB_TASK2_PRIORITY              DEBUG_TASK_PRIO 
#define WEB_TASK3_PRIORITY              DEBUG_TASK_PRIO 
#define WEB_TASK4_PRIORITY              DEBUG_TASK_PRIO 
#define WEB_LISTEN_SSL_TASK_PRIORITY    DEBUG_TASK_PRIO 
#define IOTC_ROUTINE_TASK_PRIORITY      DEBUG_TASK_PRIO 
#define IOTC_LOGIN_TASK_PRIORITY        DEBUG_TASK_PRIO 
#define LISTEN_TASK_PRIORITY            DEBUG_TASK_PRIO 
#define LOGIN_TASK_PRIORITY             DEBUG_TASK_PRIO 
#define SESSION_TASK_PRIORITY           DEBUG_TASK_PRIO 
#define WRAP_RTP_TASK_PRIORITY          DEBUG_TASK_PRIO 
#define STREAMING_RTP_TASK_PRIORITY     DEBUG_TASK_PRIO 
#define TELNET_THREAD_PRIO_t            DEBUG_TASK_PRIO 
#endif
#elif ((SW_APPLICATION_OPTION == MR8202_GATEWAYBOX_RX) || (SW_APPLICATION_OPTION == MR8202_AN_KLF08W))
enum
{
    RFIU_TASK_PRIORITY_HIGH = 4,
#if IIS_TEST   
    ...
    RFIU_WRAP_TASK_PRIORITY_UNIT1,
    RFIU_WRAP_TASK_PRIORITY_UNIT2,
    RFIU_WRAP_TASK_PRIORITY_UNIT3,	//47
...
#if LWIP2_SUPPORT
#define	    USB_PERF_TASK_PRIORITY		0
#define	    SPEAKER_TASK_PRIORITY		0
#define	    P2P_PLAYFILE_TASK_PRIORITY		0
#endif
#define IIS_TASK_PRIORITY               IIS_TASK_PRIORITY_UNIT0
#define T_LWIPENTRY_PRIOR               TCPIP_THREAD_PRIO_t
#define NIC_TASK_PRIORITY               T_ETHERNETIF_INPUT_PRIO
...
#define	T_LWIP_THREAD_STKSIZE           1024
#define	T_LWIP_THREAD_MAX_NB	        4
#elif ( (SW_APPLICATION_OPTION == FPGA_VERIFY_TEST_CIU) || (SW_APPLICATION_OPTION == FPGA_VERIFY_TEST_USB_HOST) || (SW_APPLICATION_OPTION == FPGA_VERIFY_TEST_DIU) || (SW_APPLICATION_OPTION == FPGA_VERIFY_TEST_IDU) || (SW_APPLICATION_OPTION == FPGA_VERIFY_TEST_SIU) || (SW_APPLICATION_OPTION == FPGA_VERIFY_TEST_RFU)  || (SW_APPLICATION_OPTION == FPGA_VERIFY_TEST_H264)|| (SW_APPLICATION_OPTION == FPGA_VERIFY_TEST_PIP) || (SW_APPLICATION_OPTION == FPGA_VERIFY_TEST_GFU) || (SW_APPLICATION_OPTION == FPGA_VERIFY_TEST_H1_H264) )
enum
{
    RFIU_TASK_PRIORITY_HIGH = 10,
    MAIN_TASK_PRIORITY_START,
    ...
    IIS_CH0_TASK_PRIORITY,
#elif IIS_4CH_REC_TEST
    IIS_CH3_TASK_PRIORITY,
    IIS_CH2_TASK_PRIORITY,
    IIS_CH1_TASK_PRIORITY,
    IIS_CH0_TASK_PRIORITY,
#endif
    TIMER_TICK_TASK_PRIORITY,
...
#define USB_MSC_TASK_PRIORITY           DEBUG_TASK_PRIO 
#define USB_VC_TASK_PRIORITY            USB_DEVICE_TASK_PRIORITY
#define USB_PERF_TASK_PRIORITY          USB_PERF_TASK_PRIORITY
#define USB_HOST_TASK_PRIORITY          USB_TASK_PRIORITY
#define RTC_TASK_PRIORITY               DEBUG_TASK_PRIO 
#define NIC_TASK_PRIORITY               DEBUG_TASK_PRIO 
#define T_LWIPENTRY_PRIOR               DEBUG_TASK_PRIO 
...
/*RF*/
#define RFIU_WRAP_TASK_PRIORITY_UNIT0   DEBUG_TASK_PRIO 
#define RFIU_WRAP_TASK_PRIORITY_UNIT1   DEBUG_TASK_PRIO 
#define RFIU_WRAP_TASK_PRIORITY_UNIT2   DEBUG_TASK_PRIO 
#define RFIU_WRAP_TASK_PRIORITY_UNIT3   DEBUG_TASK_PRIO 
