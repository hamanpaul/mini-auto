...
#define I2C_DH9801_WR_SLAV_ADDR       0x00000080
#define I2C_DH9801_RD_SLAV_ADDR       0x00000081

#define I2C_NVP6020_WR_SLAV_ADDR      0x00000060
#define I2C_NVP6020_RD_SLAV_ADDR      0x00000061
...
#elif (TV_DECODER == AHD6124B)
#define I2C_TVDECODER_WR_SLAV_ADDR    0x00000062
#define I2C_TVDECODER_RD_SLAV_ADDR    0x00000063
#endif
...
extern s32 i2cWrite_SENSOR(u16, u16);
extern s32 i2cRead_SENSOR(u16, u16*);
...
extern s32 i2cDeviceInit2(void);

extern s32 i2cUninit(void);
extern void i2cIntHandler(void);

#if GPIO_I2C_ENA
extern int i2cRead_PCF8574_1byte(u8 Addr, u8 *pData);
extern int i2cWrite_PCF8574_1byte(u8 Addr, u8 pData);
extern int i2c_PCF8574_SwitchSDPWR(u8 Pwr);
extern int i2c_PCF8574_SwitchSPKEn(u8 Pwr);
extern int i2c_PCF8574_SwitchTx1LED(u8 Pwr);
extern int i2c_PCF8574_SwitchTx2LED(u8 Pwr);
extern int i2c_PCF8574_SwitchTx3LED(u8 Pwr);
extern int i2c_PCF8574_SwitchTx4LED(u8 Pwr);
extern int i2c_PCF8574_SwitchUSBPWR(u8 Pwr);
extern int i2c_PCF8574_SwitchNetPhyLED(u8 Pwr);
extern void i2c_PCF8575_SetBlocker(u8 Blk);
extern u32 i2c_PCF8575_GetBlocker(void);
extern int i2cRead_PCF8575_2byte(u8 Addr, u8 *pData);
extern int i2cWrite_PCF8575_2byte(u8 Addr, u16 pData);
extern int i2c_PCF8575_SwitchSpkEn(u8 Pwr);
extern int i2c_PCF8575_SwitchSDPWR(u8 Pwr);
extern int i2c_PCF8575_SwitchTX1RedLED(u8 Pwr);
extern int i2c_PCF8575_SwitchTX1GreenLED(u8 Pwr);
extern int i2c_PCF8575_SwitchTX2RedLED(u8 Pwr);
extern int i2c_PCF8575_SwitchTX2GreenLED(u8 Pwr);
extern int i2c_PCF8575_SwitchTX3RedLED(u8 Pwr);
extern int i2c_PCF8575_SwitchTX3GreenLED(u8 Pwr);
extern int i2c_PCF8575_SwitchTX4RedLED(u8 Pwr);
extern int i2c_PCF8575_SwitchTX4GreenLED(u8 Pwr);
extern int i2c_PCF8575_SwitchUSBPWR(u8 Pwr);
extern int i2c_PCF8575_SwitchNetPhyLED(u8 Pwr);
extern int i2c_PCF8575_SwitchAllLED(u8 Pwr);
#endif

#if I2C_SEM_PROTECT
u8 i2cWaitProcess(void);
u8 i2cFinProcess(void);
#endif
...
#if (USE_BUILD_IN_RTC == RTC_USE_EXT_RTC && EXT_RTC_SEL == RTC_PCF8563)
extern BOOLEAN Get_PCF8563_RTC(RTC_DATE_TIME* rtc_time);
extern BOOLEAN Set_PCF8563_RTC(RTC_DATE_TIME* date);
extern void PCF8563_RTC_Init(void);
#endif
#if (USE_BUILD_IN_RTC == RTC_USE_EXT_RTC && EXT_RTC_SEL == RTC_PT7C43390)
extern BOOLEAN Get_PT7C43390_RTC(RTC_DATE_TIME* rtc_time);
extern BOOLEAN Set_PT7C43390_RTC(RTC_DATE_TIME* date);
extern void PT7C43390_RTC_Init(void);
#endif
#if((USE_BUILD_IN_RTC == RTC_USE_EXT_RTC) && (EXT_RTC_SEL == RTC_SD2068))
...
extern s32 i2cWrite_NVP6020(u16 addr, u8 data);
extern s32 i2cRead_NVP6020(u8 addr, u8* pData);
#endif
...
extern s32 i2cWrite_WM8940(u8 addr, u16 data);
extern void Init_IIS_WM8940_play(void);
extern void Init_IIS_WM8940_rec(void);
extern void Init_IIS_WM8940_MicRec_AuxPlay(void);
extern void WM8940_AdjustMicVolume(u16 Volume);
extern void WM8940_AdjustSpeakerVolume(u8 Volume);
extern void WM8940_SpeakerMute(void);
extern void WM8940_MicVol_FadeIn(void);
extern void WM8940_MicVol_FadeOut(void);
extern void WM8940_SpeakVol_FadeIn(void);
extern void WM8940_SpeakVol_FadeOut(void);
extern void IIS_WM8940_reset(void);
extern void WM8940_PLL_LineIn(void);
#endif
...
extern void I2C_init_nvp6124B(void);
extern void nvp6124b_set_equalizer(unsigned char ch);
#endif
