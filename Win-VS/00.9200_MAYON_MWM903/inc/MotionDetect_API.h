...
extern void mduMotionDetect_init(void);

extern void mdu_TestSensitivity(char *cmd);

extern  u8 MD_SensitivityConfTab[MD_SENSITIVITY_LEVEL][2];
extern  u8 MD_SensitivityConfTab_Night[MD_SENSITIVITY_LEVEL][2];
extern  int PIR_SensitivityConfTab_indoor[MD_SENSITIVITY_LEVEL];
extern  int PIR_SensitivityConfTab_outdoor[MD_SENSITIVITY_LEVEL];
