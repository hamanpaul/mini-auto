 ...
 * \param szViewAccount [in] The predefined view account
 * \param szViewPassword [in] The predefined view password
 ...
 *
 */
AVAPI_API int  avServStart(int nIOTCSessionID, char *szViewAccount, char *szViewPassword, unsigned long nTimeout, unsigned long nServType, unsigned char nIOTCChannelID);
 ...
 * \param abFrameData [in] The frame data to be sent
 * \param nFrameDataSize [in] The size of the frame data
 * \param abFrameInfo [in] The video frame information to be sent
 ...
 *
 */
AVAPI_API int  avSendFrameData(int nAVChannelID, char *abFrameData, int nFrameDataSize, 
								void *abFrameInfo, int nFrameInfoSize);
 ...
 *
 * \param nAVChannelID [in] The channel ID of the AV channel to be sent
 * \param abAudioData [in] The audio data to be sent
 * \param nAudioDataSize [in] The size of the audio data
 * \param abFrameInfo [in] The audio frame information to be sent
 ...
 *
 */
AVAPI_API int  avSendAudioData(int nAVChannelID, char *abAudioData, int nAudioDataSize, 
								void *abFrameInfo, int nFrameInfoSize);
 ...
 * \param szViewAccount [in] The view account for authentication
 * \param szViewPassword [in] The view password for authentication
 * \param nTimeout [in] The timeout for this function in unit of second
 ...
 *
 */
AVAPI_API int  avClientStart(int nIOTCSessionID, char *szViewAccount, char *szViewPassword, 
 ...
 * \param abIOCtrlData [in] The buffer of IO control data
 ...
 */
AVAPI_API int avSendIOCtrl(int nAVChannelID, unsigned int nIOCtrlType, char *abIOCtrlData, int nIOCtrlDataSize);
