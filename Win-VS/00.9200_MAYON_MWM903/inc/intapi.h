...
/*----------------- IntFiqID ------------------*/
   ...
   #define INT_FIQID_DES      6 // 0x00000040
   ...
   #define INT_FIQID_SUBTV2   12
   #define INT_FIQID_SUBTV3   13
...
/*---------------- IntFiqMask ------------------*/
   ...
   #define INT_FIQMASK_DES    0x00000040
   ...
   #define INT_FIQMASK_SUBTV2 0x00001000
   #define INT_FIQMASK_SUBTV3 0x00002000
   ...
   #define INT_IRQID_FTMAC    2 // 0x00000004
   #define INT_IRQID_MD       3 // 0x00000008
   #define INT_IRQID_SD2      4 // 0x00000010
   ...
   #define INT_IRQID_CPU2    20 // 0x00100000
   #define INT_IRQID_MCP2    21 // 0x00200000
   #define INT_IRQID_IISALT  22 // 0x00400000
   #define INT_IRQID_USB2    23  // 0x00800000
   #define INT_IRQID_MAX     24
...
/*-------------- IntIrqMask --------------*/
   ...
   #define INT_IRQMASK_SD2    0x00000010
   ...
   #define INT_IRQMASK_CPU2   0x00100000
   #define INT_IRQMASK_MCP2   0x00200000
   #define INT_IRQMASK_IISALT 0x00400000
   #define INT_IRQMASK_USB2    0x00800000
#endif
