...
enum
{
    RTC_DST_OFFSET_OFF = 0,
    RTC_DST_OFFSET_1HR,
    RTC_DST_OFFSET_2HR,
    RTC_DST_OFFSET_END,
};

#if RTC_INCREASE_CHECK //Add by Paul for RTC increase check, 2017/07/07
typedef enum
{
    RTC_INCREASE_VERIFY = 0,
    RTC_INCREASE_USER_SET,
    RTC_INCREASE_RESTORE,
    RTC_INCREASE_FAIL_TEST,
}RTC_INCREASE_TYPE;
#endif
...
extern BOOLEAN rtcIsCorrectIncrease(RTC_DATE_TIME *cur_time, RTC_INCREASE_TYPE type);
#endif
...
extern s32 rtcGetCount(RTC_COUNT*);
...
extern void rtcSetDefaultTime(void);
