...
extern u8 usbUninst(void);

extern int ehci_hcd_init(void);

extern int usb_stop_remove(void);
extern int usb_keep_on(void);
extern int usb_dev_in(void);
/* Extern Global Variable */
extern u8 gucUsbPlugInStat;	/* a flag to indicate the usb plug-in status. */
extern u8 gUSBDevOn;
extern int usb_hdd_removed;
