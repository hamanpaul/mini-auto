...
#define DMA_ID_UNMARK 0xFF
#define DMA_ID_MARKED 0xF1
...
enum
{
   ...
   DMA_REQ_SD2_READ,       
   DMA_REQ_SD2_WRITE,   //15
   DMA_REQ_SD2_READ_FAST,
   DMA_REQ_SD2_WRITE_FAST,
#else
   DMA_REQ_SD2_READ,        
   DMA_REQ_SD2_WRITE,       
   DMA_REQ_SD_READ,       
...
typedef struct _DMA_MemsetCacheBuffer
{
	u32 DMAID;
	u32 *CB;	// Cache Buffer
} DMA_MemsetCacheBuffer;


//=================================================================
extern DMA_MemsetCacheBuffer gDMAMemsetValTbl[DMA_ID_NUM];
...
extern void isr_marsDMAAuto(int DmaID);
