...
#define SERV_TUTK_TALK_SUPPORT              (1 << 0) //Audio In, Device to Client
#define SERV_TUTK_TALKBACK_SUPPORT          (1 << 1)//Audio Out, Client to Device
#define SERV_TUTK_PTZ_SUPPORT               (1 << 2)//Pan / Tilt
#define SERV_TUTK_EVENTLIST_SUPPORT         (1 << 3)//Event list function
#define SERV_TUTK_PLAYBACK_SUPPORT          (1 << 4)//Playback function (required Event list function)
#define SERV_TUTK_WIFI_SET_SUPPORT          (1 << 5)//Wi-Fi setting function
#define SERV_TUTK_EVENT_SET_SUPPORT         (1 << 6)//Event setting function
#define SERV_TUTK_RECORD_SET_SUPPORT        (1 << 7)//Record setting function
#define SERV_TUTK_SD_FORMAT_SUPPORT         (1 << 8)//Format SDCard function
#define SERV_TUTK_VIDEO_FLIP_SUPPORT        (1 << 9)//Video flip function (Flip, Mirror, or both)
#define SERV_TUTK_ENVIRONMENT_MODE          (1 << 10)//Environment mode (Indoor, Outdoor, Night mode)
#define SERV_TUTK_MULTI_STREAM_SUPPORT      (1 << 11)//Multi-streaming support
#define SERV_TUTK_TALKBACK_ENCODE_FORMAT    (1 << 12)//Audio out encoding format:speex encoding-0,ADPCM format-1
//Recerve for TUTK from bit 13~15
#define SERV_RDI_SUPPORT                    (1 << 16)//UI_RDI_VERSSION SUPPORT
#define SERV_TRANWO_SUPPORT                 (1 << 17)//UI_RDI_VERSSION SUPPORT
#define SERV_MAYON_SUPPORT                  (1 << 18)//UI_MAYON_VERSSION SUPPORT
//Recerve for other customer from bit 19~23
#define SERV_MARS_WALMART_SUPPORT           (1 << 24)//WALMART CMD support for no panel project
#define SERV_MARS_JHOME_AUTOMATION_SUPPORT  (1 << 25)//Home automation support via JSON format
#define SERV_MARS_THOME_AUTOMATION_SUPPORT  (1 << 26)//Home automation support via IOTC CMD
