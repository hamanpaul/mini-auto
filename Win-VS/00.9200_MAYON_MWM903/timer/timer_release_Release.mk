...
CARM_OBJS	= 		  Release\timer.o Release\timer_project.o 
...
MAKENAME	= timer_release_Release.mk
PRINT		= pr
PROGRAM		= none
...
Release\timer.o: .\src\timer.c ..\inc\\board.h ..\inc\\sysapi.h \
	 $(___INC__TIMERAPI_H) inc\\timer.h ..\inc\\task.h
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c .\src\timer.c \
	 $(CARM) -o Release\timer.o
Release\timer_project.o: .\src\timer_project.c ..\inc\\board.h \
	...
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c \
	 .\src\timer_project.c $(CARM) -o Release\timer_project.o
