...
CARM_SRCS	= 		  .\src\timer.c .\src\timer_project.c 
CARM_COMP	= c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c $$SRC $(CARM) -o $$OBJ
CARM_OBJS	= 		  DebugRel\timer.o DebugRel\timer_project.o 
...
MAKENAME	= timer_release_DebugRel.mk
PRINT		= pr
PROGRAM		= none
BUILD_LIB	= Release\..\..\lib\release\timer_release.lib
POST_BUILD	=
...
DebugRel\timer.o: .\src\timer.c ..\inc\\board.h ..\inc\\sysapi.h \
	 $(___INC__TIMERAPI_H) inc\\timer.h ..\inc\\task.h
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c .\src\timer.c \
	 $(CARM) -o DebugRel\timer.o
DebugRel\timer_project.o: .\src\timer_project.c ..\inc\\board.h \
	 ..\inc\\sysapi.h $(___INC__TIMERAPI_H) inc\\timer.h \
	 ..\inc\\rtcapi.h ..\inc\\gpioapi.h
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c \
	 .\src\timer_project.c $(CARM) -o DebugRel\timer_project.o
