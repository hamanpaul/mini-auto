...
#elif( (SYS_CPU_CLK_FREQ == 160000000) || (SYS_CPU_CLK_FREQ == 162000000) )	/* for PA9003 */
        spiClkDiv = 1;
...
//	unAddrForTest = 0x12000;
    ...
    while (ucVerifyIdx == 1)
    {
        ...
        case	9:
            ...
            else if (SYS_CPU_CLK_FREQ == 160000000)
            {
                DEBUG_SPI("System Freq = 160 MHz.\n");
                DEBUG_SPI("SPI Clock Freq = %d MHz.\n", (160/2/(spiClkDiv +1)));
            }
            else if (SYS_CPU_CLK_FREQ == 162000000)
            {
                DEBUG_SPI("System Freq = 162 MHz.\n");
                DEBUG_SPI("SPI Clock Freq = %d MHz.\n", (162/2/(spiClkDiv +1)));
            }
