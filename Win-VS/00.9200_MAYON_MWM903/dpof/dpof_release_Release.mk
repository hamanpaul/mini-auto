...
MAKENAME	= dpof_release_Release.mk
PRINT		= pr
PROGRAM		= none
BUILD_LIB	= Release\..\..\lib\release\dpof_release.lib
POST_BUILD	=
...
Release\dpof.o: .\src\dpof.c $(___INC__GENERAL_H) ..\inc\\board.h
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c .\src\dpof.c \
	 $(CARM) -o Release\dpof.o
