...
Abstract:
    ...
    Error Code Definitions for SD Host driver.
...
Revision History:
    ...
    2007/05/05  Ven-Chin Chen   Create

*/

#ifndef __SDC_ERR_H__
#define __SDC_ERR_H__
...
#define SD_ERROR_CARD_ECC_ERROR                       (SD_ERROR_CODE_BASE | 0x21)   /* SD Card ECC error */
#define SD_ERROR_CARD_DMA_REQERR                      (SD_ERROR_CODE_BASE | 0x22)   
#endif
