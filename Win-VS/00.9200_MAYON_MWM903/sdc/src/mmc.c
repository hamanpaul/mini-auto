...
s32 mmcGetCsd(void)
{
    ...
    {
        dcfStorageSize[STORAGE_MEMORY_SD_MMC] = FS_MEDIA_MMC_1GB;
    }
    else if (capacity > (512000000 - 128000000))	/* 128MB tolerance for 512MB */
    {
        dcfStorageSize[STORAGE_MEMORY_SD_MMC] = FS_MEDIA_MMC_512MB;
    }
    else if (capacity > (256000000 - 64000000))	/* 64MB tolerance for 256MB */
    {
        dcfStorageSize[STORAGE_MEMORY_SD_MMC] = FS_MEDIA_MMC_256MB;
    }
    else if (capacity > (128000000 - 32000000))	/* 32MB tolerance for 128MB */
    {
        dcfStorageSize[STORAGE_MEMORY_SD_MMC] = FS_MEDIA_MMC_128MB;
    }
    else if (capacity > (64000000 - 16000000))	/* 16MB tolerance for 64MB */
    {
        dcfStorageSize[STORAGE_MEMORY_SD_MMC] = FS_MEDIA_MMC_64MB;
    }
    else if (capacity > (32000000 - 8000000))	/* 8MB tolerance for 32MB */
    {
        dcfStorageSize[STORAGE_MEMORY_SD_MMC] = FS_MEDIA_MMC_32MB;
    }
    else if (capacity > (16000000 - 4000000))	/* 4MB tolerance for 16MB */
    {
        dcfStorageSize[STORAGE_MEMORY_SD_MMC] = FS_MEDIA_MMC_16MB;
    }
    else
    {
