...
MAKENAME	= uart_release_Release.mk
PRINT		= pr
PROGRAM		= none
BUILD_LIB	= Release\..\..\lib\release\uart_release.lib
POST_BUILD	=
...
Release\uart.o: .\src\uart.c $(___INC__GENERAL_H) ..\inc\\board.h \
	 inc\\uartreg.h $(___INC__UIAPI_H) $(___UI_INC_OSD_DRAW_API_H)
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c .\src\uart.c \
	 $(CARM) -o Release\uart.o
