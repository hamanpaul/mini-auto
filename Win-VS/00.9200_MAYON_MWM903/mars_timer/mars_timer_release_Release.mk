...
MAKENAME	= mars_timer_release_Release.mk
PRINT		= pr
PROGRAM		= none
BUILD_LIB	= Release\..\..\lib\release\mars_timer_release.lib
POST_BUILD	=
...
Release\mars_timer.o: .\src\mars_timer.c
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c .\src\mars_timer.c \
	 $(CARM) -o Release\mars_timer.o
