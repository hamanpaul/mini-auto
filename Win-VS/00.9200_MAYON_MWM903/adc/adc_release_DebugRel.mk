...
CARM_SRCS	= 		  .\src\adc.c .\src\adc_project.c 
CARM_COMP	= c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c $$SRC $(CARM) -o $$OBJ
CARM_OBJS	= 		  DebugRel\adc.o DebugRel\adc_project.o 
...
MAKENAME	= adc_release_DebugRel.mk
PRINT		= pr
PROGRAM		= none
BUILD_LIB	= Release\..\..\lib\release\adc_release.lib
POST_BUILD	=
...
DebugRel\adc.o: .\src\adc.c ..\inc\\board.h inc\\adcreg.h ..\inc\\sysapi.h \
	 $(___INC__SMCAPI_H) $(___INC__UIAPI_H) $(___INC__SIUAPI_H) \
	 ..\inc\\gpioapi.h $(___INC__ASFAPI_H)
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c .\src\adc.c \
	 $(CARM) -o DebugRel\adc.o
DebugRel\adc_project.o: .\src\adc_project.c $(___INC__GENERAL_H) \
	 ..\inc\\board.h inc\\adcreg.h ..\inc\\sysapi.h
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c \
	 .\src\adc_project.c $(CARM) -o DebugRel\adc_project.o
