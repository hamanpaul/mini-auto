...
CARM_SRCS	= 		  .\src\ir_ppm.c .\src\gpio.c .\src\gpio_project.c 
CARM_COMP	= c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c $$SRC $(CARM) -o $$OBJ
CARM_OBJS	= 		  DebugRel\ir_ppm.o DebugRel\gpio.o \
		  DebugRel\gpio_project.o 
...
MAKENAME	= gpio_release_DebugRel.mk
PRINT		= pr
PROGRAM		= none
BUILD_LIB	= Release\..\..\lib\release\gpio_release.lib
POST_BUILD	=
...
DebugRel\ir_ppm.o: .\src\ir_ppm.c $(___INC__GENERAL_H) ..\inc\\board.h \
	 ..\inc\\task.h ..\gpio\inc\gpioreg.h ..\gpio\inc\gpio.h \
	 ..\timer\inc\timer.h ..\timer\inc\timerreg.h \
	 $(___UI_INC_OSD_DRAW_API_H) inc\\ir_ppm.h
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c .\src\ir_ppm.c \
	 $(CARM) -o DebugRel\ir_ppm.o
DebugRel\gpio.o: .\src\gpio.c $(___INC__GENERAL_H) ..\inc\\board.h \
	 $(___UI_INC_OSD_DRAW_API_H) inc\\ir_ppm.h inc\\gpio.h \
	 inc\\gpioreg.h ..\inc\\sysapi.h ..\inc\\gpioapi.h ..\inc\\usbapi.h \
	  $(___INC__SIUAPI_H) ..\inc\\asfapi.h ..\inc\\fsapi.h \
	 ..\fs\inc\fs_fat.h
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c .\src\gpio.c \
	 $(CARM) -o DebugRel\gpio.o
DebugRel\gpio_project.o: .\src\gpio_project.c $(___INC__GENERAL_H)
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c \
	 .\src\gpio_project.c $(CARM) -o DebugRel\gpio_project.o
