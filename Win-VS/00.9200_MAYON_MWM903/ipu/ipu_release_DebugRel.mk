...
CARM_SRCS	= 		  .\src\CalAWBGain.c .\src\ipu.c 
CARM_COMP	= c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c $$SRC $(CARM) -o $$OBJ
CARM_OBJS	= 		  DebugRel\CalAWBGain.o DebugRel\ipu.o 
...
MAKENAME	= ipu_release_DebugRel.mk
PRINT		= pr
PROGRAM		= none
BUILD_LIB	= Release\..\..\lib\release\ipu_release.lib
POST_BUILD	=
...
DebugRel\CalAWBGain.o: .\src\CalAWBGain.c $(___INC__GENERAL_H)
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c .\src\CalAWBGain.c \
	 $(CARM) -o DebugRel\CalAWBGain.o
DebugRel\ipu.o: .\src\ipu.c $(___INC__GENERAL_H) ..\inc\\board.h inc\\ipu.h \
	 inc\\ipureg.h $(___INC__SIUAPI_H)
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c .\src\ipu.c \
	 $(CARM) -o DebugRel\ipu.o
