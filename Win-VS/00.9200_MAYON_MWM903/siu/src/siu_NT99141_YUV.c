...
{
    if(uiMenuVideoSizeSetting == UI_MENU_VIDEO_SIZE_1280X720)   // 720P
    {
...
s32 siuSetFlicker50_60Hz(int flicker_sel)
{
    if( (uiMenuVideoSizeSetting == UI_MENU_VIDEO_SIZE_1280X720) || (uiMenuVideoSizeSetting == UI_MENU_VIDEO_SIZE_640x352) || (uiMenuVideoSizeSetting == UI_MENU_VIDEO_SIZE_704x480) )   // 720P
    {
        if(flicker_sel == SENSOR_AE_FLICKER_60HZ)  //60Hz
        {
            //PCLK=40MHz
