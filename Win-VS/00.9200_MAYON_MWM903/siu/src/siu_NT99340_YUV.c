...
#define NT99340_FRAME_RATE  15
#else   // (VIDEO_RESOLUTION_SEL == VIDEO_VGA_IN_VGA_OUT)
#define NT99340_FRAME_RATE  30
#endif
...
#if 0   // 20140808
void SetNT99340_Init(void)
{
    int i;
    
    DEBUG_SIU("SetNT99340_Init()\n");
    ...
    //[Initial Setting]
    i2cWrite_NT99340(0x32F0, 0x01);
    i2cWrite_NT99340(0x32FF, 0x00);
    i2cWrite_NT99340(0x303E, 0x0C);
    i2cWrite_NT99340(0x303F, 0x02);
    i2cWrite_NT99340(0x3040, 0xFF);
    i2cWrite_NT99340(0x3041, 0x00);
    i2cWrite_NT99340(0x3042, 0x00);
    i2cWrite_NT99340(0x3051, 0xE0);
    i2cWrite_NT99340(0x3052, 0x10);
    i2cWrite_NT99340(0x3088, 0x20);
    i2cWrite_NT99340(0x3118, 0xA7);
    i2cWrite_NT99340(0x3119, 0xA7);
    i2cWrite_NT99340(0x311A, 0xA7);
    i2cWrite_NT99340(0x3100, 0x03);
    i2cWrite_NT99340(0x3101, 0x80);
    i2cWrite_NT99340(0x3102, 0x09);
    i2cWrite_NT99340(0x3103, 0x09);
    i2cWrite_NT99340(0x3104, 0x01);
    i2cWrite_NT99340(0x3105, 0x01);
    i2cWrite_NT99340(0x3106, 0x03);
    i2cWrite_NT99340(0x3107, 0x20);
    i2cWrite_NT99340(0x3108, 0x00);
    i2cWrite_NT99340(0x3109, 0x02);
    i2cWrite_NT99340(0x310A, 0x04);
    i2cWrite_NT99340(0x3127, 0x01);
    i2cWrite_NT99340(0x3030, 0x0A);
    i2cWrite_NT99340(0x306C, 0x0C);
    i2cWrite_NT99340(0x306D, 0x0C);
    i2cWrite_NT99340(0x3581, 0xF0);
    i2cWrite_NT99340(0x3583, 0x18);
    i2cWrite_NT99340(0x3587, 0x02);
    i2cWrite_NT99340(0x3584, 0x00);
    i2cWrite_NT99340(0x3585, 0x00);
    i2cWrite_NT99340(0x3580, 0xB2);
    i2cWrite_NT99340(0x3600, 0x55);
    i2cWrite_NT99340(0x3601, 0xAA);
    i2cWrite_NT99340(0x3604, 0x15);
    i2cWrite_NT99340(0x3605, 0x13);
    i2cWrite_NT99340(0x3613, 0x40);
    i2cWrite_NT99340(0x3614, 0x10);
    i2cWrite_NT99340(0x361A, 0x0C);
    i2cWrite_NT99340(0x3615, 0x24);
    i2cWrite_NT99340(0x3610, 0x02);
    i2cWrite_NT99340(0x3290, 0x01);
    i2cWrite_NT99340(0x3291, 0x80);
    i2cWrite_NT99340(0x3296, 0x01);
    i2cWrite_NT99340(0x3297, 0x60);
    i2cWrite_NT99340(0x3250, 0x80);
    i2cWrite_NT99340(0x3251, 0x01);
    i2cWrite_NT99340(0x3252, 0x27);
    i2cWrite_NT99340(0x3253, 0x9D);
    i2cWrite_NT99340(0x3254, 0x00);
    i2cWrite_NT99340(0x3255, 0xE3);
    i2cWrite_NT99340(0x3256, 0x81);
    i2cWrite_NT99340(0x3257, 0x70);
    i2cWrite_NT99340(0x329B, 0x00);
    i2cWrite_NT99340(0x32A1, 0x00);
    i2cWrite_NT99340(0x32A2, 0xEC);
    i2cWrite_NT99340(0x32A3, 0x01);
    i2cWrite_NT99340(0x32A4, 0x7A);
    i2cWrite_NT99340(0x32A5, 0x01);
    i2cWrite_NT99340(0x32A6, 0x14);
    i2cWrite_NT99340(0x32A7, 0x01);
    i2cWrite_NT99340(0x32A8, 0xB3);
    i2cWrite_NT99340(0x3270, 0x00);
    i2cWrite_NT99340(0x3271, 0x0B);
    i2cWrite_NT99340(0x3272, 0x16);
    i2cWrite_NT99340(0x3273, 0x2B);
    i2cWrite_NT99340(0x3274, 0x3F);
    i2cWrite_NT99340(0x3275, 0x51);
    i2cWrite_NT99340(0x3276, 0x72);
    i2cWrite_NT99340(0x3277, 0x8F);
    i2cWrite_NT99340(0x3278, 0xA7);
    i2cWrite_NT99340(0x3279, 0xBC);
    i2cWrite_NT99340(0x327A, 0xDC);
    i2cWrite_NT99340(0x327B, 0xF0);
    i2cWrite_NT99340(0x327C, 0xFA);
    i2cWrite_NT99340(0x327D, 0xFE);
    i2cWrite_NT99340(0x327E, 0xFF);
    i2cWrite_NT99340(0x3302, 0x00);
    i2cWrite_NT99340(0x3303, 0x4D);
    i2cWrite_NT99340(0x3304, 0x00);
    i2cWrite_NT99340(0x3305, 0x96);
    i2cWrite_NT99340(0x3306, 0x00);
    i2cWrite_NT99340(0x3307, 0x1D);
    i2cWrite_NT99340(0x3308, 0x07);
    i2cWrite_NT99340(0x3309, 0xC7);
    i2cWrite_NT99340(0x330A, 0x07);
    i2cWrite_NT99340(0x330B, 0x0A);
    i2cWrite_NT99340(0x330C, 0x01);
    i2cWrite_NT99340(0x330D, 0x30);
    i2cWrite_NT99340(0x330E, 0x01);
    i2cWrite_NT99340(0x330F, 0x07);
    i2cWrite_NT99340(0x3310, 0x06);
    i2cWrite_NT99340(0x3311, 0xFF);
    i2cWrite_NT99340(0x3312, 0x07);
    i2cWrite_NT99340(0x3313, 0xFA);
    i2cWrite_NT99340(0x3210, 0x1C);
    i2cWrite_NT99340(0x3211, 0x1A);
    i2cWrite_NT99340(0x3212, 0x1A);
    i2cWrite_NT99340(0x3213, 0x1C);
    i2cWrite_NT99340(0x3214, 0x1B);
    i2cWrite_NT99340(0x3215, 0x17);
    i2cWrite_NT99340(0x3216, 0x1A);
    i2cWrite_NT99340(0x3217, 0x1B);
    i2cWrite_NT99340(0x3218, 0x1B);
    i2cWrite_NT99340(0x3219, 0x21);
    i2cWrite_NT99340(0x321A, 0x1A);
    i2cWrite_NT99340(0x321B, 0x1B);
    i2cWrite_NT99340(0x321C, 0x1C);
    i2cWrite_NT99340(0x321D, 0x1C);
    i2cWrite_NT99340(0x321E, 0x1B);
    i2cWrite_NT99340(0x321F, 0x1B);
    i2cWrite_NT99340(0x3230, 0x00);
    i2cWrite_NT99340(0x3231, 0x00);
    i2cWrite_NT99340(0x3232, 0x00);
    i2cWrite_NT99340(0x3233, 0x03);
    i2cWrite_NT99340(0x3234, 0x0F);
    i2cWrite_NT99340(0x3235, 0x0F);
    i2cWrite_NT99340(0x3236, 0x0F);
    i2cWrite_NT99340(0x3237, 0x0F);
    i2cWrite_NT99340(0x3238, 0x40);
    i2cWrite_NT99340(0x3239, 0x40);
    i2cWrite_NT99340(0x323A, 0x40);
    i2cWrite_NT99340(0x3241, 0x40);
    i2cWrite_NT99340(0x3243, 0x42);
    i2cWrite_NT99340(0x32F6, 0x0F);
    i2cWrite_NT99340(0x32F9, 0x42);
    i2cWrite_NT99340(0x32FA, 0x24);
    i2cWrite_NT99340(0x3338, 0x18);
    i2cWrite_NT99340(0x3339, 0xC6);
    i2cWrite_NT99340(0x333A, 0x6C);
    i2cWrite_NT99340(0x3335, 0x60);
    i2cWrite_NT99340(0x3336, 0x20);
    i2cWrite_NT99340(0x3337, 0x40);
    i2cWrite_NT99340(0x333B, 0xC6);
    i2cWrite_NT99340(0x333C, 0x6C);
    i2cWrite_NT99340(0x3325, 0xAF);
    i2cWrite_NT99340(0x3326, 0x02);
    i2cWrite_NT99340(0x3327, 0x00);
    i2cWrite_NT99340(0x3331, 0x08);
    i2cWrite_NT99340(0x3332, 0xFF);
    i2cWrite_NT99340(0x333F, 0x07);
    i2cWrite_NT99340(0x334A, 0x34);
    i2cWrite_NT99340(0x334B, 0x14);
    i2cWrite_NT99340(0x334C, 0x10);
    i2cWrite_NT99340(0x3363, 0x33);
    i2cWrite_NT99340(0x3360, 0x08);
    i2cWrite_NT99340(0x3361, 0x10);
    i2cWrite_NT99340(0x3362, 0x18);
    i2cWrite_NT99340(0x3364, 0x88);
    i2cWrite_NT99340(0x3365, 0x80);
    i2cWrite_NT99340(0x3366, 0x68);
    i2cWrite_NT99340(0x3367, 0x40);
    i2cWrite_NT99340(0x3368, 0x50);
    i2cWrite_NT99340(0x3369, 0x40);
    i2cWrite_NT99340(0x336A, 0x30);
    i2cWrite_NT99340(0x336B, 0x20);
    i2cWrite_NT99340(0x336C, 0x00);
    i2cWrite_NT99340(0x336D, 0x1A);
    i2cWrite_NT99340(0x336E, 0x16);
    i2cWrite_NT99340(0x336F, 0x14);
    i2cWrite_NT99340(0x3370, 0x0C);
    i2cWrite_NT99340(0x3371, 0x3F);
    i2cWrite_NT99340(0x3372, 0x3F);
    i2cWrite_NT99340(0x3373, 0x3F);
    i2cWrite_NT99340(0x3374, 0x3F);
    i2cWrite_NT99340(0x3375, 0x0E);
    i2cWrite_NT99340(0x3376, 0x10);
    i2cWrite_NT99340(0x3377, 0x14);
    i2cWrite_NT99340(0x3378, 0x30);
    i2cWrite_NT99340(0x3012, 0x02);
    i2cWrite_NT99340(0x3013, 0x58);
    i2cWrite_NT99340(0x301D, 0x01);
    i2cWrite_NT99340(0x3326, 0x02);
    i2cWrite_NT99340(0x3331, 0x10);
    i2cWrite_NT99340(0x3332, 0xFF);
    i2cWrite_NT99340(0x334A, 0x23);
    i2cWrite_NT99340(0x3368, 0x50);
    i2cWrite_NT99340(0x3369, 0x40);
    i2cWrite_NT99340(0x336A, 0x30);
    i2cWrite_NT99340(0x336B, 0x20);
    i2cWrite_NT99340(0x336C, 0x00);
    i2cWrite_NT99340(0x3375, 0x14);
    i2cWrite_NT99340(0x3376, 0x10);
    i2cWrite_NT99340(0x3377, 0x14);
    i2cWrite_NT99340(0x3378, 0x30);
...
void SetNT99340_Init(void)
{
    ...
    i2cWrite_NT99340(0x3250, 0x80);
    i2cWrite_NT99340(0x3251, 0x01);
    i2cWrite_NT99340(0x3252, 0x15);
    i2cWrite_NT99340(0x3253, 0x98);
    i2cWrite_NT99340(0x3254, 0x00);
    i2cWrite_NT99340(0x3255, 0xDF);
    i2cWrite_NT99340(0x3256, 0x88);
    i2cWrite_NT99340(0x3257, 0x70);
    i2cWrite_NT99340(0x329B, 0x00);
    i2cWrite_NT99340(0x32A1, 0x00);
    i2cWrite_NT99340(0x32A2, 0xEC);
    ...
    i2cWrite_NT99340(0x327D, 0xFE);
    i2cWrite_NT99340(0x327E, 0xFF);
    i2cWrite_NT99340(0x3302, 0x00);//CC
    i2cWrite_NT99340(0x3303, 0x4D);
    i2cWrite_NT99340(0x3304, 0x00);
    i2cWrite_NT99340(0x3305, 0x96);
    i2cWrite_NT99340(0x3306, 0x00);
    i2cWrite_NT99340(0x3307, 0x1D);
    i2cWrite_NT99340(0x3308, 0x07);
    i2cWrite_NT99340(0x3309, 0xCF);
    i2cWrite_NT99340(0x330A, 0x06);
    i2cWrite_NT99340(0x330B, 0xD5);
    i2cWrite_NT99340(0x330C, 0x01);
    i2cWrite_NT99340(0x330D, 0x5C);
    i2cWrite_NT99340(0x330E, 0x01);
    i2cWrite_NT99340(0x330F, 0x06);
    i2cWrite_NT99340(0x3310, 0x07);
    i2cWrite_NT99340(0x3311, 0x11);
    i2cWrite_NT99340(0x3312, 0x07);
    i2cWrite_NT99340(0x3313, 0xEA);
    i2cWrite_NT99340(0x3210, 0x1C);//LSC Start
    i2cWrite_NT99340(0x3211, 0x1A);
    i2cWrite_NT99340(0x3212, 0x18);
    i2cWrite_NT99340(0x3213, 0x1A);
    i2cWrite_NT99340(0x3214, 0x1B);
    i2cWrite_NT99340(0x3215, 0x17);
    i2cWrite_NT99340(0x3216, 0x1C);
    i2cWrite_NT99340(0x3217, 0x1E);
    i2cWrite_NT99340(0x3218, 0x1B);
    i2cWrite_NT99340(0x3219, 0x21);
    i2cWrite_NT99340(0x321A, 0x1C);
    i2cWrite_NT99340(0x321B, 0x1E);
    i2cWrite_NT99340(0x321C, 0x1C);
    i2cWrite_NT99340(0x321D, 0x1C);
    i2cWrite_NT99340(0x321E, 0x1B);
    i2cWrite_NT99340(0x321F, 0x1D);
    i2cWrite_NT99340(0x3220, 0x02);
    i2cWrite_NT99340(0x3221, 0x00);
    i2cWrite_NT99340(0x3222, 0x02);
    i2cWrite_NT99340(0x3223, 0x00);
    i2cWrite_NT99340(0x3224, 0x02);
    i2cWrite_NT99340(0x3225, 0x00);
    i2cWrite_NT99340(0x3226, 0x02);
    i2cWrite_NT99340(0x3227, 0x00);
    i2cWrite_NT99340(0x3228, 0x01);
    i2cWrite_NT99340(0x3229, 0x80);
    i2cWrite_NT99340(0x322A, 0x01);
    i2cWrite_NT99340(0x322B, 0x80);
    i2cWrite_NT99340(0x322C, 0x01);
    i2cWrite_NT99340(0x322D, 0x80);
    i2cWrite_NT99340(0x322E, 0x01);
    i2cWrite_NT99340(0x322F, 0x80);
    i2cWrite_NT99340(0x3230, 0x00);
    i2cWrite_NT99340(0x3231, 0x00);
    i2cWrite_NT99340(0x3232, 0x00);
    i2cWrite_NT99340(0x3233, 0x03);
    ...
    i2cWrite_NT99340(0x3241, 0x40);
    i2cWrite_NT99340(0x3243, 0x42);
    i2cWrite_NT99340(0x3244, 0x00);
    i2cWrite_NT99340(0x3245, 0x00);//LSC end
    i2cWrite_NT99340(0x32F6, 0x0F);
    i2cWrite_NT99340(0x32F9, 0x42);
    i2cWrite_NT99340(0x32FA, 0x24);
    i2cWrite_NT99340(0x3338, 0x18);
    ...
    i2cWrite_NT99340(0x3377, 0x14);
    i2cWrite_NT99340(0x3378, 0x30);
    i2cWrite_NT99340(0x32F3, 0xC0);
    i2cWrite_NT99340(0x32Fc, 0x10);
}
#elif 0 // 20150204
void SetNT99340_Init(void)
{
    ...
    i2cWrite_NT99340(0x3362, 0x18);
    i2cWrite_NT99340(0x3364, 0x88);
    i2cWrite_NT99340(0x3365, 0x88);
    i2cWrite_NT99340(0x3366, 0x70);
    i2cWrite_NT99340(0x3367, 0x60);
    i2cWrite_NT99340(0x3368, 0x50);
    i2cWrite_NT99340(0x3369, 0x40);
    i2cWrite_NT99340(0x336A, 0x30);
    i2cWrite_NT99340(0x336B, 0x20);
...
void SetNT99340_Init(void)
{
    ...
    i2cWrite_NT99340(0x3361, 0x10);
    i2cWrite_NT99340(0x3362, 0x18);
    i2cWrite_NT99340(0x3364, 0xC8);
    i2cWrite_NT99340(0x3365, 0xC0);
    i2cWrite_NT99340(0x3366, 0xA8);
    i2cWrite_NT99340(0x3367, 0x80);
    i2cWrite_NT99340(0x3368, 0x50);
    i2cWrite_NT99340(0x3369, 0x40);
    i2cWrite_NT99340(0x336A, 0x30);
    i2cWrite_NT99340(0x336B, 0x20);
...
void SetNT99340_Init(void)
{
    ...
    i2cWrite_NT99340(0x3377, 0x14);
    i2cWrite_NT99340(0x3378, 0x30);
    i2cWrite_NT99340(0x32F3, 0xA0);
    i2cWrite_NT99340(0x32Fc, 0x10);
	i2cWrite_NT99340(0x32B0, 0x55);
	i2cWrite_NT99340(0x32B1, 0x55);
	i2cWrite_NT99340(0x32B2, 0x55);
	i2cWrite_NT99340(0x32B3, 0x55);
	i2cWrite_NT99340(0x32F3, 0xA0);
}
#endif
...
//MCLK:24M
//PCLK:92M
void SetNT99340_1080P_15FPS(void)
{
    int i;
    
    DEBUG_SIU("SetNT99340_1080P_15FPS()\n");
    ...
    //[YUYV_1920x1080_15Fps]
    i2cWrite_NT99340(0x32BF, 0x60); 
    i2cWrite_NT99340(0x32C0, 0x6A); 
    i2cWrite_NT99340(0x32C1, 0x6A); 
    i2cWrite_NT99340(0x32C2, 0x6A); 
    i2cWrite_NT99340(0x32C3, 0x00); 
    i2cWrite_NT99340(0x32C4, 0x20); 
    i2cWrite_NT99340(0x32C5, 0x20); 
    i2cWrite_NT99340(0x32C6, 0x20); 
    i2cWrite_NT99340(0x32C7, 0x00); 
    i2cWrite_NT99340(0x32C8, 0xB4); 
    i2cWrite_NT99340(0x32C9, 0x6A); 
    i2cWrite_NT99340(0x32CA, 0x8A); 
    i2cWrite_NT99340(0x32CB, 0x8A); 
    i2cWrite_NT99340(0x32CC, 0x8A); 
    i2cWrite_NT99340(0x32CD, 0x8A); 
    i2cWrite_NT99340(0x32DB, 0x76); 
    i2cWrite_NT99340(0x32D0, 0x01); 
    i2cWrite_NT99340(0x32E0, 0x07); 
    i2cWrite_NT99340(0x32E1, 0x80); 
    i2cWrite_NT99340(0x32E2, 0x04); 
    i2cWrite_NT99340(0x32E3, 0x38); 
    i2cWrite_NT99340(0x32E4, 0x00); 
    i2cWrite_NT99340(0x32E5, 0x11); 
    i2cWrite_NT99340(0x32E6, 0x00); 
    i2cWrite_NT99340(0x32E7, 0x11); 
    i2cWrite_NT99340(0x3200, 0x3F); 
    i2cWrite_NT99340(0x3201, 0x0F); 
    i2cWrite_NT99340(0x302A, 0x00); 
    i2cWrite_NT99340(0x302B, 0x01); 
    i2cWrite_NT99340(0x302C, 0x2D); 
    i2cWrite_NT99340(0x302D, 0x02); 
    i2cWrite_NT99340(0x302E, 0x00); 
    i2cWrite_NT99340(0x302F, 0x02); 
#if(SENSOR_ROW_COL_MIRROR)
    i2cWrite_NT99340(0x3022, 0x27);     
#else
    i2cWrite_NT99340(0x3022, 0x24); 
#endif            
    i2cWrite_NT99340(0x3023, 0x24); 
    i2cWrite_NT99340(0x3128, 0x01); 
    i2cWrite_NT99340(0x3002, 0x00); 
    i2cWrite_NT99340(0x3003, 0x04); 
    i2cWrite_NT99340(0x3004, 0x00); 
    i2cWrite_NT99340(0x3005, 0xC4); 
    i2cWrite_NT99340(0x3006, 0x08); 
    i2cWrite_NT99340(0x3007, 0x03); 
    i2cWrite_NT99340(0x3008, 0x05); 
    i2cWrite_NT99340(0x3009, 0x43); 
    i2cWrite_NT99340(0x300A, 0x09); 
    i2cWrite_NT99340(0x300B, 0xFB); 
    i2cWrite_NT99340(0x300C, 0x04); 
    i2cWrite_NT99340(0x300D, 0xB0); 
    i2cWrite_NT99340(0x300E, 0x08); 
    i2cWrite_NT99340(0x300F, 0x00); 
    i2cWrite_NT99340(0x3010, 0x04); 
    i2cWrite_NT99340(0x3011, 0x80); 
    i2cWrite_NT99340(0x3052, 0x10); 
    i2cWrite_NT99340(0x32BB, 0x87); 
    i2cWrite_NT99340(0x32B8, 0x3B); 
    i2cWrite_NT99340(0x32B9, 0x2D); 
    i2cWrite_NT99340(0x32BC, 0x34); 
    i2cWrite_NT99340(0x32BD, 0x38); 
    i2cWrite_NT99340(0x32BE, 0x30); 
    i2cWrite_NT99340(0x3201, 0xFF); 
    i2cWrite_NT99340(0x3109, 0x02); 
    i2cWrite_NT99340(0x3530, 0xC0); 
    i2cWrite_NT99340(0x320A, 0x42); 
    i2cWrite_NT99340(0x3021, 0x06); 
    i2cWrite_NT99340(0x3069, 0x03);
    i2cWrite_NT99340(0x306A, 0x03);
    i2cWrite_NT99340(0x3060, 0x01); 

    siuSetFlicker50_60Hz(AE_Flicker_50_60_sel);

    /* brightness */
    i2cWrite_NT99340(0x32f2 ,AETargetMeanTab[siuY_TargetIndex]);
}

void SetNT99340_1088P_15FPS(void)
{
    int i;
    
    DEBUG_SIU("SetNT99340_1088P_15FPS()\n");
    ...
    i2cWrite_NT99340(0x32E1, 0x80); 
    i2cWrite_NT99340(0x32E2, 0x04); 
    i2cWrite_NT99340(0x32E3, 0x40); 
    i2cWrite_NT99340(0x32E4, 0x00); 
    i2cWrite_NT99340(0x32E5, 0x11); 
    i2cWrite_NT99340(0x32E6, 0x00); 
    i2cWrite_NT99340(0x32E7, 0x0F); 
    i2cWrite_NT99340(0x3200, 0x3F); 
    i2cWrite_NT99340(0x3201, 0x0F); 
    i2cWrite_NT99340(0x302A, 0x00); 
    i2cWrite_NT99340(0x302B, 0x01); 
...
#elif 0 // 20140922 15fps

//[YUYV_1920x1080_15.00_15.00_Fps_PCLK_88MHZ]
void SetNT99340_1080P_15FPS(void)
{
    int i;
    ...
    i2cWrite_NT99340(0x3009, 0x43); 
    i2cWrite_NT99340(0x300A, 0x09); 
    i2cWrite_NT99340(0x300B, 0xC4); 
    i2cWrite_NT99340(0x300C, 0x04); 
    i2cWrite_NT99340(0x300D, 0x95); 
    i2cWrite_NT99340(0x300E, 0x08); 
    i2cWrite_NT99340(0x300F, 0x00); 
    i2cWrite_NT99340(0x3010, 0x04); 
    i2cWrite_NT99340(0x3011, 0x80); 
...
void SetNT99340_1088P_15FPS(void)
{
    ...
    i2cWrite_NT99340(0x32C6, 0x20); 
    i2cWrite_NT99340(0x32C7, 0x00); 
    i2cWrite_NT99340(0x32C8, 0xA5); 
    i2cWrite_NT99340(0x32C9, 0x6A); 
    i2cWrite_NT99340(0x32CA, 0x8A); 
    i2cWrite_NT99340(0x32CB, 0x8A); 
    i2cWrite_NT99340(0x32CC, 0x8A); 
    i2cWrite_NT99340(0x32CD, 0x8A); 
    i2cWrite_NT99340(0x32DB, 0x74); 
    i2cWrite_NT99340(0x32D0, 0x01); 
    i2cWrite_NT99340(0x3200, 0x3F); 
    i2cWrite_NT99340(0x3201, 0x0F); 
    i2cWrite_NT99340(0x302A, 0x00); 
    i2cWrite_NT99340(0x302B, 0x01); 
    i2cWrite_NT99340(0x302C, 0x0F); 
    i2cWrite_NT99340(0x302D, 0x00); 
    i2cWrite_NT99340(0x302E, 0x00); 
    i2cWrite_NT99340(0x302F, 0x02); 
#if(SENSOR_ROW_COL_MIRROR)
    i2cWrite_NT99340(0x3022, 0x27);     
    ...
    i2cWrite_NT99340(0x3128, 0x01); 
    i2cWrite_NT99340(0x3002, 0x00); 
    i2cWrite_NT99340(0x3003, 0x44); 
    i2cWrite_NT99340(0x3004, 0x00); 
    i2cWrite_NT99340(0x3005, 0xE4); 
    i2cWrite_NT99340(0x3006, 0x07); 
    i2cWrite_NT99340(0x3007, 0xC3); 
    i2cWrite_NT99340(0x3008, 0x05); 
    i2cWrite_NT99340(0x3009, 0x23); 
    i2cWrite_NT99340(0x300A, 0x0B); 
    i2cWrite_NT99340(0x300B, 0x50); 
    i2cWrite_NT99340(0x300C, 0x04); 
    i2cWrite_NT99340(0x300D, 0x50); 
    i2cWrite_NT99340(0x300E, 0x07); 
    i2cWrite_NT99340(0x300F, 0x80); 
    i2cWrite_NT99340(0x3010, 0x04); 
    i2cWrite_NT99340(0x3011, 0x40); 
    i2cWrite_NT99340(0x3052, 0x10); 
    i2cWrite_NT99340(0x32BB, 0x87); 
    i2cWrite_NT99340(0x32B8, 0x36); 
    i2cWrite_NT99340(0x32B9, 0x2A); 
    i2cWrite_NT99340(0x32BC, 0x30); 
    i2cWrite_NT99340(0x32BD, 0x33); 
    i2cWrite_NT99340(0x32BE, 0x2D);
    i2cWrite_NT99340(0x3201, 0xBF); 
    i2cWrite_NT99340(0x3109, 0x02); 
    i2cWrite_NT99340(0x3530, 0xC0); 
    i2cWrite_NT99340(0x320A, 0x42); 
    i2cWrite_NT99340(0x3021, 0x06); 
...
void SetNT99340_1088P_15FPS(void)
{
    ...
    i2cWrite_NT99340(0x3052, 0x10); 
    i2cWrite_NT99340(0x32BB, 0x87); 
    i2cWrite_NT99340(0x32B8, 0x32); 
    i2cWrite_NT99340(0x32B9, 0x26); 
    i2cWrite_NT99340(0x32BC, 0x2C); 
    i2cWrite_NT99340(0x32BD, 0x2F); 
    i2cWrite_NT99340(0x32BE, 0x29); 
    i2cWrite_NT99340(0x3201, 0xBF); 
    i2cWrite_NT99340(0x3109, 0x02); 
    i2cWrite_NT99340(0x3530, 0xC0); 
    i2cWrite_NT99340(0x320A, 0x42); 
...
#if 0   // 20140922 10fps
//[YUYV_1920x1080_10.00_10.00_Fps]
void SetNT99340_1080P_10FPS(void)
{
    int i;
    
    DEBUG_SIU("SetNT99340_1080P_10FPS()\n");
    ...
    //[YUYV_1920x1080_10.00_10.00_Fps]
    i2cWrite_NT99340(0x32BF, 0x60); 
    i2cWrite_NT99340(0x32C0, 0x74); 
    i2cWrite_NT99340(0x32C1, 0x74); 
    i2cWrite_NT99340(0x32C2, 0x74); 
    i2cWrite_NT99340(0x32C3, 0x00); 
    i2cWrite_NT99340(0x32C4, 0x20); 
    i2cWrite_NT99340(0x32C5, 0x20); 
    i2cWrite_NT99340(0x32C6, 0x20); 
    i2cWrite_NT99340(0x32C7, 0x00); 
    i2cWrite_NT99340(0x32C8, 0x78); 
    i2cWrite_NT99340(0x32C9, 0x74); 
    i2cWrite_NT99340(0x32CA, 0x94); 
    i2cWrite_NT99340(0x32CB, 0x94); 
    i2cWrite_NT99340(0x32CC, 0x94); 
    i2cWrite_NT99340(0x32CD, 0x94); 
    i2cWrite_NT99340(0x32DB, 0x6E); 
    i2cWrite_NT99340(0x32D0, 0x01); 
    i2cWrite_NT99340(0x32E0, 0x07); 
    i2cWrite_NT99340(0x32E1, 0x80); 
    i2cWrite_NT99340(0x32E2, 0x04); 
...
//[YUYV_1920x1088_10.00_10.00_Fps]
void SetNT99340_1088P_10FPS(void)
{
    int i;
    
    DEBUG_SIU("SetNT99340_1088P_10FPS()\n");
...
void SetNT99340_1088P_10FPS(void)
{
    ...
    i2cWrite_NT99340(0x32CC, 0x94); 
    i2cWrite_NT99340(0x32CD, 0x94); 
    i2cWrite_NT99340(0x300C, 0x06); 
    i2cWrite_NT99340(0x300D, 0x79);
    i2cWrite_NT99340(0x306A, 0x03);
    i2cWrite_NT99340(0x3060, 0x01);
...
void SetNT99340_1088P_10FPS(void)
{
    ...
    //[YUYV_1920x1088_15Fps]
    i2cWrite_NT99340(0x32BF, 0x60); 
    i2cWrite_NT99340(0x32C0, 0x78); 
    i2cWrite_NT99340(0x32C1, 0x78); 
    i2cWrite_NT99340(0x32C2, 0x78); 
    i2cWrite_NT99340(0x32C3, 0x03); 
    i2cWrite_NT99340(0x32C4, 0x28); 
    i2cWrite_NT99340(0x32C5, 0x20); 
    i2cWrite_NT99340(0x32C6, 0x20); 
    i2cWrite_NT99340(0x32C7, 0x00); 
    i2cWrite_NT99340(0x32C8, 0x5C); 
    i2cWrite_NT99340(0x32C9, 0x78); 
    i2cWrite_NT99340(0x32CA, 0x98); 
    i2cWrite_NT99340(0x32CB, 0x98); 
    i2cWrite_NT99340(0x32CC, 0x98); 
    i2cWrite_NT99340(0x32CD, 0x98); 
    i2cWrite_NT99340(0x32DB, 0x67); 
    i2cWrite_NT99340(0x32D0, 0x01); 
    i2cWrite_NT99340(0x3200, 0x3F); 
    i2cWrite_NT99340(0x3201, 0x0F); 
    i2cWrite_NT99340(0x302A, 0x00); 
    i2cWrite_NT99340(0x302B, 0x01); 
    i2cWrite_NT99340(0x302C, 0x1F); 
    i2cWrite_NT99340(0x302D, 0x02); 
    i2cWrite_NT99340(0x302E, 0x00); 
    i2cWrite_NT99340(0x302F, 0x02); 
#if(SENSOR_ROW_COL_MIRROR)
...
void SetNT99340_720P_30FPS(void)
{
    int i;
    
    DEBUG_SIU("SetNT99340_720P_30FPS()\n");

#if 0   // 20140808
    //[YUYV_1280x720_30Fps]
    i2cWrite_NT99340(0x32BF, 0x60); 
    i2cWrite_NT99340(0x32C0, 0x5A); 
    i2cWrite_NT99340(0x32C1, 0x5A); 
    i2cWrite_NT99340(0x32C2, 0x5A); 
    i2cWrite_NT99340(0x32C3, 0x00); 
    i2cWrite_NT99340(0x32C4, 0x20); 
    i2cWrite_NT99340(0x32C5, 0x20); 
    i2cWrite_NT99340(0x32C6, 0x20); 
    i2cWrite_NT99340(0x32C7, 0x00); 
    i2cWrite_NT99340(0x32C8, 0xFD); 
    i2cWrite_NT99340(0x32C9, 0x5A); 
    i2cWrite_NT99340(0x32CA, 0x7A); 
    i2cWrite_NT99340(0x32CB, 0x7A); 
    i2cWrite_NT99340(0x32CC, 0x7A); 
    i2cWrite_NT99340(0x32CD, 0x7A); 
    i2cWrite_NT99340(0x32DB, 0x7F); 
    i2cWrite_NT99340(0x32D0, 0x01); 
    i2cWrite_NT99340(0x32E0, 0x05); 
    i2cWrite_NT99340(0x32E1, 0x00); 
    i2cWrite_NT99340(0x32E2, 0x02); 
    i2cWrite_NT99340(0x32E3, 0xD0); 
    i2cWrite_NT99340(0x32E4, 0x00); 
    i2cWrite_NT99340(0x32E5, 0x28); 
    i2cWrite_NT99340(0x32E6, 0x00); 
    i2cWrite_NT99340(0x32E7, 0x28); 
    i2cWrite_NT99340(0x3200, 0x3F); 
    i2cWrite_NT99340(0x3201, 0x0F); 
    i2cWrite_NT99340(0x302A, 0x00); 
    i2cWrite_NT99340(0x302B, 0x01); 
    ...
    i2cWrite_NT99340(0x3023, 0x24); 
    i2cWrite_NT99340(0x3128, 0x01); 
    i2cWrite_NT99340(0x3002, 0x01); 
    i2cWrite_NT99340(0x3003, 0x20); 
    i2cWrite_NT99340(0x3004, 0x01); 
    i2cWrite_NT99340(0x3005, 0x64); 
    i2cWrite_NT99340(0x3006, 0x06); 
    i2cWrite_NT99340(0x3007, 0xE7); 
    i2cWrite_NT99340(0x3008, 0x04); 
    i2cWrite_NT99340(0x3009, 0xA3); 
    i2cWrite_NT99340(0x300A, 0x07); 
    i2cWrite_NT99340(0x300B, 0x14); 
    i2cWrite_NT99340(0x300C, 0x03); 
    i2cWrite_NT99340(0x300D, 0x51); 
    i2cWrite_NT99340(0x300E, 0x05); 
    i2cWrite_NT99340(0x300F, 0xC8); 
    i2cWrite_NT99340(0x3010, 0x03); 
    i2cWrite_NT99340(0x3011, 0x40); 
    i2cWrite_NT99340(0x3052, 0x10); 
    i2cWrite_NT99340(0x32BB, 0x87); 
    i2cWrite_NT99340(0x32B8, 0x3B); 
    ...
    i2cWrite_NT99340(0x32C5, 0x20); 
    i2cWrite_NT99340(0x32C6, 0x20); 
    i2cWrite_NT99340(0x32C7, 0x40); 
    i2cWrite_NT99340(0x32C8, 0x08); 
    i2cWrite_NT99340(0x32C9, 0x5A); 
    i2cWrite_NT99340(0x32CA, 0x7A); 
    i2cWrite_NT99340(0x32CB, 0x7A); 
    i2cWrite_NT99340(0x32CC, 0x7A); 
    i2cWrite_NT99340(0x32CD, 0x7A); 
    i2cWrite_NT99340(0x32DB, 0x80); 
    i2cWrite_NT99340(0x32D0, 0x01); 
    i2cWrite_NT99340(0x32E0, 0x05); 
    i2cWrite_NT99340(0x32E1, 0x00); 
    i2cWrite_NT99340(0x32E2, 0x02); 
...
#if 0   // 20141117
void SetNT99340_720P_27FPS(void)
{
    int i;
    
    DEBUG_SIU("SetNT99340_720P_27FPS()\n");

    //[YUYV_1280x720_27Fps]
    i2cWrite_NT99340(0x32BF, 0x60); 
    i2cWrite_NT99340(0x32C0, 0x5D); 
    i2cWrite_NT99340(0x32C1, 0x5D); 
    i2cWrite_NT99340(0x32C2, 0x5D); 
    i2cWrite_NT99340(0x32C3, 0x00); 
    i2cWrite_NT99340(0x32C4, 0x20); 
    i2cWrite_NT99340(0x32C5, 0x20); 
    i2cWrite_NT99340(0x32C6, 0x20); 
    i2cWrite_NT99340(0x32C7, 0x00); 
    i2cWrite_NT99340(0x32C8, 0xF8); 
    i2cWrite_NT99340(0x32C9, 0x5D); 
    i2cWrite_NT99340(0x32CA, 0x7D); 
    i2cWrite_NT99340(0x32CB, 0x7D); 
    i2cWrite_NT99340(0x32CC, 0x7D); 
    i2cWrite_NT99340(0x32CD, 0x7D); 
    i2cWrite_NT99340(0x32DB, 0x7F); 
    i2cWrite_NT99340(0x32D0, 0x01); 
    i2cWrite_NT99340(0x32E0, 0x05); 
    i2cWrite_NT99340(0x32E1, 0x00); 
    ...
    i2cWrite_NT99340(0x32E3, 0xD0); 
    i2cWrite_NT99340(0x32E4, 0x00); 
    i2cWrite_NT99340(0x32E5, 0x40); 
    i2cWrite_NT99340(0x32E6, 0x00); 
    i2cWrite_NT99340(0x32E7, 0x40); 
    i2cWrite_NT99340(0x3200, 0x3F); 
    i2cWrite_NT99340(0x3201, 0x0F); 
    i2cWrite_NT99340(0x302A, 0x00); 
    i2cWrite_NT99340(0x302B, 0x01); 
    ...
    i2cWrite_NT99340(0x3128, 0x01); 
    i2cWrite_NT99340(0x3002, 0x00); 
    i2cWrite_NT99340(0x3003, 0xE4); 
    i2cWrite_NT99340(0x3004, 0x01); 
    i2cWrite_NT99340(0x3005, 0x42); 
    i2cWrite_NT99340(0x3006, 0x07); 
    i2cWrite_NT99340(0x3007, 0x23); 
    i2cWrite_NT99340(0x3008, 0x04); 
    i2cWrite_NT99340(0x3009, 0xC5); 
    i2cWrite_NT99340(0x300A, 0x07); 
    i2cWrite_NT99340(0x300B, 0x8C); 
    i2cWrite_NT99340(0x300C, 0x03); 
    i2cWrite_NT99340(0x300D, 0x98); 
    i2cWrite_NT99340(0x300E, 0x06); 
    i2cWrite_NT99340(0x300F, 0x40); 
    i2cWrite_NT99340(0x3010, 0x03); 
    i2cWrite_NT99340(0x3011, 0x84); 
    i2cWrite_NT99340(0x3052, 0x10); 
    i2cWrite_NT99340(0x32BB, 0x87); 
    i2cWrite_NT99340(0x32B8, 0x3B); 
    i2cWrite_NT99340(0x32B9, 0x2D); 
...
// 20141121 & 20141211
void SetNT99340_720P_Change_to_27FPS(void)
{
    //[Change_to_27_Fps]
    i2cWrite_NT99340(0x32C0, 0x5D);
    i2cWrite_NT99340(0x32C1, 0x5D);
...
// 20141121 & 20141211
void SetNT99340_720P_Change_to_30FPS(void)
{
    //[Change_to_30_Fps]
    i2cWrite_NT99340(0x32C0, 0x5A);
    i2cWrite_NT99340(0x32C1, 0x5A);
...
#if 0   // 20140808
void SetNT99340_VGA_30FPS(void)
{
    int i;

    DEBUG_SIU("SetNT99340_VGA_30FPS()\n");
    ...
    //[YUYV_640x480_30Fps]
    i2cWrite_NT99340(0x32BF, 0x60); 
    i2cWrite_NT99340(0x32C0, 0x5B); 
    i2cWrite_NT99340(0x32C1, 0x5B); 
    i2cWrite_NT99340(0x32C2, 0x5B); 
    i2cWrite_NT99340(0x32C3, 0x00); 
    i2cWrite_NT99340(0x32C4, 0x20); 
    i2cWrite_NT99340(0x32C5, 0x20); 
    i2cWrite_NT99340(0x32C6, 0x20); 
    i2cWrite_NT99340(0x32C7, 0x00); 
    i2cWrite_NT99340(0x32C8, 0xE6); 
    i2cWrite_NT99340(0x32C9, 0x5B); 
    i2cWrite_NT99340(0x32CA, 0x7B); 
    i2cWrite_NT99340(0x32CB, 0x7B); 
    i2cWrite_NT99340(0x32CC, 0x7B); 
    i2cWrite_NT99340(0x32CD, 0x7B); 
    i2cWrite_NT99340(0x32DB, 0x7C); 
    i2cWrite_NT99340(0x32D0, 0x01); 
    i2cWrite_NT99340(0x32E0, 0x02); 
    i2cWrite_NT99340(0x32E1, 0x80); 
    i2cWrite_NT99340(0x32E2, 0x01); 
    i2cWrite_NT99340(0x32E3, 0xE0); 
    i2cWrite_NT99340(0x32E4, 0x00); 
    i2cWrite_NT99340(0x32E5, 0x9A); 
    i2cWrite_NT99340(0x32E6, 0x00); 
    i2cWrite_NT99340(0x32E7, 0x9A); 
    i2cWrite_NT99340(0x3200, 0x3F); 
    i2cWrite_NT99340(0x3201, 0x0F); 
    i2cWrite_NT99340(0x302A, 0x00); 
    i2cWrite_NT99340(0x302B, 0x01); 
    ...
    i2cWrite_NT99340(0x3022, 0x24); 
#endif            
    i2cWrite_NT99340(0x3023, 0x6E); 
    i2cWrite_NT99340(0x3128, 0x01); 
    i2cWrite_NT99340(0x3002, 0x00); 
    i2cWrite_NT99340(0x3003, 0x04); 
    i2cWrite_NT99340(0x3004, 0x00); 
    i2cWrite_NT99340(0x3005, 0x04); 
    i2cWrite_NT99340(0x3006, 0x08); 
    i2cWrite_NT99340(0x3007, 0x03); 
    i2cWrite_NT99340(0x3008, 0x06); 
    i2cWrite_NT99340(0x3009, 0x03); 
    i2cWrite_NT99340(0x300A, 0x07); 
    i2cWrite_NT99340(0x300B, 0xD0); 
    i2cWrite_NT99340(0x300C, 0x03); 
    i2cWrite_NT99340(0x300D, 0x10); 
    i2cWrite_NT99340(0x300E, 0x04); 
    i2cWrite_NT99340(0x300F, 0x00); 
    i2cWrite_NT99340(0x3010, 0x03); 
    i2cWrite_NT99340(0x3011, 0x00); 
    i2cWrite_NT99340(0x3052, 0x10); 
    i2cWrite_NT99340(0x32BB, 0x87); 
    i2cWrite_NT99340(0x32B8, 0x3B); 
    i2cWrite_NT99340(0x32B9, 0x2D); 
...
void SetNT99340_VGA_30FPS(void)
{
    ...
    i2cWrite_NT99340(0x32C6, 0x20); 
    i2cWrite_NT99340(0x32C7, 0x00); 
    i2cWrite_NT99340(0x32C8, 0xF0); 
    i2cWrite_NT99340(0x32C9, 0x5A); 
    i2cWrite_NT99340(0x32CA, 0x7A); 
    i2cWrite_NT99340(0x32CB, 0x7A); 
    i2cWrite_NT99340(0x32CC, 0x7A); 
    i2cWrite_NT99340(0x32CD, 0x7A); 
    i2cWrite_NT99340(0x32DB, 0x7E); 
    i2cWrite_NT99340(0x32D0, 0x01); 
    i2cWrite_NT99340(0x32E0, 0x02); 
    i2cWrite_NT99340(0x32E1, 0x80); 
    i2cWrite_NT99340(0x32E2, 0x01); 
   ...
   gRfiuUnitCntl[0].RFpara.TX_SensorType=TX_SENSORTYPE_FHD;
    ...
    {	
        ...
        case SIUMODE_MPEGAVI: 
            ...
            #if 0
                FrameRate   = 15;
                SetNT99340_1080P_15FPS();
            #else
                FrameRate   = 10;
                //SetNT99340_1080P_10FPS();
                SetNT99340_1088P_10FPS();
            #endif
            }
            else if( (uiMenuVideoSizeSetting == UI_MENU_VIDEO_SIZE_1280X720) )
            {
                if(NT99340_720P_FrameRate == 30)
                {
                    FrameRate   = 30;
                    SetNT99340_720P_30FPS();
                }
                else if(NT99340_720P_FrameRate == 27)
                {
                    FrameRate   = 27;
                    SetNT99340_720P_30FPS();
                    SetNT99340_720P_Change_to_27FPS();
                }
            }
            else if( (uiMenuVideoSizeSetting == UI_MENU_VIDEO_SIZE_640x352) || (uiMenuVideoSizeSetting == UI_MENU_VIDEO_SIZE_704x480) )
            {
                FrameRate   = 30;
                SetNT99340_720P_30FPS();
                NT99340_720P_FrameRate=30;
            }
            else if( (uiMenuVideoSizeSetting == UI_MENU_VIDEO_SIZE_640x480) || (uiMenuVideoSizeSetting == UI_MENU_VIDEO_SIZE_320x240) )
            {
                FrameRate   = 30;
                SetNT99340_VGA_30FPS();
            }
			else
		    {
                FrameRate   = 30;
...
{
    if( (uiMenuVideoSizeSetting == UI_MENU_VIDEO_SIZE_1920x1072) || (uiMenuVideoSizeSetting == UI_MENU_VIDEO_SIZE_1600x896) )   // 1088P
    {
    #if 0   // 20140808
        if(flicker_sel == SENSOR_AE_FLICKER_60HZ)  //60Hz
        {
            //[1920x1080_60Hz_AntiFlicker]
            i2cWrite_NT99340(0x32BF, 0x60);
            i2cWrite_NT99340(0x32C0, 0x70);
            i2cWrite_NT99340(0x32C1, 0x70);
            i2cWrite_NT99340(0x32C2, 0x70);
            i2cWrite_NT99340(0x32C3, 0x00);
            i2cWrite_NT99340(0x32C4, 0x20);
            i2cWrite_NT99340(0x32C5, 0x20);
            i2cWrite_NT99340(0x32C6, 0x20);
            i2cWrite_NT99340(0x32C7, 0x00);
            i2cWrite_NT99340(0x32C8, 0x96);
            i2cWrite_NT99340(0x32C9, 0x70);
            i2cWrite_NT99340(0x32CA, 0x90);
            i2cWrite_NT99340(0x32CB, 0x90);
            i2cWrite_NT99340(0x32CC, 0x90);
            i2cWrite_NT99340(0x32CD, 0x90);
            i2cWrite_NT99340(0x32DB, 0x72);
            i2cWrite_NT99340(0x32D0, 0x01);
        }
        else //50Hz
        {
            //[1920x1080_50Hz_AntiFlicker]
            i2cWrite_NT99340(0x32BF, 0x60); 
            i2cWrite_NT99340(0x32C0, 0x6A); 
            i2cWrite_NT99340(0x32C1, 0x6A); 
            i2cWrite_NT99340(0x32C2, 0x6A); 
        ...
        if(flicker_sel == SENSOR_AE_FLICKER_60HZ)  //60Hz
        {
            //[60Hz_for_1920x1080_15.00_15.00_Fps_PCLK_88MHZ]
            i2cWrite_NT99340(0x32BF, 0x60);
            i2cWrite_NT99340(0x32C0, 0x70);
            i2cWrite_NT99340(0x32C1, 0x70);
            i2cWrite_NT99340(0x32C2, 0x70);
        ...
        {
            //[50Hz_for_1920x1080_15.00_15.00_Fps_PCLK_88MHZ]
            i2cWrite_NT99340(0x32BF, 0x60); 
            i2cWrite_NT99340(0x32C0, 0x6A); 
            i2cWrite_NT99340(0x32C1, 0x6A); 
            i2cWrite_NT99340(0x32C2, 0x6A); 
    ...
    #elif 0 // 20140922 10fps
        if(flicker_sel == SENSOR_AE_FLICKER_60HZ)  //60Hz
        {
            //[60Hz_for__1920x1080_10.00_10.00_Fps]
            i2cWrite_NT99340(0x32BF, 0x60); 
            i2cWrite_NT99340(0x32C0, 0x78); 
            i2cWrite_NT99340(0x32C1, 0x78); 
            i2cWrite_NT99340(0x32C2, 0x78); 
            ...
            i2cWrite_NT99340(0x32C6, 0x20); 
            i2cWrite_NT99340(0x32C7, 0x00); 
            i2cWrite_NT99340(0x32C8, 0x64); 
            i2cWrite_NT99340(0x32C9, 0x78); 
            i2cWrite_NT99340(0x32CA, 0x98); 
            i2cWrite_NT99340(0x32CB, 0x98); 
            i2cWrite_NT99340(0x32CC, 0x98); 
            i2cWrite_NT99340(0x32CD, 0x98); 
            i2cWrite_NT99340(0x32DB, 0x68); 
            i2cWrite_NT99340(0x32D0, 0x01); 
        }
        else //50Hz
        {
            //[50Hz_for__1920x1080_10.00_10.00_Fps]
            i2cWrite_NT99340(0x32BF, 0x60); 
            i2cWrite_NT99340(0x32C0, 0x74); 
            i2cWrite_NT99340(0x32C1, 0x74); 
            i2cWrite_NT99340(0x32C2, 0x74); 
    ...
    #elif 0 // 20141211 15fps
        if(flicker_sel == SENSOR_AE_FLICKER_60HZ)  //60Hz
        {
            //[60Hz_for_1088p_15FPS]
            i2cWrite_NT99340(0x32BF, 0x60); 
            i2cWrite_NT99340(0x32C0, 0x70); 
            i2cWrite_NT99340(0x32C1, 0x70); 
            i2cWrite_NT99340(0x32C2, 0x70); 
        ...
        else //50Hz
        {
            ...
            i2cWrite_NT99340(0x32C6, 0x20); 
            i2cWrite_NT99340(0x32C7, 0x00); 
            i2cWrite_NT99340(0x32C8, 0xD5); 
            i2cWrite_NT99340(0x32C9, 0x6A); 
            i2cWrite_NT99340(0x32CA, 0x8A); 
            i2cWrite_NT99340(0x32CB, 0x8A); 
            i2cWrite_NT99340(0x32CC, 0x8A); 
            i2cWrite_NT99340(0x32CD, 0x8A); 
            i2cWrite_NT99340(0x32DB, 0x7A); 
            i2cWrite_NT99340(0x32D0, 0x01); 
        }
    #elif 0 // 20141211 10fps
        if(flicker_sel == SENSOR_AE_FLICKER_60HZ)  //60Hz
        {
            //[60Hz_for_1088p_10FPS]
            i2cWrite_NT99340(0x32BF, 0x60); 
            i2cWrite_NT99340(0x32C0, 0x78); 
            i2cWrite_NT99340(0x32C1, 0x78); 
            i2cWrite_NT99340(0x32C2, 0x78); 
        ...
        else //50Hz
        {
            ...
            i2cWrite_NT99340(0x32C6, 0x20); 
            i2cWrite_NT99340(0x32C7, 0x00); 
            i2cWrite_NT99340(0x32C8, 0x6E); 
            i2cWrite_NT99340(0x32C9, 0x74); 
            i2cWrite_NT99340(0x32CA, 0x94); 
            i2cWrite_NT99340(0x32CB, 0x94); 
            i2cWrite_NT99340(0x32CC, 0x94); 
            i2cWrite_NT99340(0x32CD, 0x94); 
            i2cWrite_NT99340(0x32DB, 0x6B); 
            i2cWrite_NT99340(0x32D0, 0x01); 
        }
    #endif
    }
    else if( (uiMenuVideoSizeSetting == UI_MENU_VIDEO_SIZE_1280X720) || (uiMenuVideoSizeSetting == UI_MENU_VIDEO_SIZE_640x352) || (uiMenuVideoSizeSetting == UI_MENU_VIDEO_SIZE_704x480) )   // 720P
    {
    #if 0   // 20140808
        if(flicker_sel == SENSOR_AE_FLICKER_60HZ)  //60Hz
        {
            if(NT99340_720P_FrameRate == 30)
            {
                //[1280x720_60Hz_AntiFlicker]
                i2cWrite_NT99340(0x32BF, 0x60); 
                i2cWrite_NT99340(0x32C0, 0x60); 
                i2cWrite_NT99340(0x32C1, 0x60); 
                i2cWrite_NT99340(0x32C2, 0x60); 
                i2cWrite_NT99340(0x32C3, 0x00); 
                i2cWrite_NT99340(0x32C4, 0x20); 
                i2cWrite_NT99340(0x32C5, 0x20); 
                i2cWrite_NT99340(0x32C6, 0x20); 
                i2cWrite_NT99340(0x32C7, 0x00); 
                i2cWrite_NT99340(0x32C8, 0xD3); 
                i2cWrite_NT99340(0x32C9, 0x60); 
                i2cWrite_NT99340(0x32CA, 0x80); 
                i2cWrite_NT99340(0x32CB, 0x80); 
                i2cWrite_NT99340(0x32CC, 0x80); 
                i2cWrite_NT99340(0x32CD, 0x80); 
                i2cWrite_NT99340(0x32DB, 0x7A); 
                i2cWrite_NT99340(0x32D0, 0x01); 
            }
            else if(NT99340_720P_FrameRate == 27)   // 20141117
            {
                //[1280x720_60Hz_AntiFlicker]
                i2cWrite_NT99340(0x32BF, 0x60); 
                i2cWrite_NT99340(0x32C0, 0x61); 
                i2cWrite_NT99340(0x32C1, 0x61); 
                i2cWrite_NT99340(0x32C2, 0x61); 
                i2cWrite_NT99340(0x32C3, 0x00); 
                i2cWrite_NT99340(0x32C4, 0x20); 
                i2cWrite_NT99340(0x32C5, 0x20); 
                i2cWrite_NT99340(0x32C6, 0x20); 
                i2cWrite_NT99340(0x32C7, 0x00); 
                i2cWrite_NT99340(0x32C8, 0xCF); 
                i2cWrite_NT99340(0x32C9, 0x61); 
                i2cWrite_NT99340(0x32CA, 0x81); 
                i2cWrite_NT99340(0x32CB, 0x81); 
                i2cWrite_NT99340(0x32CC, 0x81); 
                i2cWrite_NT99340(0x32CD, 0x81); 
                i2cWrite_NT99340(0x32DB, 0x79); 
                i2cWrite_NT99340(0x32D0, 0x01); 
            }
        ...
        if(flicker_sel == SENSOR_AE_FLICKER_60HZ)  //60Hz
        {
            if(NT99340_720P_FrameRate == 30)
            {
                ...
                i2cWrite_NT99340(0x32C6, 0x20); 
                i2cWrite_NT99340(0x32C7, 0x00); 
                i2cWrite_NT99340(0x32C8, 0xDC); 
                i2cWrite_NT99340(0x32C9, 0x60); 
                i2cWrite_NT99340(0x32CA, 0x80); 
                i2cWrite_NT99340(0x32CB, 0x80); 
                i2cWrite_NT99340(0x32CC, 0x80); 
                i2cWrite_NT99340(0x32CD, 0x80); 
                i2cWrite_NT99340(0x32DB, 0x7B); 
                i2cWrite_NT99340(0x32D0, 0x01); 
            }
            else if(NT99340_720P_FrameRate == 27)
            {
    ...
    else    // VGA
    {
        ...
        if(flicker_sel == SENSOR_AE_FLICKER_60HZ)  //60Hz
        {
            ...
            i2cWrite_NT99340(0x32C6, 0x20); 
            i2cWrite_NT99340(0x32C7, 0x00); 
            i2cWrite_NT99340(0x32C8, 0xBF); 
            i2cWrite_NT99340(0x32C9, 0x60); 
            i2cWrite_NT99340(0x32CA, 0x80); 
            i2cWrite_NT99340(0x32CB, 0x80); 
            i2cWrite_NT99340(0x32CC, 0x80); 
            i2cWrite_NT99340(0x32CD, 0x80); 
            i2cWrite_NT99340(0x32DB, 0x77); 
            i2cWrite_NT99340(0x32D0, 0x01); 
        }
        else //50Hz
        {
            //[640x480_50Hz_AntiFlicker]
            i2cWrite_NT99340(0x32BF, 0x60); 
            i2cWrite_NT99340(0x32C0, 0x5B); 
            i2cWrite_NT99340(0x32C1, 0x5B); 
            i2cWrite_NT99340(0x32C2, 0x5B); 
        ...
        if(flicker_sel == SENSOR_AE_FLICKER_60HZ)  //60Hz
        {
            ...
            i2cWrite_NT99340(0x32C6, 0x20); 
            i2cWrite_NT99340(0x32C7, 0x00); 
            i2cWrite_NT99340(0x32C8, 0xC8); 
            i2cWrite_NT99340(0x32C9, 0x60); 
            i2cWrite_NT99340(0x32CA, 0x80); 
            i2cWrite_NT99340(0x32CB, 0x80); 
            i2cWrite_NT99340(0x32CC, 0x80); 
            i2cWrite_NT99340(0x32CD, 0x80); 
            i2cWrite_NT99340(0x32DB, 0x78); 
            i2cWrite_NT99340(0x32D0, 0x01); 
        }
        else //50Hz
        {
...
void siuSetSensorDayNight(u8 Level)
{
	...
	{   //夜間模式
        ...
        i2cWrite_NT99340(0x32c4 ,0x30);
        i2cWrite_NT99340(0x320A ,0x04);
        i2cWrite_NT99340(0x32F1 ,0x01);
        i2cWrite_NT99340(0x3270, 0x00);
        i2cWrite_NT99340(0x3271, 0x0C);
        i2cWrite_NT99340(0x3272, 0x18);
        i2cWrite_NT99340(0x3273, 0x32);
        i2cWrite_NT99340(0x3274, 0x44);
        i2cWrite_NT99340(0x3275, 0x54);
        i2cWrite_NT99340(0x3276, 0x70);
        i2cWrite_NT99340(0x3277, 0x88);
        i2cWrite_NT99340(0x3278, 0x9D);
        i2cWrite_NT99340(0x3279, 0xB0);
        i2cWrite_NT99340(0x327A, 0xCF);
        i2cWrite_NT99340(0x327B, 0xE2);
        i2cWrite_NT99340(0x327C, 0xEF);
        i2cWrite_NT99340(0x327D, 0xF7);
        i2cWrite_NT99340(0x327E, 0xFF);
        i2cWrite_NT99340(0x3060 ,0x01);
	}
    else
...
void siu_NT99340PowerDown(void)
{
   i2cWrite_SENSOR(0x0d, 0x0006);
}

void siu_NT99340PowerUp(void)
{
   i2cWrite_SENSOR(0x0d, 0x0000);
}

void siu_SetNT99340_720P_FrameRate(u32 FrameRate)
{

    if( (uiMenuVideoSizeSetting == UI_MENU_VIDEO_SIZE_1280X720) )
    {
        if(NT99340_720P_FrameRate  != FrameRate)
        {
            DEBUG_SIU("siu_SetNT99340_720P_FrameRate(%d)\n", FrameRate);
            if(FrameRate == 30)
            {
                SetNT99340_720P_Change_to_30FPS();
                NT99340_720P_FrameRate=30;
            }
            else if(FrameRate == 27)
            {
                SetNT99340_720P_Change_to_27FPS();
                NT99340_720P_FrameRate=27;
            }
        }
    }
}
