...
MAKENAME	= encrypt_DebugRel.mk
PRINT		= pr
PROGRAM		= none
BUILD_LIB	= Debug\..\..\lib\encrypt.lib
POST_BUILD	=
...
DebugRel\des.o: .\src\des.c inc\\des.h
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c .\src\des.c \
	 $(CARM) -o DebugRel\des.o
DebugRel\encrypt.o: .\src\encrypt.c inc\\des.h $(___INC__GENERAL_H)
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c .\src\encrypt.c \
	 $(CARM) -o DebugRel\encrypt.o
