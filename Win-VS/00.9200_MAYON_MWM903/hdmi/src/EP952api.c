...
============================================================================
   ...
   ============================================================================
	...
	3. set audio interface
		...
		EP_HDMI_Set_Audio_Fmt(AUD_I2S, EP952_SF_48000Hz); // IIS input , 48KHz 
...
void  EP_HDMI_Set_Audio_Fmt_952(unsigned char  Audfmt, unsigned char  Audfreq)
{
	///////////////////////////////////////////////////////////////
	...
	//
	//  [Example]:
	// 		EP_HDMI_SetAudFmt(AUD_I2S, EP952_SF_44100Hz); 	// I2S input,   Sample Frequency = 44.1KHz 
	// 		EP_HDMI_SetAudFmt(AUD_SPDIF, EP952_SF_48000Hz); 	// SPDIF input, Sample Frequency = 48KHz 
	//
	///////////////////////////////////////////////////////////////
...
void  EP_HDMI_Set_Video_Timing_952(unsigned char VIC)
{
		...
		//
		/////////////////////////////////////////////////////////////////////////
		EP952C_Registers.Video_Interface[0] = EP_TX_Video_Interface_Setting_0__BSEL | EP_TX_Video_Interface_Setting_0__EDGE;	// reference to Video_Interface[0].jpg;
				
		EP952C_Registers.Video_Interface[1] = EP_TX_Video_Interface_Setting_1__VIN_FMT__YCC422 | EP_TX_Video_Interface_Setting_1__SYNC__Embeded;	// reference to Video_Interface[1].jpg;
...
void EP_HDMI_952_Init(unsigned char  Audfreq,unsigned char  VdoSize)
{
    EP_HDMI_Set_Video_Timing_952(VdoSize);
    EP_HDMI_Set_Audio_Fmt_952(AUD_I2S, Audfreq);
