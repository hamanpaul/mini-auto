...
#include "rfiuapi.h"
//--------//
#define RFI_BATCAM_SLEEP_SYNC_CH_LOW        0    //For Battery Camera: SLEEP,SYNC mode時,固定於特定CH.
#define RFI_BATCAM_SLEEP_SYNC_CH_HIGH       15   //For Battery Camera: SLEEP,SYNC mode時,固定於特定CH.

#define RFI_BATCAM_WAKEUP_CH_LOW            0    //FOR Battery Caera: Wakeup 固定於特定頻道
#define RFI_BATCAM_WAKEUP_CH_HIGH           15    //FOR Battery Caera: Wakeup 固定於特定頻道

#define RFI_TXFWUPD_CH                      0    // TX FW update 固定於特定頻道
...
#define RFI_GOOD_CH_JDG_LV             204 // X/256
 ...
 //---Parameter---//
  ...
  #if( (RFI_CLK_FREQ == 36000000) || (RFI_CLK_FREQ == 54000000) )
    #define RFI_CLK_DIV_SEL  RFI_TXCLK_DIV_9

  #elif( (RFI_CLK_FREQ == 32000000) || (RFI_CLK_FREQ == 48000000) )	
    #define RFI_CLK_DIV_SEL  RFI_TXCLK_DIV_8
...
#elif(RFIC_SEL==RFIC_NONE_5M)
  #define RFI_CLK_DIV_SEL  RFI_TXCLK_DIV_32  //96M/16=6M
...
#elif(RFI_CLK_DIV_SEL == RFI_TXCLK_DIV_10)
#define RFI_RXCLKADJUST       ((0<<16) | (0x2<<3) | (0x0<<0))
#define RFI_DCLKCONF          ( (RFI_RX_PREAMBLE_NUM<<28) | (0x9<<24) | ((RFI_CLK_DIV_SEL*2)<<16) | (RFI_CLK_DIV_SEL<<8) | (RFI_CLK_DIV_SEL<<0))
#define RFI_RXTIMINGFINETUNE  ((0x2<<3) | (0x2<<0))
...
#define RFI_DCLKCONF          ( (RFI_RX_PREAMBLE_NUM<<28) | (0x7<<24) | ((RFI_CLK_DIV_SEL*2)<<16) | (RFI_CLK_DIV_SEL<<8) | (RFI_CLK_DIV_SEL<<0))
#define RFI_RXTIMINGFINETUNE  ((0x2<<3) | (0x2<<0))
#elif(RFI_CLK_DIV_SEL == RFI_TXCLK_DIV_6)
#define RFI_RXCLKADJUST       ((0<<16) | (0x1<<3) | (0x0<<0))
#define RFI_DCLKCONF          ( (RFI_RX_PREAMBLE_NUM<<28) | (0x4<<24) | ((RFI_CLK_DIV_SEL*2)<<16) | (RFI_CLK_DIV_SEL<<8) | (RFI_CLK_DIV_SEL<<0))
#define RFI_RXTIMINGFINETUNE  ((0x2<<3) | (0x0<<0))

#elif(RFI_CLK_DIV_SEL == RFI_TXCLK_DIV_5)
#define RFI_RXCLKADJUST       ((0<<16) | (0x1<<3) | (0x0<<0))
#define RFI_DCLKCONF          ( (RFI_RX_PREAMBLE_NUM<<28) | (0x3<<24) | ((RFI_CLK_DIV_SEL*2)<<16) | (RFI_CLK_DIV_SEL<<8) | (RFI_CLK_DIV_SEL<<0))
#define RFI_RXTIMINGFINETUNE  ((0x2<<3) | (0x0<<0))

#elif(RFI_CLK_DIV_SEL == RFI_TXCLK_DIV_4)
#define RFI_RXCLKADJUST       ((0<<16) | (0x1<<3) | (0x0<<0))
#define RFI_DCLKCONF          ( (RFI_RX_PREAMBLE_NUM<<28) | (0x3<<24) | ((RFI_CLK_DIV_SEL*2)<<16) | (RFI_CLK_DIV_SEL<<8) | (RFI_CLK_DIV_SEL<<0))
#define RFI_RXTIMINGFINETUNE  ((0x2<<3) | (0x0<<0))
#elif(RFI_CLK_DIV_SEL == RFI_TXCLK_DIV_32)
#define RFI_RXCLKADJUST       ((0<<16) | (0x2<<3) | (0x0<<0))
#define RFI_DCLKCONF          ( (RFI_RX_PREAMBLE_NUM<<28) | (0xf<<24) | ((RFI_CLK_DIV_SEL*2)<<16) | (RFI_CLK_DIV_SEL<<8) | (RFI_CLK_DIV_SEL<<0))
#define RFI_RXTIMINGFINETUNE  ((0x2<<3) | (0x2<<0))
#endif
...
#define RFI_FWUPD_DONE_ADDR_OFFSET        (RFI_CMD_ADDR_OFFSET + 24)
#define RFI_FWUPD_DONE_ADDR_CHEKBIT       (0x01 << 24)

#define RFI_FWUPD_START_ADDR_OFFSET        (RFI_CMD_ADDR_OFFSET + 25)
#define RFI_FWUPD_START_ADDR_CHEKBIT       (0x01 << 25)
#endif
 ...
 *********************************************************************************************************
 */
extern unsigned int rfiuDataPktConfig_Rx(int RFIunit,DEF_REGRFIU_CFG *pRfiuPara,int RFCh);
extern unsigned int rfiuDataPktConfig_Tx(int RFIunit,DEF_REGRFIU_CFG *pRfiuPara,int RFCh);
...
extern int rfiuGetACK2TimeCheck(unsigned char RFUnit,unsigned char *ACKBufAddr,
