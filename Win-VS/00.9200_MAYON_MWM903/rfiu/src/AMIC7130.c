...
const BYTE  A7130Config[]=
{
  ...
  #if ( AMIC7130_PAON ==1)  //Lucian: No PA in FPGA board.
...
void A7130_InitCodeSwitch2M_B1(void);
void A7130_InitCodeSwitch2M_B2(void);
...
void A7130_InitCodeSwitch2M_B1(void)
{
    A7130_WriteReg_B1( CHGROUP1_REG,  0x3C);
    A7130_WriteReg_B1( CHGROUP2_REG,  0x78);
    A7130_WriteReg_B1( TX1_REG,       0xAE);
    A7130_WriteReg_B1( DELAY2_REG,    0x60);
    A7130_WriteReg_B1( RXGAIN1_REG,   0x6F);
    A7130_WriteReg_B1( RXGAIN2_REG,   0xC2);
    A7130_WriteReg_B1( RXGAIN3_REG,   0x1D);
    A7130_WriteReg_B1( RXGAIN4_REG,   0xC7);
    A7130_WriteReg_B1( IFCAL1_REG,    0x20);
    A7130_WriteReg_B1( IFCAL2_REG,    0x7F);
    A7130_WriteReg_B1( VCOMODDELAY_REG,0x9C);
    A7130_WriteReg_B1( CRYSTALTEST_REG,0x55);
    A7130_WriteReg_B1( CHSELECT_REG,  0x37);

    A7130_WriteReg_B1(RFANALOG_REG, A7130Config[0x35] | PageTab[1]);//page select
    A7130_WriteReg_B1(0x2A, 0x49);
    A7130_WriteReg_B1(RFANALOG_REG, A7130Config[0x35] | PageTab[6]);//page select
    A7130_WriteReg_B1(0x2A, 0x0A);
}

void A7130_InitCodeSwitch2M_B2(void)
{
    A7130_WriteReg_B2( CHGROUP1_REG,  0x3C);
    A7130_WriteReg_B2( CHGROUP2_REG,  0x78);
    A7130_WriteReg_B2( TX1_REG,       0xAE);
    A7130_WriteReg_B2( DELAY2_REG,    0x60);
    A7130_WriteReg_B2( RXGAIN1_REG,   0x6F);
    A7130_WriteReg_B2( RXGAIN2_REG,   0xC2);
    A7130_WriteReg_B2( RXGAIN3_REG,   0x1D);
    A7130_WriteReg_B2( RXGAIN4_REG,   0xC7);
    A7130_WriteReg_B2( IFCAL1_REG,    0x20);
    A7130_WriteReg_B2( IFCAL2_REG,    0x7F);
    A7130_WriteReg_B2( VCOMODDELAY_REG,0x9C);
    A7130_WriteReg_B2( CRYSTALTEST_REG,0x55);
    A7130_WriteReg_B2( CHSELECT_REG,  0x37);

    A7130_WriteReg_B2(RFANALOG_REG, A7130Config[0x35] | PageTab[1]);//page select
    A7130_WriteReg_B2(0x2A, 0x49);
    A7130_WriteReg_B2(RFANALOG_REG, A7130Config[0x35] | PageTab[6]);//page select
    A7130_WriteReg_B2(0x2A, 0x0A);
}

#if 0
void A7130_ChgTo_2M_B1(void)
{
    A7130_WriteReg_B1( DATARATE_REG,    0x5F);
    A7130_WriteReg_B1( TX1_REG,         0xAE);
    A7130_WriteReg_B1( RXGAIN3_REG,     0x1D);
    A7130_WriteReg_B1( RXGAIN4_REG,     0xC7);
    A7130_WriteReg_B1( IFCAL1_REG,      0x20);
...
void A7130_ChgTo_2M_B2(void)
{
    A7130_WriteReg_B2( DATARATE_REG,    0x5F);
    A7130_WriteReg_B2( TX1_REG,         0xAE);
    A7130_WriteReg_B2( RXGAIN3_REG,     0x1D);
    A7130_WriteReg_B2( RXGAIN4_REG,     0xC7);
    A7130_WriteReg_B2( IFCAL1_REG,      0x20);
...
void A7130_ChgTo_4M_B1(void)
{
    A7130_WriteReg_B1( DATARATE_REG,    0x9F);
    A7130_WriteReg_B1( TX1_REG,         0xAF);
    A7130_WriteReg_B1( RXGAIN3_REG,     0x3D);
    A7130_WriteReg_B1( RXGAIN4_REG,     0xE7);
    A7130_WriteReg_B1( IFCAL1_REG,      0x60);
    A7130_WriteReg_B1( VCOMODDELAY_REG, 0xDC);
    A7130_WriteReg_B1( CHSELECT_REG,    0x77);
}

void A7130_ChgTo_4M_B2(void)
{
    A7130_WriteReg_B2( DATARATE_REG,    0x9F);
    A7130_WriteReg_B2( TX1_REG,         0xAF);
    A7130_WriteReg_B2( RXGAIN3_REG,     0x3D);
    A7130_WriteReg_B2( RXGAIN4_REG,     0xE7);
    A7130_WriteReg_B2( IFCAL1_REG,      0x60);
    A7130_WriteReg_B2( VCOMODDELAY_REG, 0xDC);
    A7130_WriteReg_B2( CHSELECT_REG,    0x77);
}

#else
void A7130_ChgTo_2M_B1(void)
{
    const char RegTab[14]={
    	0x0d, 0x5f,
    	0x15, 0xae,
    	0x1c, 0x1d,
    	0x1d, 0xc7,
...
void A7130_TxMode_Start(int BoardSel)
{
    ...
    if(BoardSel==1)
    {
        ...
        //A7196_WriteReg_B1(GPIO2_REG,0x24);      //GPO2 as TX
	    //StrobeCmd_B1(CMD_TX); //entry tx & transmit	

		gpioSetLevel(GPIO_GROUP_RFI1CONF_nSS, GPIO_BIT_RFI1_nSS,0);	
        ByteSendFast_B1(GPIO2_REG);
...
void A7130_RxMode_Start(int BoardSel)
{
    ...
    if(BoardSel==1)
    {
        ...
        //A7196_WriteReg_B1(GPIO2_REG,0x21);      //GPO2 as RX
        //StrobeCmd_B1(CMD_RX); //entry tx & transmit
		gpioSetLevel(GPIO_GROUP_RFI1CONF_nSS, GPIO_BIT_RFI1_nSS,0);	
        ByteSendFast_B1(GPIO2_REG); //GPO2 as RX
...
** WOR_enable
*********************************************************************/
s32 A7130_WOR_enable_B1(s32 PIR_IntvOn)
{
    u8 tmp;
    int i;
    GPIO_CFG c;
    ...
    if(gRfiuCustomerCode[0] & 0x01)
       A7130_CH_sel(0+1,gRfiuDAT_CH_Table[RFI_BATCAM_WAKEUP_CH_HIGH]);
    else
       A7130_CH_sel(0+1,gRfiuDAT_CH_Table[RFI_BATCAM_WAKEUP_CH_LOW]);
    //---Config Wake RF-ID---//
    ...
    //------//
    gpioSetLevel(GPIO_GROUP_RFI1CONF_RXSW, GPIO_BIT_RFI1_RXSW,1);   //LNA off
    A7130_WriteReg_B1(CODE2_REG,0x07);     //CODE 2 register, ID torence=1
    
    A7130_WriteReg_B1(CKO_REG,0x3A);       //CKO as FSYNC
    A7130_WriteReg_B1(GPIO1_REG,0x03);      //GIO1 as WTR,signal inverse
    A7130_WriteReg_B1(GPIO2_REG,0x00);      //GPO2 disable
    //-----//     
 #if 0   
...
#if 1
	A7130_WriteReg_B1(RCOSC1_REG, 0x31);	//setup WOR Sleep time and RX time: 400 ms
	A7130_WriteReg_B1(RCOSC2_REG, 0x0f);    //wake time: 4 ms
#else
	A7130_WriteReg_B1(RCOSC1_REG, 0xff);	//setup WOR Sleep time and RX time: 8 sec
	A7130_WriteReg_B1(RCOSC2_REG, 0xc0);    //wake time: 0.25 ms
#endif
...
void A7130_WOR_enable_B2(void)
{
    ...
    //-----
    if(gRfiuCustomerCode[0] & 0x01)
       A7130_CH_sel(1+1,gRfiuDAT_CH_Table[RFI_BATCAM_WAKEUP_CH_HIGH]);
    else
       A7130_CH_sel(1+1,gRfiuDAT_CH_Table[RFI_BATCAM_WAKEUP_CH_LOW]);
