...
// DMA_REQ_IIS5_RECORD
     ...
     (DMA_INT_ENA_FINISH|DMA_INT_ENA_ERROR|DMA_SRC_APB|DMA_DST_AHB|DMA_SRC_INC0|DMA_DST_INC4|DMA_DATA_WORD|DMA_ADCRX_REC),
 #else
     (DMA_INT_ENA_FINISH|DMA_INT_ENA_ERROR|DMA_SRC_APB|DMA_DST_AHB|DMA_SRC_INC0|DMA_DST_INC4|DMA_DATA_WORD|DMA_IIS5_REC),
 #endif
// DMA_REQ_IIS5_PLAY
 
     (DMA_INT_ENA_FINISH|DMA_INT_ENA_ERROR|DMA_SRC_AHB|DMA_DST_APB|DMA_SRC_INC4|DMA_DST_INC0|DMA_DATA_WORD|DMA_IIS5_PLAY),
 

	// DMA_REQ_SD_READ
    (DMA_INT_ENA_FINISH|DMA_INT_ENA_ERROR|DMA_SRC_APB|DMA_DST_AHB|DMA_SRC_INC0|DMA_DST_INC4|DMA_DATA_WORD|DMA_SD),    

	// DMA_REQ_SD_WRITE
    (DMA_INT_ENA_FINISH|DMA_INT_ENA_ERROR|DMA_SRC_AHB|DMA_DST_APB|DMA_SRC_INC4|DMA_DST_INC0|DMA_DATA_WORD|DMA_SD),

	// DMA_REQ_SD_READ_FAST
    (DMA_INT_ENA_FINISH|DMA_INT_ENA_ERROR|DMA_SRC_APB|DMA_DST_AHB|DMA_SRC_INC0|DMA_DST_INC16|DMA_DATA_WORD|DMA_BST_TYPE16|DMA_SD|DMA_BURST4),

	// DMA_REQ_SD_WRITE_FAST
    (DMA_INT_ENA_FINISH|DMA_INT_ENA_ERROR|DMA_SRC_AHB|DMA_DST_APB|DMA_SRC_INC16|DMA_DST_INC0|DMA_DATA_WORD|DMA_BST_TYPE16|DMA_SD|DMA_BURST4),

	// DMA_REQ_SD2_READ
    (DMA_INT_ENA_FINISH|DMA_INT_ENA_ERROR|DMA_SRC_APB|DMA_DST_AHB|DMA_SRC_INC0|DMA_DST_INC4|DMA_DATA_WORD|DMA_SD2|DMA_BURST4),

	// DMA_REQ_SD2_WRITE
    (DMA_INT_ENA_FINISH|DMA_INT_ENA_ERROR|DMA_SRC_AHB|DMA_DST_APB|DMA_SRC_INC4|DMA_DST_INC0|DMA_DATA_WORD|DMA_SD2|DMA_BURST4),
    
    // DMA_REQ_SD_READ_FAST
    (DMA_INT_ENA_FINISH|DMA_INT_ENA_ERROR|DMA_SRC_APB|DMA_DST_AHB|DMA_SRC_INC0|DMA_DST_INC16|DMA_DATA_WORD|DMA_BST_TYPE16|DMA_SD2|DMA_BURST4),

	// DMA_REQ_SD_WRITE_FAST
    (DMA_INT_ENA_FINISH|DMA_INT_ENA_ERROR|DMA_SRC_AHB|DMA_DST_APB|DMA_SRC_INC16|DMA_DST_INC0|DMA_DATA_WORD|DMA_BST_TYPE16|DMA_SD2|DMA_BURST4),
...
// DMA_REQ_MEM_SET_BYTE
    ...
    // DMA_REQ_MEM_SET_WORD_FAST
    (DMA_INT_ENA_FINISH|DMA_INT_ENA_ERROR|DMA_SRC_AHB|DMA_DST_AHB|DMA_SRC_INC0|DMA_DST_INC16|DMA_DATA_WORD|DMA_BST_TYPE16|DMA_NONE),
...
u32 marsDMATrigger(INT32U uiDMAId, INT32U uiReqId, DMA_CFG* pCfg)
{
	INT32U uiDMACmmd=0;
...
void *memcpy_hw(void *dest, const void *src, unsigned int count)
{
    ...
    #elif( (DRAMCNTRL_SEL == DRAMCNTRL_DDR2) )
...
void *memset_hw_Word(void *ori_dest, unsigned int dataVal, int ori_count)
{
    ...
    *gpuiHWMemsetVal = dataVal;
    ...
    {
    	dest += ((count>>2)<<2);    // DMA moved
        memset(dest, dataVal & 0x0ff, count%4);
    }
...
void *memset_hw_Word(void *ori_dest, unsigned int dataVal, int ori_count)
{
	u8 *dest;
    u32 *dest1, *src1, uiDstAddr, count;
    INT32U size1, uiDMAId, status, uiDataVal, DMATblIdx;
    DMA_CFG dmaCfg;
    int i;
    u8 err;
    ...
    for(i = 0; i < 4; i++)
    	gDMAMemsetValTbl[DMATblIdx].CB[i] = dataVal;
    ...
    dest1 = (u32*)dest;
    src1 = gDMAMemsetValTbl[DMATblIdx].CB;
    ...
    uiDMAId = marsDMATrigger(DMATblIdx, DMA_REQ_MEM_SET_WORD, &dmaCfg);
    status = marsDMACheckReady(uiDMAId);
    ...
    if(count & 0xf)
    {
        ...
        memset(dest, dataVal & 0x0ff, (count & 0xf));
    }    
    return dest;
}
#endif
