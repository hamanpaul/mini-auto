...
CARM	= -I..\inc\mars_controller\ -I.\inc\ -I..\inc\ -I..\inc\os\ --no_debug --dwarf2 -O3
...
CARM_OBJS	= 		  Release\mars_dmareqfunc.o Release\mars_dma.o 
...
MAKENAME	= mars_dma_release_Release.mk
PRINT		= pr
PROGRAM		= none
...
Release\mars_dmareqfunc.o: .\src\mars_dmareqfunc.c
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c \
	 .\src\mars_dmareqfunc.c $(CARM) -o Release\mars_dmareqfunc.o
Release\mars_dma.o: .\src\mars_dma.c
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c .\src\mars_dma.c \
	 $(CARM) -o Release\mars_dma.o
