...
MAKENAME	= avi_release_Release.mk
PRINT		= pr
PROGRAM		= none
BUILD_LIB	= Release\..\..\lib\release\avi_release.lib
POST_BUILD	=
...
Release\avi.o: .\src\avi.c $(___INC__GENERAL_H) ..\inc\\board.h \
	 ..\inc\\task.h  ..\inc\\rtcapi.h $(___INC__DCFAPI_H) inc\\avi.h \
	 ..\inc\\aviapi.h ..\inc\\mpeg4api.h $(___INC__IISAPI_H) \
	 ..\iis\inc\iis.h $(___INC__ISUAPI_H) ..\inc\\iduapi.h \
	 ..\inc\\ipuapi.h $(___INC__SIUAPI_H) ..\inc\\fsapi.h \
	 ..\fs\inc\fs_fat.h
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c .\src\avi.c \
	 $(CARM) -o Release\avi.o
