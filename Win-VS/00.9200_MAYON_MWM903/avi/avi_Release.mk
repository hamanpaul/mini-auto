...
MAKENAME	= avi_Release.mk
PRINT		= pr
PROGRAM		= none
BUILD_LIB	= Debug\..\..\lib\avi.lib
POST_BUILD	=
...
# Missing files: 11
#   Selected list: aviapi.h 
___INC__OSAPI_H=..\inc\\osapi.h 
___INC__FSAPI_H=..\inc\\fsapi.h 
___INC__DCFAPI_H=..\inc\\dcfapi.h 
# DEPEND: end include files

Release\avi.o: .\src\avi.c ..\inc\\general.h ..\inc\\board.h \
	 $(___INC__OSAPI_H) ..\inc\\task.h $(___INC__FSAPI_H) \
	 ..\inc\\rtcapi.h $(___INC__DCFAPI_H) inc\\avi.h ..\inc\\mpeg4api.h \
	 ..\inc\\iisapi.h
