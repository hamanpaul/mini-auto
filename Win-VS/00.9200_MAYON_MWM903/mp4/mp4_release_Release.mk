...
MAKENAME	= mp4_release_Release.mk
PRINT		= pr
PROGRAM		= none
BUILD_LIB	= Release\..\..\lib\release\mp4_release.lib
POST_BUILD	=
...
Release\mp4.o: .\src\mp4.c $(___INC__GENERAL_H) ..\inc\\board.h \
	 ..\inc\\task.h  ..\inc\\rtcapi.h $(___INC__DCFAPI_H) inc\\mp4.h \
	 ..\inc\\mp4api.h ..\inc\\mpeg4api.h $(___INC__IISAPI_H) \
	 $(___INC__ISUAPI_H) ..\inc\\iduapi.h ..\inc\\ipuapi.h \
	 $(___INC__SIUAPI_H) ..\inc\\sysapi.h ..\inc\\fsapi.h \
	 ..\fs\inc\fs_fat.h
	c:\progra~1\arm\rvct\programs\2.1\328\win_32~1\armcc -c .\src\mp4.c \
	 $(CARM) -o Release\mp4.o
